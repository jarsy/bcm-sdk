/*
 * $Id: blackbird_service.h,v 1.3 Broadcom SDK $
 *
 * $Copyright: (c) 2016 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 */
 
#ifndef _BLACKBIRD_SERVICE_H
#define _BLACKBIRD_SERVICE_H
...
int drv_blackbird_port_pri_mapop_set(int unit, int port, int op_type, 
                uint32 pri_old, uint32 cfi_old, uint32 pri_new, uint32 cfi_new);
int drv_blackbird_port_pri_mapop_get(int unit, int port, int op_type, 
                uint32 pri_old, uint32 cfi_old, uint32 *pri_new, uint32 *cfi_new);
...
int drv_blackbird_dev_prop_get(int unit,uint32 prop_type,uint32 *prop_val);
int drv_blackbird_dev_prop_set(int unit,uint32 prop_type,uint32 prop_val);



extern drv_if_t drv_blackbird_services;
