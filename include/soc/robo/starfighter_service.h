...
#ifndef _STARFIGHTER_SERVICE_H
#define _STARFIGHTER_SERVICE_H
...
int drv_starfighter_port_pri_mapop_set(int unit, int port, int op_type, 
                uint32 pri_old, uint32 cfi_old, uint32 pri_new, uint32 cfi_new);
int drv_starfighter_port_pri_mapop_get(int unit, int port, int op_type, 
                uint32 pri_old, uint32 cfi_old, uint32 *pri_new, uint32 *cfi_new);
...
int drv_starfighter_dev_prop_get(int unit,uint32 prop_type,uint32 *prop_val);
int drv_starfighter_dev_prop_set(int unit,uint32 prop_type,uint32 prop_val);


extern drv_if_t drv_starfighter_services;
