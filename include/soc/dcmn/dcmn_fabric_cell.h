/*
 * $Id: dcmn_fabric_cell.h,v 1.2 Broadcom SDK $
 *
...
#define SOC_DCMN_FABRIC_CELL_ENTRY_MAX_SIZE_UINT32      (36)
...
typedef struct dcmn_captured_cells_s {
    ...
    int is_last_cell;
    uint32 cell_type;
    uint32 data[SOC_DCMN_FABRIC_CAPTURED_CELL_ENTRY_MAX_SIZE_UINT32];            /* Pointer to array of data blocks. */
...
#endif /* ifndef SOC_DCMN_FABRIC_CELL_H */
