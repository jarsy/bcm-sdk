...
typedef enum {
    ...
    socBondInfoFeatureNoPktStats,       /*  Packetized Stats */
    socBondInfoFeatureNoTrafficCaptureBuffer, /*  TCB */
...
typedef struct soc_bond_info_s {
    ...
    SHR_BITDCL tsc_in_loop[_SHR_BITDCLSIZE(64)];    /* 64b: TSC_FORCE_LOOPBACK  */
