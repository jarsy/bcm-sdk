...
/*
 * $Id: sbZfKaEpIpFourBitEntry.hx,v 1.2 Broadcom SDK $
 * $Copyright: (c) 2016 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 */


#ifndef SB_ZF_ZKAEPIPFOURBITENTRY_H
#define SB_ZF_ZKAEPIPFOURBITENTRY_H

#define SB_ZF_ZKAEPIPFOURBITENTRY_SIZE_IN_BYTES 8
#define SB_ZF_ZKAEPIPFOURBITENTRY_SIZE 8
#define SB_ZF_ZKAEPIPFOURBITENTRY_M_NNDATA_BITS "63:0"


typedef struct _sbZfKaEpIpFourBitEntry {
  uint64 m_nnData;
} sbZfKaEpIpFourBitEntry_t;

uint32
sbZfKaEpIpFourBitEntry_Pack(sbZfKaEpIpFourBitEntry_t *pFrom,
                            uint8 *pToData,
                            uint32 nMaxToDataIndex);
void
sbZfKaEpIpFourBitEntry_Unpack(sbZfKaEpIpFourBitEntry_t *pToStruct,
                              uint8 *pFromData,
                              uint32 nMaxToDataIndex);
void
sbZfKaEpIpFourBitEntry_InitInstance(sbZfKaEpIpFourBitEntry_t *pFrame);

#ifdef SAND_BIG_ENDIAN_HOST
#define SB_ZF_KAEPIPFOURBITENTRY_SET_DATA(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#endif
#ifdef SAND_BIG_ENDIAN_HOST
#define SB_ZF_KAEPIPFOURBITENTRY_GET_DATA(nToData,pFromData,nMaxFromDataIndex) \
          do { \
