...
/*
 * $Id: sbZfKaEpIpTtlRange.hx,v 1.2 Broadcom SDK $
 * $Copyright: (c) 2016 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 */


#ifndef SB_ZF_ZFKAEPIPTTLRANGE_H
#define SB_ZF_ZFKAEPIPTTLRANGE_H

#define SB_ZF_ZFKAEPIPTTLRANGE_SIZE_IN_BYTES 8
#define SB_ZF_ZFKAEPIPTTLRANGE_SIZE 8
#define SB_ZF_ZFKAEPIPTTLRANGE_M_NHIGHTTL_BITS "63:32"
#define SB_ZF_ZFKAEPIPTTLRANGE_M_NLOWTTL_BITS "31:0"


typedef struct _sbZfKaEpIpTtlRange {
  uint32 m_nHighTtl;
  uint32 m_nLowTtl;
} sbZfKaEpIpTtlRange_t;
...
#define SB_ZF_KAEPIPTTLRANGE_SET_HI(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#define SB_ZF_KAEPIPTTLRANGE_SET_LO(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#endif
#ifdef SAND_BIG_ENDIAN_HOST
#define SB_ZF_KAEPIPTTLRANGE_GET_HI(nToData,pFromData,nMaxFromDataIndex) \
          do { \
...
#define SB_ZF_KAEPIPTTLRANGE_GET_LO(nToData,pFromData,nMaxFromDataIndex) \
          do { \
