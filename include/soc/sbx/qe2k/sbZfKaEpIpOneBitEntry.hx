...
/*
 * $Id: sbZfKaEpIpOneBitEntry.hx,v 1.2 Broadcom SDK $
 * $Copyright: (c) 2016 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 */


#ifndef SB_ZF_ZKAEPIPONEBITENTRY_H
#define SB_ZF_ZKAEPIPONEBITENTRY_H

#define SB_ZF_ZKAEPIPONEBITENTRY_SIZE_IN_BYTES 8
#define SB_ZF_ZKAEPIPONEBITENTRY_SIZE 8
#define SB_ZF_ZKAEPIPONEBITENTRY_M_NNDATA_BITS "63:0"


typedef struct _sbZfKaEpIpOneBitEntry {
  uint64 m_nnData;
} sbZfKaEpIpOneBitEntry_t;
...
#define SB_ZF_KAEPIPONEBITENTRY_SET_DATA(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#endif
#ifdef SAND_BIG_ENDIAN_HOST
#define SB_ZF_KAEPIPONEBITENTRY_GET_DATA(nToData,pFromData,nMaxFromDataIndex) \
          do { \
