...
/*
 * $Id: sbZfFabBm9600NmEmt_0Entry.hx,v 1.2 Broadcom SDK $
 * $Copyright: (c) 2016 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 */


#ifndef SB_ZF_FAB_BM9600_NMEMT_0ENTRY_H
#define SB_ZF_FAB_BM9600_NMEMT_0ENTRY_H

#define SB_ZF_FAB_BM9600_NMEMT_0ENTRY_SIZE_IN_BYTES 10
#define SB_ZF_FAB_BM9600_NMEMT_0ENTRY_SIZE 10
#define SB_ZF_FAB_BM9600_NMEMT_0ENTRY_M_UMFEM_BITS "72:72"
#define SB_ZF_FAB_BM9600_NMEMT_0ENTRY_M_UESETMEMBER1_BITS "71:64"
#define SB_ZF_FAB_BM9600_NMEMT_0ENTRY_M_UUESETMEMBER0_BITS "63:0"


typedef struct _sbZfFabBm9600NmEmt_0Entry {
  uint32 m_uMfem;
  uint32 m_uEsetMember1;
  uint64 m_uuEsetMember0;
} sbZfFabBm9600NmEmt_0Entry_t;
...
#define SB_ZF_FABBM9600NMEMT_0ENTRY_SET_MFEM(nFromData,pToData,nMaxToDataIndex) \
          do { \
           (pToData)[10] = ((pToData)[10] & ~0x01) | ((nFromData) & 0x01); \
          } while(0)

#define SB_ZF_FABBM9600NMEMT_0ENTRY_SET_ESETMEMBER1(nFromData,pToData,nMaxToDataIndex) \
          do { \
           (pToData)[11] = ((nFromData)) & 0xFF; \
          } while(0)

#define SB_ZF_FABBM9600NMEMT_0ENTRY_SET_ESETMEMBER0(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#endif
#ifdef SAND_BIG_ENDIAN_HOST
#define SB_ZF_FABBM9600NMEMT_0ENTRY_GET_MFEM(nToData,pFromData,nMaxFromDataIndex) \
          do { \
           (nToData) = (uint32) ((pFromData)[10]) & 0x01; \
          } while(0)

#define SB_ZF_FABBM9600NMEMT_0ENTRY_GET_ESETMEMBER1(nToData,pFromData,nMaxFromDataIndex) \
          do { \
           (nToData) = (uint32) (pFromData)[11] ; \
          } while(0)

#define SB_ZF_FABBM9600NMEMT_0ENTRY_GET_ESETMEMBER0(nToData,pFromData,nMaxFromDataIndex) \
          do { \
