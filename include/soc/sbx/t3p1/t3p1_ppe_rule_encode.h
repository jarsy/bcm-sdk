/*
 * 
 * $Id: ppe_h.stg,v 1.19 Broadcom SDK $
 * $Copyright: (c) 2016 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 *
 * t3p1_pp_rule_encode.h: Guadalupe3k V1.0 PPE rule encoding functions
 *
 ...
 */
#ifndef _SB_T3P1_FE_PP_RULE_ENCODE_H_
#define _SB_T3P1_FE_PP_RULE_ENCODE_H_
...
#define SOC_SBX_T3P1_MEM_SIZE (SOC_SBX_CALADAN3_PPE_HASH_BIT_LENGTH_BITS >> 3)


typedef struct {
  soc_sbx_caladan3_ppe_hash_type_t type;
  soc_sbx_caladan3_ppe_hash_id_t id;
  uint8 mem[SOC_SBX_T3P1_MEM_SIZE];
} soc_sbx_t3p1_ppe_hash_t;
...
SOC_CALADAN3_PPE_RULE_rS6_MPLS_ACH_ENTRY = 0 ,
SOC_CALADAN3_PPE_RULE_rS6_MPLS_NOACH_L2_ENTRY = 1 ,
SOC_CALADAN3_PPE_RULE_rS6_MPLS_NOACH_L3_ENTRY = 2 ,
SOC_CALADAN3_PPE_RULE_rS6_MPLS_UNKN_ENTRY = 3 ,
SOC_CALADAN3_PPE_RULE_rS6_MPLS3_ENTRY = 4 ,
SOC_CALADAN3_PPE_RULE_rS6_MPLS4_ENTRY = 5 ,
SOC_CALADAN3_PPE_RULE_rS6_UDP_PTP0_ENTRY = 6 ,
SOC_CALADAN3_PPE_RULE_rS6_UDP_PTP1_ENTRY = 7 ,
SOC_CALADAN3_PPE_RULE_rS6_UDP_UNKN_ENTRY = 8 ,
...
SOC_CALADAN3_PPE_RULE_rS0_EGR_ERH_ENTRY = 112 ,
...
} soc_sbx_t3p1_ppe_rule_id_t; 

typedef struct {
  uint32 cam_id_first;
  uint32 cam_id_last;
  soc_sbx_t3p1_ppe_rule_id_t rule_id;
  uint32 rule_enable;
  soc_sbx_caladan3_ppe_tcamdata_t tcam;
  soc_sbx_caladan3_ppe_camram_t   camram;
} soc_sbx_t3p1_ppe_rule_t;
...
} soc_sbx_t3p1_ppe_packet_VLAN_t;
...
} soc_sbx_t3p1_ppe_packet_SNAP_t;


typedef struct {
  int  len;  /* size=16 offset=0*/
} soc_sbx_t3p1_ppe_packet_LLC_t;


typedef struct {
  int  value;  /* size=16 offset=0*/
} soc_sbx_t3p1_ppe_packet_ETYPE_t;
...
} soc_sbx_t3p1_ppe_packet_ETYPE_PTP_t;
...
} soc_sbx_t3p1_ppe_packet_IPV4_t;
...
} soc_sbx_t3p1_ppe_packet_IPV6_t;
...
} soc_sbx_t3p1_ppe_packet_UDP_PTP_t;
...
} soc_sbx_t3p1_ppe_packet_MPLS_t;
...
} soc_sbx_t3p1_ppe_packet_ACH_t;


typedef struct {
  int  null;  /* size=0 offset=0*/
} soc_sbx_t3p1_ppe_packet_NULL_t;
...
typedef struct {
  ...
  int  s;  /* size=1 offset=87*/
  int  ttl;  /* size=8 offset=88*/
} soc_sbx_t3p1_ppe_packet_EERH_t;


typedef struct {
  int  ksop;  /* size=8 offset=0*/
} soc_sbx_t3p1_ppe_packet_KBYTE_t;
...
} soc_sbx_t3p1_ppe_packet_ITHM_t;
...
typedef struct {
  ...
  int  s;  /* size=1 offset=119*/
  int  ttl;  /* size=8 offset=120*/
} soc_sbx_t3p1_ppe_packet_OTMH_t;
...
typedef struct {
  ...
  int  s;  /* size=1 offset=119*/
  int  ttl;  /* size=8 offset=120*/
} soc_sbx_t3p1_ppe_packet_TMH_t;


typedef struct {
  int  isid;  /* size=32 offset=0*/
} soc_sbx_t3p1_ppe_packet_MIM_t;
...
} soc_sbx_t3p1_ppe_packet_ETH_ETYPE_t;
...
} soc_sbx_t3p1_ppe_packet_TWO_VLAN_t;


typedef struct {
  int  private_header;  /* size=32 offset=0*/
} soc_sbx_t3p1_ppe_packet_CUSTOM_t;
...
} soc_sbx_t3p1_ppe_packet_ETYPE_MPLS_t;
...
} soc_sbx_t3p1_ppe_packet_ETYPE_MPLS_MPLS_t;
...
} soc_sbx_t3p1_ppe_packet_MPLS_MPLS_t;
...
typedef struct {
  ...
  int  pwe_bfd;  /* size=1 offset=15*/
  int  lsp_gal;  /* size=1 offset=16*/
...
} soc_sbx_t3p1_ppe_variable_ing_ppevar_t;


typedef struct {
  int  pm_enable;  /* size=1 offset=0*/
  int  loopback;  /* size=1 offset=1*/
  int  pwe_y1731;  /* size=1 offset=2*/
} soc_sbx_t3p1_ppe_variable_egr_ppevar_t;
...
} soc_sbx_t3p1_ppe_cam_state_mask_parse_state_t;
...
} soc_sbx_t3p1_ppe_cam_state_mask_initial_queue_state_t;
...
} soc_sbx_t3p1_ppe_cam_state_mask_lsmac_state_t;


typedef struct {
  int  tpid;  /* size=16 offset=0*/
} soc_sbx_t3p1_ppe_cam_state_mask_tpid_state_t;
...
#define SOC_SBX_T3P1_PPE_HASHT_hVLAN_PRI 0
#define SOC_SBX_T3P1_PPE_HASHT_hETH_MAC 4
#define SOC_SBX_T3P1_PPE_HASHT_hETH_DMAC 5
#define SOC_SBX_T3P1_PPE_HASHT_hETH_SMAC 6
#define SOC_SBX_T3P1_PPE_HASHT_hETH_DMAC_IPV4 7
#define SOC_SBX_T3P1_PPE_HASHT_hVLAN_VID_TWO 8
#define SOC_SBX_T3P1_PPE_HASHT_hVLAN_VID 9
#define SOC_SBX_T3P1_PPE_HASHT_hVLAN_VID_C 10
#define SOC_SBX_T3P1_PPE_HASHT_hIPV4 11
#define SOC_SBX_T3P1_PPE_HASHT_hIPV4_DA 12
#define SOC_SBX_T3P1_PPE_HASHT_hIPV4_SA 13
#define SOC_SBX_T3P1_PPE_HASHT_hIPV6 14
#define SOC_SBX_T3P1_PPE_HASHT_hIPV6_DA 15
#define SOC_SBX_T3P1_PPE_HASHT_hIPV6_SA 16
#define SOC_SBX_T3P1_PPE_HASHT_hL4_PORT 17
#define SOC_SBX_T3P1_PPE_HASHT_hL4_DPORT 18
#define SOC_SBX_T3P1_PPE_HASHT_hL4_SPORT 19



#endif /* BCM_CALADAN3_T3P1_SUPPORT */
#endif /* _SB_T3P1_FE_PP_RULE_ENCODE_H_ */
