 ...
 * $Id: c3_1x40g_8x10g_1xil100.h,v 1.1.2.3 Broadcom SDK $
 */
#ifdef BCM_CALADAN3_SUPPORT

sws_config_t c3_1x40g_8x10g_1xil100_cfg = {
     ...
     */
     {
        /* Buffer Thresholds */
        {
           ...
           1608, 0x3fff, 322, 11861, 8896, 5931, 10616, 1187, 38
        },
        ...
        9, 
        {
	    {589, 442, 295, 0x3fff, 35, 35}, /* 0 */
            { 0 }, /* 1 */
            { 0 }, /* 2 */
            { 0 }, /* 3 */
            {204, 153, 102, 0x3fff, 52, 52}, /* 4 */
            {204, 153, 102, 0x3fff, 52, 52}, /* 5 */
            {204, 153, 102, 0x3fff, 52, 52}, /* 6 */
            {204, 153, 102, 0x3fff, 52, 52}, /* 7 */
            {204, 153, 102, 0x3fff, 52, 52}, /* 8 */
            {204, 153, 102, 0x3fff, 52, 52}, /* 9 */
            {204, 153, 102, 0x3fff, 52, 52}, /* 10 */
            {204, 153, 102, 0x3fff, 52, 52}, /* 11 */
            { 0 }, /* 12 */
            { 0 }, /* 13 */
            { 0 }, /* 14 */
            { 0 }, /* 15 */
        ...
        },
        {
            ...
            {638, 479, 319, 229, 49, 49}, /* 8 */
            {638, 479, 319, 229, 49, 49}, /* 9 */
            {638, 479, 319, 229, 49, 49}, /* 10 */
            {638, 479, 319, 229, 49, 49}, /* 11 */
            { 0 }, /* 12 */
            { 0 }, /* 13 */
            { 0 }, /* 14 */
            { 0 }, /* 15 */
