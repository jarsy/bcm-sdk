...
#ifndef INCLUDED_NLMCMRBTREE_PTR_H
#define INCLUDED_NLMCMRBTREE_PTR_H

/* We have to use a typedef or else we get compiler errors with 'const const' */
typedef const void * NlmCmRBCnstVoidPtr ;

#define NlmCmRBNodeDataType		NlmCmRBCnstVoidPtr
#define NlmCmRBNameSuffix		Ptr
...
#define NlmCmRBTreePtr__GetItemCount(self)	NlmCmRBTree__GetItemCount(self)
#define NlmCmRBItorPtr__Here(self)		NlmCmRBItor__Here(self)
#define	NlmCmRBItorPtr__Base(self)		NlmCmRBItor__Base(self)
