...
#define NLMDEV_LUT_INSTRUCTION_START_BIT      (21)    /* 9b opcode for instructions */
...
#define NLMDEV_LUT_IDX_OR_AD_NUM_BYTE_START_BIT(x)  (36 + (5 * x) )     /* index/asso-data in bytes */
#define NLMDEV_LUT_IDX_OR_AD_NUM_BYTE_END_BIT(x)    (39 + (5 * x) )

#define NLMDEV_LUT_IDX_OR_AD_BIT(x)                 (40 + (5 * x) ) /* either index/asso-data */
