...
#define SOC_DPP_COUNTER_FIFO_DEPTH_QUX                       (64 * 1024)
#define SOC_DPP_PDM_SIZE_QUX                                 (1024*1024*3)
#define SOC_DPP_NOF_INSTANCES_FSRD_QUX                       (3)
#define SOC_DPP_NOF_QUADS_IN_FSRD_QUX                        (3)
...
#define SOC_DPP_NOF_FABRIC_LINKS_IN_MAC_QUX                  (4)
...
#define SOC_DPP_NOF_OUT_LIFS_QUX                             (160 * 1024)
...
#define SOC_DPP_NOF_EEDB_PAYLOADS_QUX                        (86)
...
#define SOC_DPP_NOF_GLEM_BANKS_QUX                           (8)
#define SOC_DPP_ESEM_WIDTH_QUX                               (40)
#define SOC_DPP_NOF_ESEM_LINES_QUX                           (32 * 1024)
#define SOC_DPP_NOF_ESEM_PAYLOADS_QUX                        (17)
#define SOC_DPP_MULTICAST_GROUP_NOF_BITS_QUX                 (17)
#define SOC_DPP_NOF_MULTICAST_GROUPS_QUX                     (128 * 1024)
...
#define SOC_DPP_OAM_2_ID_NOF_BITS_QUX                        (11)
...
#define SOC_DPP_ECMP_MAX_SIZE_QUX                            (512)
...
#define SOC_DPP_JUMBO_MAX_SIZE_QUX                           (0x3FFF)
...
#define SOC_DPP_NOF_INTERLAKEN_PORTS_QUX                     (4)
#define SOC_DPP_NOF_CAUI_PORTS_QUX                           (6)
#define SOC_DPP_NOF_FC_PFC_GENERIC_BITMAPS_QUX               (80)
...
#define SOC_DPP_MAX_GBPS_RATE_EGQ_QUX                        (500)
#define SOC_DPP_MAX_GBPS_RATE_SCH_QUX                        (500)
#define SOC_DPP_SIZE_OF_OAM_KEY_QUX                          (18)
#define SOC_DPP_FC_INB_CAL_LEN_MAX_QUX                       (512)
...
#define SOC_DPP_FIELD_LARGE_DIRECT_LU_KEY_LENGTH_QUX         (14)
