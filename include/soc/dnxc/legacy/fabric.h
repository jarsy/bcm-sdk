...
#define SOC_DNXC_FABRIC_MESH_TOPOLOGY_LIST_MAX          (72)
...
typedef enum dnxc_fabric_device_type_e {
    dnxcFabricDeviceTypeUnknown, /* Unknown device type */
    dnxcFabricDeviceTypeFE13,    /* FE13 device type */
    dnxcFabricDeviceTypeFE2,     /* FE2 device type */
    dnxcFabricDeviceTypeFAP,     /* FAP device type */
    dnxcFabricDeviceTypeFE1,     /* FE1 device type */
    dnxcFabricDeviceTypeFE3,     /* FE3 device type */
    dnxcFabricDeviceTypeFIP,     /* FIP device type */
    dnxcFabricDeviceTypeFOP      /* FOP device type */
...
int soc_dnxc_fabric_pipe_map_initalize_valid_configurations(int unit, int min_tdm_priority, soc_dnxc_fabric_pipe_map_t* fabric_pipe_map_valid_config);
soc_error_t soc_dnxc_fabric_mesh_topology_diag_get(int unit, soc_dnxc_fabric_mesh_topology_diag_t *mesh_topology_diag);


#endif /*_SOC_DNXC_FABRIC_H*/
