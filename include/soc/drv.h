...
#define PGW_GE_BLOCK(unit, instance)    ((((instance) >= 0) && ((instance) < 2)) ? SOC_INFO(unit).pgw_ge_block[(instance)] : (-1))
...
#define EPRE_BLOCK(unit, instance) ((((instance) >= 0) && ((instance) < SOC_MAX_NUM_EPRE_BLKS)) ? SOC_INFO(unit).epre_block[instance] : (-1))
#define FDTL_BLOCK(unit) (SOC_INFO(unit).fdtl_block)
...
#define CDUM_BLOCK(unit, instance) ((((instance) >= 0) && ((instance) < SOC_MAX_NUM_CDUM_BLKS)) ? SOC_INFO(unit).cdum_block[instance] : (-1))
#define SOC_MAX_NUM_EPS_BLKS 2
#define EPS_BLOCK(unit, instance) ((((instance) >= 0) && ((instance) < SOC_MAX_NUM_EPS_BLKS)) ? SOC_INFO(unit).eps_block[instance] : (-1))
...
#define NMG_BLOCK(unit, instance) ((((instance) >= 0) && ((instance) < SOC_MAX_NUM_NMG_BLKS)) ? SOC_INFO(unit).nmg_block[instance] : (-1))
...
#define ETPPC_BLOCK(unit, instance) ((((instance) >= 0) && ((instance) < SOC_MAX_NUM_ETPPC_BLKS)) ? SOC_INFO(unit).etppc_block[instance] : (-1))
...
#define SOC_MAX_NUM_HBC_BLKS 18
...
#define ILE_BLOCK(unit, instance) ((((instance) >= 0) && ((instance) < SOC_MAX_NUM_ILE_BLKS)) ? SOC_INFO(unit).ile_block[instance] : (-1))
#define SOC_MAX_NUM_IPPE_BLKS 2
#define IPPE_BLOCK(unit, instance) ((((instance) >= 0) && ((instance) < SOC_MAX_NUM_IPPE_BLKS)) ? SOC_INFO(unit).ippe_block[instance] : (-1))
#define SOC_MAX_NUM_TCAM_BLKS 2
#define TCAM_BLOCK(unit, instance) ((((instance) >= 0) && ((instance) < SOC_MAX_NUM_TCAM_BLKS)) ? SOC_INFO(unit).tcam_block[instance] : (-1))
#define SOC_MAX_NUM_TDU_BLKS 2
#define TDU_BLOCK(unit, instance) ((((instance) >= 0) && ((instance) < SOC_MAX_NUM_TDU_BLKS)) ? SOC_INFO(unit).tdu_block[instance] : (-1))
...
typedef struct {
    ...
    int             iproc_block;
    int             crypto_block;
    int             pgw_ge_block[2];        /* PGW_GE blocks*/
    /* SBX only blocks */
    ...
    int             xlb0port_block;         /* xlb0port block */
    int             cm_block;
    ...
    int             nof_pmqs;
        ...
        int             ocb_block[SOC_MAX_NUM_OCB_BLKS];
        int             crps_block;
        int             epre_block[SOC_MAX_NUM_EPRE_BLKS];
        int             fdtl_block;
        int             eci_block;
        ...
        int             pqp_block[SOC_MAX_NUM_PQP_BLKS];
        int             ire_block;
        int             irr_block;
        ...
        int             oamp_block;
        int             olp_block;
        int             sif_block[SOC_MAX_NUM_SIF_BLKS];
        int             mcp_block[SOC_MAX_NUM_MCP_BLKS];
        int             itpp_block[SOC_MAX_NUM_ITPP_BLKS];
        int             pdm_block[SOC_MAX_NUM_PDM_BLKS];
        int             cdu_block[SOC_MAX_NUM_CDU_BLKS];
        int             cdum_block[SOC_MAX_NUM_CDUM_BLKS];
        int             eps_block[SOC_MAX_NUM_EPS_BLKS];
        int             hbmc_block[SOC_MAX_NUM_HBMC_BLKS];
        int             ilu_block[SOC_MAX_NUM_ILU_BLKS];
        int             nmg_block[SOC_MAX_NUM_NMG_BLKS];
        ...
        int             etppc_block[SOC_MAX_NUM_ETPPC_BLKS];
        int             evnt_block[SOC_MAX_NUM_EVNT_BLKS];
        int             hbc_block[SOC_MAX_NUM_HBC_BLKS];
        int             ile_block[SOC_MAX_NUM_ILE_BLKS];
        int             ippe_block[SOC_MAX_NUM_IPPE_BLKS];
        int             tcam_block[SOC_MAX_NUM_TCAM_BLKS];
        int             tdu_block[SOC_MAX_NUM_TDU_BLKS];

        int             bdm_block[SOC_MAX_NUM_BDM_BLKS];
        int             mtm_block;
        int             hbm_block[SOC_MAX_NUM_HBM_BLKS];
        int             rqp_block[SOC_MAX_NUM_RQP_BLKS];
        int             fqp_block[SOC_MAX_NUM_FQP_BLKS];
        int             mdb_block;
        int             erpp_block[SOC_MAX_NUM_ERPP_BLKS];
        int             etppa_block[SOC_MAX_NUM_ETPPA_BLKS];
        int             etppb_block[SOC_MAX_NUM_ETPPB_BLKS];
        int             mact_block;
        int             ippa_block[SOC_MAX_NUM_IPPA_BLKS];
        int             ippb_block[SOC_MAX_NUM_IPPB_BLKS];
        int             ippc_block[SOC_MAX_NUM_IPPC_BLKS];
        int             ippd_block[SOC_MAX_NUM_IPPD_BLKS];
        ...
        int             sqm_block;
        int             ipsec_block;
        int             ipsec_spu_wrapper_top_block[SOC_MAX_NUM_IPSEC_SPU_WRAPPER_TOP_BLKS];
    ...
    char            port_name_alter[SOC_MAX_NUM_PP_PORTS][11];
    ...
    char            port_name_alter[SOC_MAX_NUM_PORTS][11];
...
#define SOC_RECONFIG_TDM (SOC_IS_CALADAN3(unit) && SOC_CONTROL(unit)->reconfig_flag)
    int             hotswap_flag;          /* True when doing hotswap */
#define SOC_HOTSWAP_TDM (SOC_IS_CALADAN3(unit) && SOC_CONTROL(unit)->hotswap_flag)
...
#define         SOC_DMA_UNLOCK(l)    (void)sal_spl(l)
    sdc_t       soc_channels[SOC_CMCS_NUM_MAX * N_DMA_CHAN];
...
#define SOC_PSTATS_UNLOCK(unit) \
    ...
    sal_mutex_t fp_lock;               /* L3 module lock */
