...
typedef struct 
{
	...
	AG_BOOL 				b_t1;
	AG_BOOL					b_esf;
	AG_BOOL 				b_transmit_crc;
	AG_BOOL					b_recive_crc;
	AG_U8					n_singling_format;
...
AG_BOOL ag_unstruct(AG_U32 n_port);

void ag_init_alarm_array(void);

int ag_get_active_line(void);
