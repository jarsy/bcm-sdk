...
/******************************************************************
*
* FILENAME:       DuneDriver/DNX_SAND/Utils/include/dnx_sand_header.h
*
* MODULE PREFIX:  DNX_SAND
*
* FILE DESCRIPTION:
*
* REMARKS:
...
#define __ATTRIBUTE_PACKED__  __DNX_SAND_USER_DEFINED_ATTRIBUTE_PACKED__
