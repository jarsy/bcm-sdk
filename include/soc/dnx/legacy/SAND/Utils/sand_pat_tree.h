...
#ifndef __DNX_SAND_PAT_INCLUDED__
/* { */
#define __DNX_SAND_PAT_INCLUDED__
...
#define DNX_SAND_PAT_TREE_NOF_NODE_CHILD 2
#define DNX_SAND_PAT_TREE_PREFIX_MAX_LEN 32
#define DNX_SAND_PAT_TREE_NULL DNX_SAND_U32_MAX
#define DNX_SAND_PAT_TREE_PREFIX_INVALID 255
...
#define DNX_SAND_PAT_TREE_FIND_IDENTICAL 1
/* for optimization store and reuse last traverse node */
#define DNX_SAND_PAT_TREE_FIND_LOAD_NODE 2
#define DNX_SAND_PAT_TREE_FIND_STORE_NODE  4
/* find exact key */
#define DNX_SAND_PAT_TREE_FIND_EXACT  8
...
#define DNX_SAND_PAT_TREE_ITER_IS_END(iter)    \
            (((iter)->arr[0] == DNX_SAND_PAT_TREE_NULL) && (((iter)->arr[1] == DNX_SAND_PAT_TREE_NULL)))

#define DNX_SAND_PAT_TREE_IS_CACHED_INST( _inst)   \
        (uint8)DNX_SAND_GET_BITS_RANGE(_inst,31,31)

#define DNX_SAND_PAT_TREE_TREE_INST( _inst)   \
...
typedef  uint32 DNX_SAND_PAT_TREE_KEY;
typedef uint32 DNX_SAND_PAT_TREE_NODE_PLACE;


/* $Id: sand_pat_tree.h,v 1.8 Broadcom SDK $
 * the ADT of Patricia tree, use this type to manipulate the PAT tree
 */
typedef uint32  DNX_SAND_PAT_TREE_ID;
...
typedef enum
{
   ...
   *  table.
   */
  DNX_SAND_PAT_TREE_ITER_TYPE_FAST=0,
  /*
   *  According to this type the iterator traverse the table
   *  ordered according to (IP, Prefix), it's slower than the
   *  fast type.
   */
  DNX_SAND_PAT_TREE_ITER_TYPE_KEY_PREFIX_ORDERED=1,
  /*
   *  According to this type the iterator traverse the table
   *  ordered according to (Prefix, IP), it's slower than the
   *  previous types (fast and (IP, Prefix)).
   */
  DNX_SAND_PAT_TREE_ITER_TYPE_PREFIX_KEY_ORDERED=2
}DNX_SAND_PAT_TREE_ITER_TYPE;
...
typedef struct
{
  DNX_SAND_PAT_TREE_NODE_PLACE child[DNX_SAND_PAT_TREE_NOF_NODE_CHILD];
 /*
  *  Drop, Route or Trap
  */
  DNX_SAND_PAT_TREE_KEY key;
 /*
  ...
  */
  ...
  uint8 is_prefix;
}DNX_SAND_PAT_TREE_NODE;



/*********************************************************************
* NAME:
*     DNX_SAND_PAT_TREE_SW_DB_TREE_INFO_SET
* FUNCTION:
*  call back to set information from the SW DB of the device.
* INPUT:
*  DNX_SAND_IN  uint32              tree_ndx -
*   handle of the tree to set the info for.
*  DNX_SAND_OUT  DNX_SAND_PAT_TREE_T*      pat_tree -
...
typedef
  uint32
    (*DNX_SAND_PAT_TREE_SW_DB_TREE_ROOT_SET)(
      DNX_SAND_IN  int                     prime_handle,
      DNX_SAND_IN  uint32                     sec_handle,
      DNX_SAND_IN  DNX_SAND_PAT_TREE_NODE_PLACE     root_place
    );

/*********************************************************************
* NAME:
*     DNX_SAND_PAT_TREE_SW_DB_TREE_INFO_GET
* FUNCTION:
...
typedef
  uint32
    (*DNX_SAND_PAT_TREE_SW_DB_TREE_ROOT_GET)(
      DNX_SAND_IN  int                     prime_handle,
      DNX_SAND_IN  uint32                     sec_handle,
      DNX_SAND_OUT  DNX_SAND_PAT_TREE_NODE_PLACE    *root_place
    );


/*********************************************************************
* NAME:
*     DNX_SAND_PAT_TREE_SW_DB_TREE_NODE_INFO_SET
* FUNCTION:
*  call back to set the node information from the SW DB of the device.
* INPUT:
*  DNX_SAND_IN  uint32              tree_ndx -
*   handle of the tree to set the info for.
*  DNX_SAND_IN  uint32               node_place -
*   the place of the node in the memory "array".
*  DNX_SAND_IN DNX_SAND_PAT_TREE_NODE     *node_info -
...
typedef
  uint32
    (*DNX_SAND_PAT_TREE_SW_DB_TREE_NODE_INFO_SET)(
      DNX_SAND_IN  int                   prime_handle,
      DNX_SAND_IN  uint32                   sec_handle,
      DNX_SAND_IN DNX_SAND_PAT_TREE_NODE_PLACE    node_place,
      DNX_SAND_IN DNX_SAND_PAT_TREE_NODE          *node_info
    );
...
/*********************************************************************
* NAME:
*     DNX_SAND_PAT_TREE_SW_DB_TREE_NODE_INFO_GET
* FUNCTION:
*  call back to set the node information from the SW DB of the device.
* INPUT:
*  DNX_SAND_IN  uint32              tree_ndx -
...
typedef
  uint32
    (*DNX_SAND_PAT_TREE_SW_DB_TREE_NODE_INFO_GET)(
      ...
      DNX_SAND_IN  uint32                 sec_handle,
      DNX_SAND_IN DNX_SAND_PAT_TREE_NODE_PLACE  node_place,
      DNX_SAND_OUT DNX_SAND_PAT_TREE_NODE       *node_info
    );
/*********************************************************************
* NAME:
*     DNX_SAND_PAT_TREE_SW_DB_TREE_NODE_INFO_GET
...
typedef
  uint32
    (*DNX_SAND_PAT_TREE_SW_DB_TREE_NODE_REF_GET)(
      DNX_SAND_IN  int                 prime_handle,
      DNX_SAND_IN  uint32                 sec_handle,
      DNX_SAND_IN DNX_SAND_PAT_TREE_NODE_PLACE  node_place,
      DNX_SAND_OUT DNX_SAND_PAT_TREE_NODE       **node_info
...
/*********************************************************************
* NAME:
*     DNX_SAND_PAT_TREE_NODE_IS_SKIP_IN_LPM_IDENTICAL_DATA_QUERY_FUN
* FUNCTION:
...
/*********************************************************************
* NAME:
*     DNX_SAND_PAT_TREE_NODE_DATA_IS_IDENTICAL_FUN
* FUNCTION:
...
* INPUT:
*  DNX_SAND_IN DNX_SAND_PAT_TREE_NODE     *node_info_0 -
*   the information of the node.
*  DNX_SAND_IN DNX_SAND_PAT_TREE_NODE     *node_info_1 -
*   the information of the node.
* REMARKS:
*     None.
* RETURNS:
...
typedef struct
{
  ...
  */
  uint8 prefix;
}DNX_SAND_PAT_TREE_NODE_KEY;


typedef struct {
  DNX_SAND_MAGIC_NUM_VAR

  DNX_SAND_PAT_TREE_NODE_PLACE root;
  /*
   * the memory to allocate from the nodes of the tree
  */
  DNX_SAND_PAT_TREE_NODE *tree_memory;
  /*
   ...
   * Added here specifically for JER2_ARAD which still uses old interface to
   * occupation bit map (old sw state)
   */
  DNX_SAND_OCC_BM_T *memory_use_ptr ;
  /*
  ...
  DNX_SAND_PAT_TREE_NODE *tree_memory_cache;
  DNX_SAND_PAT_TREE_NODE_PLACE root_cache;

  /* use to optimize commit, to do from the relevant (changed) subtree*/
  DNX_SAND_PAT_TREE_NODE_KEY cache_change_head;

  /* for traverse optimization*/
  DNX_SAND_PAT_TREE_NODE_PLACE current_node_place;
...
typedef struct {
  ...
  */
  uint32
    tree_size;
  DNX_SAND_PAT_TREE_SW_DB_TREE_NODE_INFO_SET node_set_fun;
  DNX_SAND_PAT_TREE_SW_DB_TREE_NODE_INFO_GET node_get_fun;
  DNX_SAND_PAT_TREE_SW_DB_TREE_NODE_REF_GET node_ref_get_fun;
  DNX_SAND_PAT_TREE_SW_DB_TREE_ROOT_SET root_set_fun;
  DNX_SAND_PAT_TREE_SW_DB_TREE_ROOT_GET root_get_fun;
  DNX_SAND_PAT_TREE_NODE_DATA_IS_IDENTICAL_FUN node_data_is_identical_fun;
  DNX_SAND_PAT_TREE_NODE_IS_SKIP_IN_LPM_IDENTICAL_DATA_QUERY_FUN node_is_skip_in_lpm_identical_data_query_fun;
  int prime_handle;
  uint32
    sec_handle;
  uint8
...
typedef struct
{
  ...
  *  the data of the node
  */
  DNX_SAND_PAT_TREE_NODE_KEY  key;
  DNX_SAND_PAT_TREE_NODE_DATA data;
  /* id/place of node */
  DNX_SAND_PAT_TREE_NODE_PLACE node_place;

}DNX_SAND_PAT_TREE_NODE_INFO;
...
typedef struct
{
  ...
  DNX_SAND_PAT_TREE_NODE_DATA_IS_IDENTICAL_FUN node_data_is_identical_fun;
  DNX_SAND_PAT_TREE_NODE_IS_SKIP_IN_LPM_IDENTICAL_DATA_QUERY_FUN node_is_skip_in_lpm_identical_data_query_fun;
}DNX_SAND_PAT_TREE_LOAD_INFO;

/*********************************************************************
* NAME:
*     DNX_SAND_PAT_TREE_FOREACH_FUN
* FUNCTION:
*  call back to invoke on each node in PAT tree 
*  
*  By default (if not set, or set to NULL), bitwise comparison is used.
* INPUT:
*  DNX_SAND_IN DNX_SAND_PAT_TREE_INFO       *tree_info -
*    tree info
*  DNX_SAND_IN void                     *vparam -
*   free argument
* REMARKS:
*     None.
* RETURNS:
...
typedef
  uint32
    (*DNX_SAND_PAT_TREE_FOREACH_FUN)(
      DNX_SAND_INOUT DNX_SAND_PAT_TREE_INFO *pat_tree,
      DNX_SAND_IN DNX_SAND_PAT_TREE_KEY key,
      DNX_SAND_IN uint8 prefix,
      DNX_SAND_INOUT uint32 *data,
      DNX_SAND_IN uint8 is_prefix,
      DNX_SAND_INOUT void* vparam
    );
...
* INPUT:
*   DNX_SAND_INOUT  DNX_SAND_PAT_TREE_INFO       *tree_info -
...
* INPUT:
*  DNX_SAND_OUT  DNX_SAND_PAT_TREE_INFO pat_tree -
...
uint32
  dnx_sand_pat_tree_clear_nodes(
    DNX_SAND_INOUT  DNX_SAND_PAT_TREE_INFO       *tree_info_ndx
  );

/*********************************************************************
* NAME:
*     dnx_sand_pat_tree_root_reset
* TYPE:
*   PROC
* FUNCTION:
*   in order to optimize clearing all patricia trees/
*   call dnx_sand_pat_tree_clear once then this API for each patricia tree
* INPUT:
*  DNX_SAND_OUT  DNX_SAND_PAT_TREE_INFO pat_tree -
*     The Patricia Tree to destroy.
* REMARKS:
...
*   DNX_SAND_IN  DNX_SAND_PAT_TREE_NODE_KEY  *node_key -
*     The key to add into the Patricia Tree
*   DNX_SAND_IN  DNX_SAND_PAT_TREE_NODE_DATA  *node_data -
...
*   DNX_SAND_IN  uint8                  identical_payload -
...
*   DNX_SAND_OUT  DNX_SAND_PAT_TREE_NODE_INFO   *lpm_info -
...
uint32
  dnx_sand_pat_tree_node_at_place(
    DNX_SAND_IN  DNX_SAND_PAT_TREE_INFO        *tree_info_ndx,
    DNX_SAND_IN  DNX_SAND_PAT_TREE_NODE_PLACE  node_place,
    DNX_SAND_OUT  DNX_SAND_PAT_TREE_NODE_INFO   *lpm_info,
...
uint32
  dnx_sand_pat_tree_head_key_of_changes(
    DNX_SAND_IN  DNX_SAND_PAT_TREE_INFO     *tree_info_ndx,
    DNX_SAND_OUT  DNX_SAND_PAT_TREE_NODE_KEY     *cached_head
  );


/*********************************************************************
* NAME:
*     dnx_sand_pat_tree_get_block
* TYPE:
*   PROC
* DATE:
*   May 27 2008
...
*   DNX_SAND_IN  DNX_SAND_PAT_TREE_INFO       *tree_info -
*     The Patricia Tree instance.
*   DNX_SAND_IN DNX_SAND_PAT_TREE_ITER_TYPE     iter_type -
...
*   DNX_SAND_IN  DNX_SAND_PAT_TREE_INFO       *tree_info -
*     The Patricia Tree instance.
*   DNX_SAND_OUT  uint32                    *total_nodes -
*     Total nodes (prefix/glue) inserted to the PAT tree.
*   DNX_SAND_OUT  uint32                    *prefix_nodes -
*     prefix nodes inserted to the PAT tree.
*   DNX_SAND_OUT  uint32                    *free_nodes -
...
*   DNX_SAND_IN  DNX_SAND_PAT_TREE_INFO       *tree_info -
*     The Patricia Tree instance.
*   DNX_SAND_IN  DNX_SAND_PAT_TREE_FOREACH_FUN       fun -
*     Function to apply.
*   DNX_SAND_INOUT void                       *param - 
...
uint32
  dnx_sand_pat_tree_cache_set(
    DNX_SAND_INOUT  DNX_SAND_PAT_TREE_INFO        *tree_info_ndx,
    DNX_SAND_IN  uint8             cached
  );

uint32
  dnx_sand_pat_tree_cache_commit(
    DNX_SAND_INOUT  DNX_SAND_PAT_TREE_INFO        *tree_info_ndx,
    DNX_SAND_IN  uint32               flags
  );

uint32
  dnx_sand_pat_tree_cache_rollback(
    DNX_SAND_INOUT  DNX_SAND_PAT_TREE_INFO        *tree_info_ndx,
    DNX_SAND_IN  uint32               flags
  );
...
/*********************************************************************
* NAME:
*     dnx_sand_pat_tree_get_size_for_save
* TYPE:
*   PROC
* DATE:
*   Mar  6 2008
...
* INPUT:
*   DNX_SAND_IN  DNX_SAND_PAT_TREE_PTR tree_info -
...
*     by dnx_sand_pat_tree_get_size_for_save.
...
*     the hash function of the pat-tree.
*   DNX_SAND_OUT  DNX_SAND_PAT_TREE_PTR tree_info -
...
uint32
  dnx_sand_pat_tree_load(
    DNX_SAND_IN  uint8                           **buffer,
    DNX_SAND_IN  DNX_SAND_PAT_TREE_LOAD_INFO           *load_info,
    DNX_SAND_OUT DNX_SAND_PAT_TREE_INFO               *tree_info
  );  

void
  dnx_sand_SAND_PAT_TREE_LOAD_INFO_clear(
    DNX_SAND_PAT_TREE_LOAD_INFO *info
  );
void
  dnx_sand_SAND_PAT_TREE_INFO_clear(
    DNX_SAND_PAT_TREE_INFO *info
  );

#if DNX_SAND_DEBUG

uint32
  dnx_sand_pat_tree_print(
    DNX_SAND_IN  DNX_SAND_PAT_TREE_INFO       *tree_info_ndx,
    DNX_SAND_IN  DNX_SAND_PAT_TREE_NODE_PLACE   node_place,
    DNX_SAND_IN  uint8                  including_glue,
    DNX_SAND_IN  uint8                  print_subtree
  );
...
/* } __DNX_SAND_PAT_TREE_INCLUDED__*/
#endif
