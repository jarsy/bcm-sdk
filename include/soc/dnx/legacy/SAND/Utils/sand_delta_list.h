...
*/
#ifndef DNX_SAND_DELTA_LIST_H
#define DNX_SAND_DELTA_LIST_H
#ifdef  __cplusplus
extern "C" {
#endif
/* $Id: sand_delta_list.h,v 1.4 Broadcom SDK $
 ...
 */
typedef struct soc_dnx_list_node_str
{
  void                 *data;
  uint32         num;
  struct soc_dnx_list_node_str *next;
 ...
 * DNX_SAND_DELTA_LIST as a param, and "work" on it.
 */
typedef struct
{
  DNX_SAND_DELTA_LIST_NODE       *head;
  uint32                         head_time;
  sal_mutex_t                    mutex_id;
  sal_thread_t                   mutex_owner;
  int32                          mutex_counter;
  DNX_SAND_DELTA_LIST_STATISTICS stats;
} DNX_SAND_DELTA_LIST;
 ...
 */
DNX_SAND_DELTA_LIST
  *dnx_sand_delta_list_create(void);
/*
