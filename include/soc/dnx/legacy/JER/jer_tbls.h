...
#ifndef _SOC_DNX_JER2_JER_TBLS_H
#define _SOC_DNX_JER2_JER_TBLS_H
...
uint32 soc_jer2_jer_ihp_tbls_init (int unit);
uint32 soc_jer2_jer_ihb_tbls_init (int unit);
...
soc_error_t soc_jer2_jer_ipt_tbls_init (int unit);
uint32 soc_jer2_jer_fdt_tbls_init (int unit);
int soc_jer2_jerplus_fdt_tbls_init(int unit); /*used also for JER2_QAX*/
uint32 soc_jer2_jer_egq_tbls_init (int unit);
uint32 soc_jer2_jer_epni_tbls_init (int unit);
uint32 soc_jer2_jer_oamp_tbls_init (int unit);
uint32 soc_jer2_jer_mrps_tbls_init (int unit);
uint32 soc_jer2_jer_mrpsEm_tbls_init (int unit);
uint32 soc_jer2_jer_idr_tbls_init (int unit);
uint32 soc_jer2_jer_ppdb_tbls_init(int unit);
uint32 soc_jer2_jer_xlp_tbls_init(int unit);
uint32 soc_jer2_jer_clp_tbls_init(int unit);
int soc_jer2_jer_dynamic_tbls_reset (int unit);
 ...
 * Marks the table not to later be filled by soc_jer2_jerplus_tbls_init.
 */
...
#define JER2_JER_TBL_SOC_REF(unit, tbl_ptr, field, field_dst)       \
{                                                     \
    ...
    soc_field_info_t    *fieldinfo;                     \
        ...
        SOC_FIND_FIELD(field,                                   \
                       ...
                       fieldinfo);                              \
        if (NULL != fieldinfo) {                          \
            DNXC_SAND_IF_ERR_EXIT(dnx_sand_os_memcpy(field_dst, fieldinfo, sizeof(soc_field_info_t)));  \
                    }\
        else {\
...
#endif /* _SOC_DNX_JER2_JER_TBLS_H */
