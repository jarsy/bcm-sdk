/* $Id: jer2_jer2_jer2_tmc_api_cnm.h,v 1.7 Broadcom SDK $
 * $Copyright: (c) 2016 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
*/

#ifndef __DNX_TMC_API_CNM_INCLUDED__
/* { */
#define __DNX_TMC_API_CNM_INCLUDED__
...
#define  DNX_TMC_CNM_NOF_SAMPLING_BASES (8)

/*     Number of uint32s in the CP Id field in the PDU header    */
#define  DNX_TMC_CNM_NOF_UINT32S_IN_CP_ID (2)

/*     Number of CP profiles                                   */
#define  DNX_TMC_CNM_NOF_PROFILES (8)
...
typedef enum
{
   ...
   */
  DNX_TMC_CNM_GEN_MODE_SAMPLING = 2,

  /* Same as Petra-B PP */
  DNX_TMC_CNM_GEN_MODE_DUNE_PP = 3,

  /* HiGig Mode  - JER2_ARAD ONLY */
  DNX_TMC_CNM_GEN_MODE_HIGIG = 4,

  /*
   *  Number of types in DNX_TMC_CNM_GEN_MODE
   */
  DNX_TMC_CNM_NOF_GEN_MODES
}DNX_TMC_CNM_GEN_MODE;
...
typedef enum
{
   ...
   */
  DNX_TMC_CNM_Q_SET_4_CPS = 1,
  /*
   *  Number of types in DNX_TMC_CNM_Q_SET
   */
  DNX_TMC_CNM_NOF_Q_SETS = 2
}DNX_TMC_CNM_Q_SET;
...
} DNX_TMC_CNM_CONGESTION_TEST_INFO;
...
typedef struct
{
   ...
   *  (8K-1)*64.
   */
  uint32 sampling_base[DNX_TMC_CNM_NOF_SAMPLING_BASES];
  /*
...
typedef struct
{
   ...
   */
  uint32 cp_id_6_msb[DNX_TMC_CNM_NOF_UINT32S_IN_CP_ID];
...
typedef struct
{
   ...
   *  packets.
   */
  DNX_SAND_PP_MAC_ADDRESS mac_sa;
  /*
