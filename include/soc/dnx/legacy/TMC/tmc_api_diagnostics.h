...
#ifndef __DNX_TMC_API_DIAGNOSTICS_INCLUDED__
/* { */
#define __DNX_TMC_API_DIAGNOSTICS_INCLUDED__
...
#define DNX_TMC_DIAG_LAST_PCKT_SNAPSHOT_LEN_BYTES_PB                (64)
#define DNX_TMC_DIAG_LAST_PCKT_SNAPSHOT_LEN_BYTES_JER2_ARAD              (128)
#define DNX_TMC_DIAG_LAST_PCKT_SNAPSHOT_LEN_BYTES_MAX               DNX_SAND_MAX(DNX_TMC_DIAG_LAST_PCKT_SNAPSHOT_LEN_BYTES_JER2_ARAD, DNX_TMC_DIAG_LAST_PCKT_SNAPSHOT_LEN_BYTES_PB)
 ...
 *  DRAM status
 */
#define DNX_TMC_DIAG_NOF_DDR_TRAIN_SEQS               8
#define DNX_TMC_DIAG_NOF_DLLS_PER_DRAM                4

/*
 * Maximum size of received/sent packets in bytes
 */
#define DNX_TMC_DIAG_LBG_PAYLOAD_BYTE_SIZE         (256)
...
#define  DNX_TMC_DIAG_NOF_SONE_PER_SMS_MAX (8192)

/*     Maximal length (in longs) of the diagnostic chain.      */
#define  DNX_TMC_DIAG_CHAIN_LENGTH_MAX_IN_UINT32S (144)
...
typedef enum
{
  DNX_TMC_DIAG_PKT_HDR_U_TYPE      = 0x8,
  DNX_TMC_DIAG_PKT_HDR_F_TYPE      = 0x9,
  DNX_TMC_DIAG_PKT_HDR_M_TYPE      = 0xA,
  DNX_TMC_DIAG_PKT_HDR_IN_RCY_TYPE = 0xC,

  /*
   * Un-known type.
   * This type do not exist in the device.
   */
  DNX_TMC_DIAG_PKT_HDR_UNKOWN_TYPE = 0xFF

} DNX_TMC_DIAG_ING_PKT_HDR_TYPE;
...
typedef enum
{
   ...
   */
  DNX_TMC_DIAG_QDR_BIST_ADDR_MODE_NORMAL=0,
  /*
   ...
   */
  DNX_TMC_DIAG_QDR_BIST_ADDR_MODE_ADDRESS_SHIFT=1,
  /*
   ...
   *  data mode.
   */
  DNX_TMC_DIAG_QDR_BIST_ADDR_MODE_ADDRESS_TEST=2,

  DNX_TMC_DIAG_NOF_QDR_BIST_ADDR_MODES=3
}DNX_TMC_DIAG_QDR_BIST_ADDR_MODE;
...
typedef enum
{
   ...
   *  words.
   */
  DNX_TMC_DIAG_QDR_BIST_DATA_MODE_NORMAL=0,
  /*
   ...
   */
  DNX_TMC_DIAG_QDR_BIST_DATA_MODE_PATTERN_BIT=1,
  /*
   ...
   */
  DNX_TMC_DIAG_QDR_BIST_DATA_MODE_RANDOM=2,
  /*
   ...
   */
  DNX_TMC_DIAG_QDR_BIST_DATA_MODE_DATA_SHIFT=3,

  DNX_TMC_DIAG_NOF_QDR_BIST_DATA_MODES=4
}DNX_TMC_DIAG_QDR_BIST_DATA_MODE;
...
typedef enum
{
   ...
   *  DNX_TMC_DIAG_QDR_BIST_DATA_MODE. Random mode ignores these
   *  values.
   */
  DNX_TMC_DIAG_BIST_DATA_PATTERN_DIFF=0,
  /*
   ...
   *  values.
   */
  DNX_TMC_DIAG_BIST_DATA_PATTERN_ONE=1,
  /*
   ...
   *  values.
   */
  DNX_TMC_DIAG_BIST_DATA_PATTERN_ZERO=2,
  DNX_TMC_DIAG_NOF_BIST_DATA_PATTERNS=3
}DNX_TMC_DIAG_BIST_DATA_PATTERN;
...
typedef enum
{
   ...
   *  words.
   */
  DNX_TMC_DIAG_DRAM_BIST_DATA_MODE_NORMAL=0,
  /*
   ...
   */
  DNX_TMC_DIAG_DRAM_BIST_DATA_MODE_PATTERN_BIT=1,
  /*
   *  The PRBS will be used to generate the pattern towards
   *  the DRAM.
   */
  DNX_TMC_DIAG_DRAM_DATA_MODE_RANDOM=2,
  DNX_TMC_DIAG_NOF_DRAM_BIST_DATA_MODES =3
}DNX_TMC_DIAG_DRAM_BIST_DATA_MODE;
...
typedef enum
{
   ...
   */
  DNX_TMC_DIAG_SOFT_ERROR_PATTERN_ONE = 0,
  /*
   *  Fill the data to write by 000... (Bits).
   */
  DNX_TMC_DIAG_SOFT_ERROR_PATTERN_ZERO = 1,
  /*
   *  Fill the data to write by 1010101... (Bits).
   */
  DNX_TMC_DIAG_SOFT_ERROR_PATTERN_DIFF1 = 2,
  /*
   *  Fill the data to write by 0101010... (Bits).
   */
  DNX_TMC_DIAG_SOFT_ERROR_PATTERN_DIFF2 = 3,
  /*
   *  Number of types in DNX_TMC_DIAG_SOFT_ERROR_PATTERN
   */
  DNX_TMC_NOF_DIAG_SOFT_ERROR_PATTERNS = 4
}DNX_TMC_DIAG_SOFT_ERROR_PATTERN;
...
typedef enum
{
   ...
   */
  DNX_TMC_DIAG_SOFT_COUNT_TYPE_FAST = 0,
  /*
   *  The error count is done per SMS, and per SONE.
   */
  DNX_TMC_DIAG_SOFT_COUNT_TYPE_COMPLETE = 1,
  /*
   *  Number of types in DNX_TMC_DIAG_SOFT_COUNT_TYPE
   */
  DNX_TMC_NOF_DIAG_SOFT_COUNT_TYPES = 2
}DNX_TMC_DIAG_SOFT_COUNT_TYPE;
...
typedef struct
{
   ...
   */
  DNX_TMC_DIAG_QDR_BIST_DATA_MODE data_mode;
  /*
   *  The mode to jump between the addresses
   */
  DNX_TMC_DIAG_QDR_BIST_ADDR_MODE address_mode;
  /*
   *  How to build the initial data to write to the memory,
   *  the data_mode may use this data_patern differently.
   */
  DNX_TMC_DIAG_BIST_DATA_PATTERN data_pattern;
}DNX_TMC_DIAG_QDR_BIST_TEST_RUN_INFO;
...
}DNX_TMC_DIAG_QDR_BIST_TEST_RES_INFO;
...
typedef struct
{
   ...
   *  The way to build the test data from the data patterns.
   */
  DNX_TMC_DIAG_DRAM_BIST_DATA_MODE data_mode;
  /*
   *  How to build the initial data to write to the memory,
   *  the data_mode may use this data_pattern differently.
   */
  DNX_TMC_DIAG_BIST_DATA_PATTERN data_pattern;
}DNX_TMC_DIAG_DRAM_BIST_TEST_RUN_INFO;
...
typedef struct
{
   ...
   */
  uint32 reply_err_counter;
}DNX_TMC_DIAG_DRAM_BIST_TEST_RES_INFO;
...
}DNX_TMC_DIAG_DRAM_READ_COMPARE_STATUS;
...
typedef struct
{
   ...
   */
  uint32 dst_prt_id;
}DNX_TMC_DIAG_PACKET_WALKTROUGH;
...
typedef struct
{
   ...
   */
  uint8 data[DNX_TMC_DIAG_LBG_PAYLOAD_BYTE_SIZE];
  /*
   *  Number of bytes in packet
   */
  uint32 data_byte_size;

}DNX_TMC_DIAG_LBG_PACKET_PATTERN;
...
typedef struct
{
  ...
  * to the packet size.
  */
  DNX_TMC_DIAG_LBG_PACKET_PATTERN pattern;
 /*
...
typedef struct
{
  ...
  * Soc_petra counters
  */
  DNX_TMC_STAT_ALL_STATISTIC_COUNTERS counters;
 /*
...
typedef struct
{
  ...
  */
  uint32 ports[DNX_TMC_NOF_FAP_PORTS];
 /*
  *  number of ports
  */
  uint32 nof_ports;
}DNX_TMC_DIAG_LBG_PATH_INFO;
...
typedef struct
{
  DNX_SAND_MAGIC_NUM_VAR
    ...
    */
    DNX_TMC_DIAG_LBG_PATH_INFO     path;
}DNX_TMC_DIAG_LBG_INFO;
...
typedef struct
{
   ...
   *
   */
  uint32 ddr_training_sequence[DNX_TMC_DIAG_NOF_DDR_TRAIN_SEQS];
  /*
   *  Status of the 4 DLLs.
   */
  DNX_TMC_DIAG_DLL_STATUS_INFO dll_status[DNX_TMC_DIAG_NOF_DLLS_PER_DRAM];
}DNX_TMC_DIAG_DRAM_STATUS_INFO;
...
typedef struct
{
   ...
   */
  DNX_TMC_DIAG_SOFT_ERROR_PATTERN pattern;
  /*
...
typedef struct
{
   ...
   */
  uint32 diag_chain[DNX_TMC_DIAG_CHAIN_LENGTH_MAX_IN_UINT32S];
  /*
   *  Number of errors per memory types per SMS and per SONE
   *  (for SONE index different from 0).
   */
  DNX_TMC_DIAG_SOFT_ERR_RESULT nof_errs;

} DNX_TMC_DIAG_SOFT_SMS_RESULT;
...
void
  DNX_TMC_DIAG_SOFT_ERR_INFO_clear(
    DNX_SAND_OUT DNX_TMC_DIAG_SOFT_ERR_INFO *info
  );
...
/* } __DNX_TMC_API_DIAGNOSTICS_INCLUDED__*/
#endif
