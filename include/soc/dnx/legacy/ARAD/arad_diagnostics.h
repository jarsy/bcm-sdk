/* $Id: jer2_arad_diagnostics.h,v 1.7 Broadcom SDK $
 * $Copyright: (c) 2016 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
*/

#ifndef __JER2_ARAD_DIAGNOSTICS_INCLUDED__
/* { */
#define __JER2_ARAD_DIAGNOSTICS_INCLUDED__
...
/*********************************************************************
* NAME:
 *   jer2_arad_diag_last_packet_info_get_unsafe
 * TYPE:
 *   PROC
 * FUNCTION:
...
uint32
  jer2_arad_diag_last_packet_info_get_verify(
    DNX_SAND_IN  int                unit
  );
 ...
 *     "jer2_arad_diag_sample_enable_get_unsafe" API.
 *     Refer to "jer2_arad_diag_sample_enable_get_unsafe" API for details.
*********************************************************************/
uint32
...
* REMARKS:
*  has to call to jer2_arad_diag_sample_enable_set_unsafe() with enable = true.
...
#endif /* JER2_ARAD_DEBUG */

/* } */

#include <soc/dnx/legacy/SAND/Utils/sand_footer.h>

/* } __JER2_ARAD_DIAGNOSTICS_INCLUDED__*/
#endif
