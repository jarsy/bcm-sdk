/* $Id: jer2_arad_multicast_imp.h,v  $
 * $Copyright: (c) 2016 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
*/

#ifndef __JER2_ARAD_MULTICAST_IMP_INCLUDED__
#define __JER2_ARAD_MULTICAST_IMP_INCLUDED__
 ...
 */
uint32 jer2_arad_mcdb_set_next_pointer(
    DNX_SAND_IN  int     unit,
 ...
 */
uint32 jer2_arad_mcds_get_replications_from_entry(
    DNX_SAND_IN    int     unit,
 ...
 */
uint32 jer2_arad_mult_ing_encode_entry(
    DNX_SAND_IN    int                    unit,
...
#endif /* __JER2_ARAD_MULTICAST_IMP_INCLUDED__*/
