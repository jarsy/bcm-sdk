...
#define JER2_ARAD_ITM_HUNGRY_TH_MULTIPLIER_OFFSET  4

  /* Maximum ITM-Connection-Class: Value 31   */
#define  JER2_ARAD_ITM_QT_CC_CLS_MAX              31

  /* Maximum ITM-Credit-Class: Value 15 */
#define JER2_ARAD_ITM_IPS_QT_MAX(unit)            (SOC_DNX_DEFS_GET(unit, nof_credit_request_profiles) - 1)
...
#define JER2_ARAD_MIN_SCAN_CYCLE_PERIOD_MICRO 33333 /* calculated for a deletion threshold with the max field value of 15 to be around 500ms */
#define JER2_ARAD_MIN_SCAN_CYCLE_PERIOD_MICRO_AGGRESSIVE_WD_STATUS_MSG 1000 /* calculated for a message threshold with the min field value of 1 to be around 1ms */
 ...
 */
#define JER2_ARAD_MIN_SCAN_CYCLE_PERIOD_MICRO_PER_MODE { \
  JER2_ARAD_MIN_SCAN_CYCLE_PERIOD_MICRO, \
  JER2_ARAD_MIN_SCAN_CYCLE_PERIOD_MICRO, \
  JER2_ARAD_MIN_SCAN_CYCLE_PERIOD_MICRO_AGGRESSIVE_WD_STATUS_MSG, \
  JER2_ARAD_CREDIT_WATCHDOG_COMMON_MAX_SCAN_TIME_NS / 2000}
...
/*********************************************************************
* NAME:
*     jer2_arad_itm_dram_buffs_set_unsafe
* TYPE:
*   PROC
* DATE:
*   Apr 21 2008
 ...
 *     "jer2_arad_itm_committed_q_size_set_unsafe" API.
 *     Refer to "jer2_arad_itm_committed_q_size_set_unsafe" API for
 *     details.
*********************************************************************/
uint32
...
/*********************************************************************
*     Gets the configuration set by the
 *     "jer2_arad_itm_dp_discard_set_unsafe" API.
 *     Refer to "jer2_arad_itm_dp_discard_set_unsafe" API for
 *     details.
*********************************************************************/
int
