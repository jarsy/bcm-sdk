...
typedef enum
{
     ...
     * Must be last one!
     */
    dnx_data_device_general_define_nof
...
typedef enum
{
     ...
     * Must be last one!
     */
    dnx_data_device_general_table_nof
 ...
 */
/*}*/
#else     /*DNX_DATA_INTERNAL_DEVICE_H_*/
/*{*/
#ifndef DNX_DATA_INTERNAL
/*{*/
#error "dnx_data_internal_device file might include any header files, therfore header files must not include it.\nAny include to dnx_data_internal_device must be from 'c' file"
/*}*/
