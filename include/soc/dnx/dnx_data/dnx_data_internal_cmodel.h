/** \file dnx_data_internal_cmodel.h
 * 
 ...
 */
#ifndef _DNX_DATA_INTERNAL_CMODEL_H_
/*{*/
#define _DNX_DATA_INTERNAL_CMODEL_H_
/*
 * INCLUDE FILES:
 * {
 */
...
typedef enum
{
    dnx_data_cmodel_submodule_tx,

    /**
     * Must be last one!
     */
    dnx_data_cmodel_submodule_nof
} dnx_data_cmodel_submodule_e;
 ...
 *   * None
 */
int dnx_data_cmodel_tx_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_cmodel_tx_define_loopback_enable,

    /**
     * Must be last one!
     */
    dnx_data_cmodel_tx_define_nof
} dnx_data_cmodel_tx_define_e;
 ...
 *   * None
 */
uint32 dnx_data_cmodel_tx_loopback_enable_get(
    int unit);
...
typedef enum
{
     ...
     * Must be last one!
     */
    dnx_data_cmodel_tx_table_nof
} dnx_data_cmodel_tx_table_e;
 ...
 *   * None
 */
shr_error_e dnx_data_cmodel_init(
    int unit,
 ...
 */
/*}*/
#else     /*DNX_DATA_INTERNAL_CMODEL_H_*/
/*{*/
#ifndef DNX_DATA_INTERNAL
/*{*/
#error "dnx_data_internal_cmodel file might include any header files, therfore header files must not include it.\nAny include to dnx_data_internal_cmodel must be from 'c' file"
/*}*/
#endif /*DNX_DATA_INTERNAL*/
/*}*/
#endif /*_DNX_DATA_INTERNAL_CMODEL_H_*/
/* *INDENT-ON* */
