...
typedef enum
{
     ...
     * Must be last one!
     */
    dnx_data_snif_ingress_define_nof
...
typedef enum
{
     ...
     * Must be last one!
     */
    dnx_data_snif_ingress_table_nof
 ...
 */
/*}*/
#else     /*DNX_DATA_INTERNAL_SNIF_H_*/
/*{*/
#ifndef DNX_DATA_INTERNAL
/*{*/
#error "dnx_data_internal_snif file might include any header files, therfore header files must not include it.\nAny include to dnx_data_internal_snif must be from 'c' file"
/*}*/
