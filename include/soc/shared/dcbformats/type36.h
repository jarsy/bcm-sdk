...
#define _SOC_SHARED_DCBFOMATS_TYPE36_H
...
typedef struct {
    ...
    uint32  :7,                         /* Don't care */
            ...
            c_count:16;                 /* Requested byte count */
                                        ...
                                        /* T36.2 (word 12 in EP_TO_CPU_HDR) */
    uint32  reason_hi;                  /* CPU opcode (hi bits) */
                                        /* T36.3 (word 11 in EP_TO_CPU_HDR) */
    uint32  reason;                     /* CPU opcode (low bits) */

#ifdef  LE_HOST
                                        /* T36.4 (word 10 in EP_TO_CPU_HDR) */
    ...
    uint32  hgi:2,                      /* Higig Interface Format Indicator */
            ...
            srcport:8;                  /* Source port number */
                                        ...
                                        /* T36.6 (word 8 in EP_TO_CPU_HDR) */
    uint32  mh0;                        /* Module Header word 0 */
                                        /* T36.7 (word 7 in EP_TO_CPU_HDR) */
    uint32  mh1;                        /* Module Header word 1 */
                                        /* T36.8 (word 6 in EP_TO_CPU_HDR) */
    uint32  mh2;                        /* Module Header word 2 */
                                        /* T36.9 (word 5 in EP_TO_CPU_HDR) */
    uint32  mh3;                        /* Module Header word 3 */

#ifdef  LE_HOST
                                        /* T36.10 (word 4 in EP_TO_CPU_HDR) */
    uint32  inner_pri:3,                /* Inner priority */
            ...
            :7;                         /* Reserved */
                                        ...
                                        /* T36.11 (word 3 in EP_TO_CPU_HDR) */
    ...
    uint32  :1,                         /* Reserved */
            ...
            dscp:6;                     /* New DSCP */
#endif
                                        /* T36.12 (word 2 in EP_TO_CPU_HDR) */
    uint32  timestamp;                  /* Timestamp */

#ifdef  LE_HOST
                                        /* T36.13 (word 1 in EP_TO_CPU_HDR) */
    ...
    union {                             /* T36.14 (word 0 in EP_TO_CPU_HDR) */
...
#endif /* _SOC_SHARED_DCBFOMATS_TYPE36_H */
