...
#define _SOC_HIGIG_H
    ...
    defined(BCM_CALADAN3_SUPPORT) || defined(BCM_PETRA_SUPPORT)
...
#endif /* defined(BCM_XGS_SUPPORT) || defined(BCM_SIRIUS_SUPPORT) || defined(BCM_CALADAN3_SUPPORT) || defined(BCM_PETRA_SUPPORT)*/
