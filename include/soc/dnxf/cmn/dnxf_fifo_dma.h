...
soc_error_t soc_dnxf_fifo_dma_init(int unit);
soc_error_t soc_dnxf_fifo_dma_deinit(int unit);

soc_error_t soc_dnxf_fifo_dma_channel_entry_get(int unit, int channel, uint32  max_entry_size, uint32 nof_entries, uint8 *entry);
soc_error_t soc_dnxf_fifo_dma_channel_clear(int unit, int channel);

soc_error_t soc_dnxf_fifo_dma_channel_init(int unit, int channel);
soc_error_t soc_dnxf_fifo_dma_channel_deinit(int unit, int channel);
