...
typedef struct soc_dnxf_implementation_defines_s {
    int        soc_dnxf_imp_defs_rtp_reachabilty_gen_rate_per_link;        /* RTP Reachability gen rate per link */
    int        soc_dnxf_imp_defs_rtp_reachabilty_watchdog_rate;            /* RTP Reachability watchdog reate */
    int        soc_dnxf_imp_defs_mdio_int_dividend_default;                /* Divident default */
    int        soc_dnxf_imp_defs_mdio_int_freq_default;                    /* Freq default */
...
/* SOC_DNXF_IMP_DEFS_RTP_REACHABILTY_GEN_RATE_PER_LINK_MAX*/
#ifdef BCM_88790_A0
#ifdef SOC_DNXF_IMP_DEFS_RTP_REACHABILTY_GEN_RATE_PER_LINK_MAX
#if (50000) > SOC_DNXF_IMP_DEFS_RTP_REACHABILTY_GEN_RATE_PER_LINK_MAX
#undef SOC_DNXF_IMP_DEFS_RTP_REACHABILTY_GEN_RATE_PER_LINK_MAX
#define SOC_DNXF_IMP_DEFS_RTP_REACHABILTY_GEN_RATE_PER_LINK_MAX 50000
#endif /* (50000) > SOC_DNXF_IMP_DEFS_RTP_REACHABILTY_GEN_RATE_PER_LINK_MAX */
#else
#define SOC_DNXF_IMP_DEFS_RTP_REACHABILTY_GEN_RATE_PER_LINK_MAX 50000
#endif /* SOC_DNXF_IMP_DEFS_RTP_REACHABILTY_GEN_RATE_PER_LINK_MAX */
#endif /* BCM_88790_A0*/
/* SOC_DNXF_IMP_DEFS_RTP_REACHABILTY_GEN_RATE_PER_LINK_MAX - end */
...
/* SOC_DNXF_IMP_DEFS_MDIO_INT_DIVIDEND_DEFAULT_MAX*/
#ifdef BCM_88790_A0
#ifdef SOC_DNXF_IMP_DEFS_MDIO_INT_DIVIDEND_DEFAULT_MAX
#if (1) > SOC_DNXF_IMP_DEFS_MDIO_INT_DIVIDEND_DEFAULT_MAX
#undef SOC_DNXF_IMP_DEFS_MDIO_INT_DIVIDEND_DEFAULT_MAX
#define SOC_DNXF_IMP_DEFS_MDIO_INT_DIVIDEND_DEFAULT_MAX 1
#endif /* (1) > SOC_DNXF_IMP_DEFS_MDIO_INT_DIVIDEND_DEFAULT_MAX */
#else
#define SOC_DNXF_IMP_DEFS_MDIO_INT_DIVIDEND_DEFAULT_MAX 1
#endif /* SOC_DNXF_IMP_DEFS_MDIO_INT_DIVIDEND_DEFAULT_MAX */
#endif /* BCM_88790_A0*/
/* SOC_DNXF_IMP_DEFS_MDIO_INT_DIVIDEND_DEFAULT_MAX - end */

/* SOC_DNXF_IMP_DEFS_MDIO_INT_FREQ_DEFAULT_MAX*/
#ifdef BCM_88790_A0
#ifdef SOC_DNXF_IMP_DEFS_MDIO_INT_FREQ_DEFAULT_MAX
#if (10) > SOC_DNXF_IMP_DEFS_MDIO_INT_FREQ_DEFAULT_MAX
#undef SOC_DNXF_IMP_DEFS_MDIO_INT_FREQ_DEFAULT_MAX
#define SOC_DNXF_IMP_DEFS_MDIO_INT_FREQ_DEFAULT_MAX 10
#endif /* (10) > SOC_DNXF_IMP_DEFS_MDIO_INT_FREQ_DEFAULT_MAX */
#else
#define SOC_DNXF_IMP_DEFS_MDIO_INT_FREQ_DEFAULT_MAX 10
#endif /* SOC_DNXF_IMP_DEFS_MDIO_INT_FREQ_DEFAULT_MAX */
#endif /* BCM_88790_A0*/
/* SOC_DNXF_IMP_DEFS_MDIO_INT_FREQ_DEFAULT_MAX - end */
...
#if (0) > SOC_DNXF_IMP_DEFS_FABRIC_CLOCK_FREQ_IN_DEFAULT_MAX
#undef SOC_DNXF_IMP_DEFS_FABRIC_CLOCK_FREQ_IN_DEFAULT_MAX
#define SOC_DNXF_IMP_DEFS_FABRIC_CLOCK_FREQ_IN_DEFAULT_MAX 0
#endif /* (0) > SOC_DNXF_IMP_DEFS_FABRIC_CLOCK_FREQ_IN_DEFAULT_MAX */
#else
#define SOC_DNXF_IMP_DEFS_FABRIC_CLOCK_FREQ_IN_DEFAULT_MAX 0
...
#if (0) > SOC_DNXF_IMP_DEFS_FABRIC_CLOCK_FREQ_OUT_DEFAULT_MAX
#undef SOC_DNXF_IMP_DEFS_FABRIC_CLOCK_FREQ_OUT_DEFAULT_MAX
#define SOC_DNXF_IMP_DEFS_FABRIC_CLOCK_FREQ_OUT_DEFAULT_MAX 0
#endif /* (0) > SOC_DNXF_IMP_DEFS_FABRIC_CLOCK_FREQ_OUT_DEFAULT_MAX */
#else
#define SOC_DNXF_IMP_DEFS_FABRIC_CLOCK_FREQ_OUT_DEFAULT_MAX 0
