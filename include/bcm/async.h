...
void	bcm_cosq_ingress_port_drop_control_frame_get_async(int unit, bcm_port_t port, uint32 flags, bcm_cosq_ingress_drop_control_frame_config_t * control_frame_config, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_cosq_ingress_port_drop_control_frame_set_async(int unit, bcm_port_t port, uint32 flags, bcm_cosq_ingress_drop_control_frame_config_t * control_frame_config, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_field_qualify_DstPortSRLanId_async(int unit, bcm_field_entry_t entry, uint8 net_id, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_DstPortSRLanId_get_async(int unit, bcm_field_entry_t entry, uint8 * net_id, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_field_qualify_SrcPortSRLanId_async(int unit, bcm_field_entry_t entry, uint8 net_id, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_field_qualify_SrcPortSRLanId_get_async(int unit, bcm_field_entry_t entry, uint8 * net_id, bcm_async_cb_t async_callback, void *async_cookie);
