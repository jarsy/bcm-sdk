...
/* Initialize the Extender egress structure. */
...
/* Set Extender egress objects for a Extender port */
...
/* Get an Extender egress object for a Extender port */
extern int bcm_extender_egress_get(
    int unit, 
    bcm_gport_t extender_port, 
    bcm_extender_egress_t *extender_egress);

/* Get Extender egress objects for a Extender port */
...
/* Delete all Extender egress objects from a Extender port. */
