...
typedef enum bcm_linkscan_trigger_event_e {
    BCM_LINKSCAN_TRIGGER_EVENT_FAULT = 0 /* Trigger link fault checking in
                                           Linkscan thread. */
} bcm_linkscan_trigger_event_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Note: links status trigger event is always set, and can't be disabled. */
