/*
 * $Id: mirror.h,v 1.2 Broadcom SDK $
...
#ifndef _BCM_INT_SBX_CALADAN3_MIRROR_H_
#define _BCM_INT_SBX_CALADAN3_MIRROR_H_
 ...
 */
#define G3P1_INGR_MIRROR_MIN     1 /* lowest valid nonreserved ingr mirror */
#define G3P1_EGR_MIRROR_MIN      4 /* lowest valid nonreserved egr mirror */

#define G3P1_MIRROR_PORT_MAX     2 /* dest port can have 1-ingress + 1-egress mirror */
 ...
 */
typedef enum _caladan3_mirror_flags_e {
    C3_MIRROR_VALID      = 0x0001,                /* entry is in use */
    C3_MIRROR_TUNNEL     = 0x0002                 /* entry is tunnel port */
} _caladan3_mirror_flags_t;

typedef struct _caladan3_mirror_s {
    _caladan3_mirror_flags_t flags;                     /* entry flags */
    unsigned int         refCount;                  /* references to entry */
    bcm_gport_t          dest_gport;
} _caladan3_mirror_t;

typedef enum _caladan3_mirror_direction_e { 
    _caladan3_ingress_mirror,
    _caladan3_egress_mirror,
    _caladan3_mirror_direction_max
} _caladan3_mirror_direction_t;

/*
 *  State per direction, ingress or egress
 */
typedef struct _caladan3_mirror_state_s {
    int32            mirror_min;
    int32            mirror_max;
    _caladan3_mirror_t  *mirrors;
} _caladan3_mirror_state_t;

/*  
 *  This contains the global variables for a single unit.
 */
typedef struct _caladan3_mirror_glob_s {
    sal_mutex_t           tableLock;                  /* locks tables */
    _caladan3_mirror_state_t  state[_caladan3_mirror_direction_max];
} _caladan3_mirror_glob_t;

/*  
 *  Global variables for this module
 */
extern _caladan3_mirror_glob_t *_mirror_glob[BCM_MAX_NUM_UNITS];
extern volatile sal_mutex_t _caladan3_mirror_glob_lock;

/*
 *   Function
 *      _bcm_caladan3_ingr_mirror_alloc
 *   Purpose
...
/*
 *   Function
 *      _bcm_caladan3_ingr_mirror_free
 *   Purpose
...
/*
 *   Function
 *      _bcm_caladan3_egr_mirror_alloc
 *   Purpose
...
/*
 *   Function
 *      _bcm_caladan3_egr_mirror_addref
 *   Purpose
 ...
 */
extern int
_bcm_caladan3_egr_mirror_addref(const int unit,
                              const unsigned int mirrorId);

/*
 *   Function
 *      _bcm_caladan3_egr_mirror_get
 *   Purpose
...
#endif /* _BCM_INT_SBX_CALADAN3_MIRROR_H_ */
