...
int _bcm_dpp_am_template_ip_tunnel_init(int unit,int sip_profile ,int sip_val, int ttl_profile, int ttl_val, int tos_profile, int tos_val, int tunnel_template_profile, SOC_PPC_EG_ENCAP_IP_TUNNEL_SIZE_PROTOCOL_TEMPLATE_INFO *tunnel_template_val);
