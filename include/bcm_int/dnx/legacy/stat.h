...
extern int _bcm_dnx_stat_generic_get(int unit, bcm_port_t port,
                                 bcm_stat_val_t type, uint64 *val);

extern int _bcm_dnx_stat_ge_get(int unit, bcm_port_t port,
                                 bcm_stat_val_t type, uint64 *val);

int _bcm_dnx_stat_counter_non_dma_extra_get(int unit,
...
int _bcm_dnx_stat_recover(int unit, bcm_pbmp_t okay_nif_ports, uint32 counter_flags, int counter_interval, bcm_pbmp_t counter_pbmp);
#endif

#if defined(BCM_DNX_SUPPORT)
int 
_bcm_dnx_stat_counter_lif_counting_get(
    int unit, 
    uint32 flags, 
