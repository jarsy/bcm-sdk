...
extern int bcm_gh2_switch_control_port_set(int unit, bcm_port_t port, bcm_switch_control_t type, int arg);
extern int bcm_gh2_switch_control_port_get(int unit, bcm_port_t port, bcm_switch_control_t type, int *arg);
extern int bcm_gh2_switch_control_set(int unit, bcm_switch_control_t type, int arg);
extern int bcm_gh2_switch_control_get(int unit, bcm_switch_control_t type, int *arg);
