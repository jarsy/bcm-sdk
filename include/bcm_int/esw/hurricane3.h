...
#define _BCM_HR3_SWITCH_MATCH_ID_MASK               (0xffff)
#define _BCM_HR3_SWITCH_MATCH_TYPE_SHIFT            (28)

/* Switch Match Types (4-bit) */
#define _BCM_HR3_SWITCH_MATCH_TYPE_MIML             (1)
#define _BCM_HR3_SWITCH_MATCH_TYPE_CUSTOM_HEADER    (2)

/* Switch Match table size */
#define _BCM_HR3_SWITCH_MATCH_TABLE_SIZE_MIML       (1)
...
extern int bcm_hr3_switch_match_init(int unit);
extern int bcm_hr3_switch_match_detach(int unit);
extern int bcm_hr3_switch_match_config_add(int unit, 
            bcm_switch_match_service_t match_service, 
            bcm_switch_match_config_info_t *config_info, 
            int *match_id);
extern int bcm_hr3_switch_match_config_delete(int unit, 
            bcm_switch_match_service_t match_service, 
            int match_id);
extern int bcm_hr3_switch_match_config_delete_all(int unit, 
            bcm_switch_match_service_t match_service);
extern int bcm_hr3_switch_match_config_get(int unit, 
            bcm_switch_match_service_t match_service, 
            int match_id, 
            bcm_switch_match_config_info_t *config_info);
extern int bcm_hr3_switch_match_config_set(int unit, 
            bcm_switch_match_service_t match_service, 
            int match_id, 
            bcm_switch_match_config_info_t *config_info);
extern int bcm_hr3_switch_match_config_traverse(int unit, 
            bcm_switch_match_service_t match_service, 
            bcm_switch_match_config_traverse_cb cb_fn, 
            void *user_data);
extern int bcm_hr3_switch_match_control_get(int unit, 
            bcm_switch_match_service_t match_service, 
            bcm_switch_match_control_type_t control_type, 
            bcm_gport_t gport, 
            bcm_switch_match_control_info_t *control_info);
extern int bcm_hr3_switch_match_control_set(int unit, 
            bcm_switch_match_service_t match_service, 
            bcm_switch_match_control_type_t control_type, 
            bcm_gport_t gport, 
            bcm_switch_match_control_info_t *control_info);
extern int bcm_hr3_switch_match_control_traverse(int unit, 
            bcm_switch_match_service_t match_service, 
