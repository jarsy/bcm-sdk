...
typedef enum _shr_rx_reason_e {
    ...
    _SHR_RX_L2_STU_FAIL                 = 158, /* L2 STU check fail                   */
    _SHR_RX_SR_COUNTER_EXCEEDED         = 159, /* Seamless Redundancy(SR) -           */
                                               /* Counter Threshold Exceeded          */
    _SHR_RX_SR_COPY_TO_CPU_BIT0         = 160, /* Seamless Redundancy(SR) copy to CPU */
                                               /* SR custom reason code bit 0         */
    _SHR_RX_SR_COPY_TO_CPU_BIT1         = 161, /* SR custom reason code bit 1         */
    _SHR_RX_SR_COPY_TO_CPU_BIT2         = 162, /* SR custom reason code bit 2         */
    _SHR_RX_SR_COPY_TO_CPU_BIT3         = 163, /* SR custom reason code bit 3         */
    _SHR_RX_SR_COPY_TO_CPU_BIT4         = 164, /* SR custom reason code bit 4         */
    _SHR_RX_SR_COPY_TO_CPU_BIT5         = 165, /* SR custom reason code bit 5         */
    _SHR_RX_REASON_COUNT                = 166  /* MUST BE LAST                        */
} _shr_rx_reason_t;
