...
#define _SHR_GPORT_SUB_TYPE_LIF_MASK                0x3FFFF
...
#define _SHR_L3_ITF_TYPE_MASK                0x3

#define _SHR_L3_ITF_VAL_SHIFT                  0
#define _SHR_L3_ITF_VAL_MASK          0x1FFFFFFF
...
#define _SHR_GPORT_TUNNEL_TO_L3_ITF_LIF(_l3_itf_lif , _gport_tunnel)    \
   do { \
      int __gport_tunnel_val;   \
      if (_SHR_GPORT_IS_TUNNEL(_gport_tunnel)) {   \
         __gport_tunnel_val = _SHR_GPORT_SUB_TYPE_LIF_VAL_GET(_gport_tunnel); \
         _SHR_L3_ITF_SET(_l3_itf_lif, _SHR_L3_ITF_TYPE_LIF, __gport_tunnel_val);\
      }\
      else {\
        _l3_itf_lif = -1;\
      }\
