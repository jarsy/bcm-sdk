...
/* { */
#include <soc/dnx/legacy/dnx_sw_state.h>
#include <bcm_int/dnx/legacy/bcm_sw_state.h>
...
/* { */
typedef struct {
    utilex_sw_state_t sand ;
    sw_state_res_tag_bitmap_info_t  res_tag_bmp_info;
} shareddnx_sw_state_t ;

typedef struct
{
                    PARSER_HINT_ALLOW_WB_ACCESS dnx_dbal_sw_state_t dbal_db;
} socdnx_sw_state_t;

typedef struct {
    dnx_algo_res_mngr_info_t res_mngr;
    dnx_algo_template_mngr_info_t template_mngr;
    dnx_multi_set_template_info_t multi_set_template;
} bcmdnx_sw_state_t;

typedef struct {
    shareddnx_sw_state_t  shareddnx ;
    socdnx_sw_state_t     socdnx;
    bcmdnx_sw_state_t     bcmdnx;
    /*legacy sw state*/
    soc_dnx_bcm_sw_state_t  bcm;
    soc_dnx_soc_sw_state_t  soc;
    soc_dnx_shr_sw_state_t  shr;
} dnx_sw_state_t ;
/* } */
#endif/*
 * shr_sw_state_t
