...
#ifndef _SHR_SW_STATE_DPP_SOC_ARAD_TM_VENDOR_0_ACCESS_H_
#define _SHR_SW_STATE_DPP_SOC_ARAD_TM_VENDOR_0_ACCESS_H_
...
int sw_state_dpp_soc_arad_tm_vendor_0_access_cb_init(int unit);

#endif /* _SHR_SW_STATE_DPP_SOC_ARAD_TM_VENDOR_0_ACCESS_H_ */
