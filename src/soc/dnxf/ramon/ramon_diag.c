...
soc_ramon_diag_cell_pipe_counter_get(int unit, int pipe, uint64 * counter)
{
    ...
    case 0: /*Pipe0*/
        ...
        {
            DNXC_IF_ERR_EXIT(READ_DCH_DCH_TOTAL_CELL_CNT_P_0r(unit, i, &reg_val32));
    ...
    case 1: /*Pipe1*/
        for (i = 0 ; i < SOC_DNXF_DEFS_GET(unit, nof_instances_dch) ; i++)
        {
            DNXC_IF_ERR_EXIT(READ_DCH_DCH_TOTAL_CELL_CNT_P_1r(unit, i, &reg_val32));
    ...
    case 2: /*Pipe2*/
        for (i = 0 ; i < SOC_DNXF_DEFS_GET(unit, nof_instances_dch) ; i++)
        {
            DNXC_IF_ERR_EXIT(READ_DCH_DCH_TOTAL_CELL_CNT_P_2r(unit, i, &reg_val32));
    ...
    default:
        DNXC_EXIT_WITH_ERR(SOC_E_PARAM, (_BSL_DNXC_MSG("pipe %d does not exist\n"), pipe));
    }
...
soc_ramon_counters_get_info(int unit,soc_dnxf_counters_info_t* fe_counters_info)
{
    ...
    for (i = 0 ; i < SOC_DNXF_DEFS_GET(unit, nof_instances_dch); i++)
    {
        DNXC_IF_ERR_EXIT(READ_DCH_DCH_TOTAL_CELL_CNT_P_0r(unit, i , &reg_val));
        ...
        DNXC_IF_ERR_EXIT(READ_DCH_DCH_TOTAL_OUT_CELL_CNT_P_0r(unit, i , &reg_val));
        ...
        DNXC_IF_ERR_EXIT(soc_reg32_get(unit, DCH_FIFO_DISCARD_COUNTER_Pr, i, 0, &reg_val));
        ...
        DNXC_IF_ERR_EXIT(READ_DCH_UN_REACH_DESTr(unit, i, &reg_val64));
        ...
        DNXC_IF_ERR_EXIT(READ_DCH_IFM_MAX_OCCUP_P_0r(unit, i, &reg_val64));
    ...
    if (nof_pipes >= 2)
    {
        ...
        for (i = 0; i < SOC_DNXF_DEFS_GET(unit, nof_instances_dch); i++)
        {
            DNXC_IF_ERR_EXIT(READ_DCH_DCH_TOTAL_CELL_CNT_P_1r(unit, i, &reg_val));
            ...
            DNXC_IF_ERR_EXIT(READ_DCH_DCH_TOTAL_OUT_CELL_CNT_P_1r(unit, i , &reg_val));
            ...
            DNXC_IF_ERR_EXIT(soc_reg32_get(unit, DCH_FIFO_DISCARD_COUNTER_Pr, i, 1, &reg_val));
            ...
            DNXC_IF_ERR_EXIT(READ_DCH_IFM_MAX_OCCUP_P_1r(unit, i, &reg_val64));
    ...
    if (nof_pipes == 3)
    {
        ...
        for (i = 0; i < SOC_DNXF_DEFS_GET(unit, nof_instances_dch) ; i++ )
        {
            DNXC_IF_ERR_EXIT(READ_DCH_DCH_TOTAL_CELL_CNT_P_2r(unit, i, &reg_val));
            ...
            DNXC_IF_ERR_EXIT(READ_DCH_DCH_TOTAL_OUT_CELL_CNT_P_2r(unit, i , &reg_val));
            ...
            DNXC_IF_ERR_EXIT(soc_reg32_get(unit, DCH_FIFO_DISCARD_COUNTER_Pr, i, 2, &reg_val));
            ...
            DNXC_IF_ERR_EXIT(READ_DCH_IFM_MAX_OCCUP_P_2r(unit, i, &reg_val64));
    ...
    for (j = 0 ; j < nof_pipes ; j ++)
    {
        ...
        {
            DNXC_IF_ERR_EXIT(READ_DCM_TOTAL_IN_CELL_CNT_PABr(unit, i, j, &reg_val));
            ...
            DNXC_IF_ERR_EXIT(READ_DCM_TOTAL_IN_CELL_CNT_PCDr(unit, i, j, &reg_val));
            ...
            DNXC_IF_ERR_EXIT(READ_DCM_DROP_TOTAL_P_CNTr(unit, i, j, &reg_val));
            ...
            for (k = 0; k < soc_dnxf_fabric_priority_nof; k++) {
                switch (j) {
                case 0:
                    DNXC_IF_ERR_EXIT(READ_DCM_DROP_IP_PRI_P_0_CNTr(unit, i, k, &reg_val));
                    ...
                    break;
                case 1:
                    DNXC_IF_ERR_EXIT(READ_DCM_DROP_IP_PRI_P_1_CNTr(unit, i, k, &reg_val));
                    ...
                    break;
                case 2:
                    DNXC_IF_ERR_EXIT(READ_DCM_DROP_IP_PRI_P_2_CNTr(unit, i, k, &reg_val));
            ...
            DNXC_IF_ERR_EXIT(READ_DCM_MC_LP_CELL_DRP_CNT_Pr(unit, i, j, &reg_val));
            ...
            DNXC_IF_ERR_EXIT(READ_DCM_DCM_MAX_OCUP_Pr(unit, i , j, &reg_val64));
    ...
    {
        DNXC_IF_ERR_EXIT(READ_DCL_TOTAL_IN_CELL_P_CNTr(unit, i , 0, &reg_val));
        ...
        DNXC_IF_ERR_EXIT(READ_DCL_TOTAL_OUT_CELL_P_CNTr(unit, i, 0, &reg_val));
        ...
        {
            DNXC_IF_ERR_EXIT(READ_DCL_DROPPED_IP_PR_P_0_CNTr(unit, i , j, &reg_val));
        ...
        DNXC_IF_ERR_EXIT(READ_DCL_MAX_OCCUPANCY_FIFO_Pr(unit, i, 0, &reg_val));
    ...
    if (nof_pipes >= 2)
    {
        ...
        for (i = 0 ; i < SOC_DNXF_DEFS_GET(unit, nof_instances_dcl); i++ )
        {
            DNXC_IF_ERR_EXIT(READ_DCL_TOTAL_IN_CELL_P_CNTr(unit, i, 1, &reg_val));
            ...
            DNXC_IF_ERR_EXIT(READ_DCL_TOTAL_OUT_CELL_P_CNTr(unit, i, 1, &reg_val));
            ...
            for (j = 0 ; j < 4; j++)
            {
                DNXC_IF_ERR_EXIT(READ_DCL_DROPPED_IP_PR_P_1_CNTr(unit, i, j, &reg_val));
            ...
            DNXC_IF_ERR_EXIT(READ_DCL_MAX_OCCUPANCY_FIFO_Pr(unit, i, 1, &reg_val));
            temp = soc_reg_field_get(unit, DCL_MAX_OCCUPANCY_FIFO_Pr, reg_val, MAX_OCCUP_P_Nf);
            curr_max = (temp>curr_max)? temp:curr_max;
        }
    ...
    if (nof_pipes == 3)
    {
        ...
        for (i = 0; i < SOC_DNXF_DEFS_GET(unit, nof_instances_dcl); i++ )
        {
            DNXC_IF_ERR_EXIT(READ_DCL_TOTAL_IN_CELL_P_CNTr(unit, i, 2, &reg_val));
            ...
            DNXC_IF_ERR_EXIT(READ_DCL_TOTAL_OUT_CELL_P_CNTr(unit, i, 2, &reg_val));
            ...
            for (j = 0 ; j < 4 ; j++)
            {
                DNXC_IF_ERR_EXIT(READ_DCL_DROPPED_IP_PR_P_2_CNTr(unit, i, j, &reg_val));
            ...
            DNXC_IF_ERR_EXIT(READ_DCL_MAX_OCCUPANCY_FIFO_Pr(unit, i, 2, &reg_val));
            temp = soc_reg_field_get(unit, DCL_MAX_OCCUPANCY_FIFO_Pr, reg_val, MAX_OCCUP_P_Nf);
            curr_max = (temp>curr_max)? temp:curr_max;
        }
    ...
    for (i = 0 ; i < SOC_DNXF_DEFS_GET(unit, nof_instances_dch) ; i++)
    {        
        DNXC_IF_ERR_EXIT(READ_DCH_DCM_FLOW_CNTROL_0_CNT_P_0r(unit, i, &reg_val));
        ...
        DNXC_IF_ERR_EXIT(READ_DCH_DCM_FLOW_CNTROL_1_CNT_P_0r(unit, i, &reg_val));
    ...
    if (nof_pipes >= 2)
    {
        for (i = 0 ; i < SOC_DNXF_DEFS_GET(unit, nof_instances_dch); i++)
        {
            DNXC_IF_ERR_EXIT(READ_DCH_DCM_FLOW_CNTROL_0_CNT_P_1r(unit, i, &reg_val));
            ...
            DNXC_IF_ERR_EXIT(READ_DCH_DCM_FLOW_CNTROL_1_CNT_P_1r(unit, i, &reg_val));
    ...
    if (nof_pipes == 3)
    {
        for (i = 0; i < SOC_DNXF_DEFS_GET(unit, nof_instances_dch); i++)
        {
            DNXC_IF_ERR_EXIT(READ_DCH_DCM_FLOW_CNTROL_0_CNT_P_2r(unit, i, &reg_val));
            ...
            DNXC_IF_ERR_EXIT(READ_DCH_DCM_FLOW_CNTROL_1_CNT_P_2r(unit, i, &reg_val));
    ...
    for (j = 0; j < nof_pipes ; j++)
    {
        for (i = 0 ; i < SOC_DNXF_DEFS_GET(unit, nof_instances_dcm) ; i++)
        {
            DNXC_IF_ERR_EXIT(READ_DCM_DCL_FLOW_CONTROL_CNT_Pr(unit, i, j, &reg_val));
    ...
    for (i = 0; i < SOC_DNXF_DEFS_GET(unit, nof_instances_ccs) ; i++)
    {
        DNXC_IF_ERR_EXIT(READ_CCS_TOTAL_CELLS_CNTr(unit, i, &reg_val));
        ...
        DNXC_IF_ERR_EXIT(READ_CCS_FLOW_STATUS_CELLS_CNTr(unit, i, &reg_val));
        ...
        DNXC_IF_ERR_EXIT(READ_CCS_CREDIT_CELLS_CNTr(unit, i, &reg_val));
        ...
        DNXC_IF_ERR_EXIT(READ_CCS_REACHABILITY_CELLS_CNTr(unit, i, &reg_val));
        ...
        DNXC_IF_ERR_EXIT(READ_CCS_UNREACHABLE_DESTINATION_CELLS_CNTr(unit, i, &reg_val));
...
soc_ramon_queues_get_info(int unit, soc_dnxf_queues_info_t* fe_queues_info)
{
    ...
    for (i = 0; i < SOC_DNXF_DEFS_GET(unit, nof_instances_dch); i++)
    {
        ...
        fe_queues_info->dch_queues_info[0].nof_dch[i].nof_link_a = i*SOC_DNXF_DEFS_GET(unit, nof_links_in_dcq) + nof_fifo;
        ...
        fe_queues_info->dch_queues_info[0].nof_dch[i].nof_link_b = i*SOC_DNXF_DEFS_GET(unit, nof_links_in_dcq) + SOC_DNXF_DEFS_GET(unit, nof_links_in_dcq)/3 + nof_fifo; /* Start from relevant DCH block + Start from B links (12) + offset in "B Links" */
        ...
        fe_queues_info->dch_queues_info[0].nof_dch[i].nof_link_c = i*SOC_DNXF_DEFS_GET(unit, nof_links_in_dcq) + 2*(SOC_DNXF_DEFS_GET(unit,nof_links_in_dcq)/3) + nof_fifo; /* Start from relevant DCH block + Start from C Links(24) + offset in "C Links" */
    }
    ...
    if (nof_pipes >= 2)
    {
        for (i = 0 ; i < SOC_DNXF_DEFS_GET(unit, nof_instances_dch); i++)
        {
            ...
            fe_queues_info->dch_queues_info[1].nof_dch[i].nof_link_a = i*SOC_DNXF_DEFS_GET(unit, nof_links_in_dcq) + nof_fifo;
            ...
            fe_queues_info->dch_queues_info[1].nof_dch[i].nof_link_b = i*SOC_DNXF_DEFS_GET(unit, nof_links_in_dcq) + SOC_DNXF_DEFS_GET(unit, nof_links_in_dcq)/3 + nof_fifo; /* Start from relevant DCH block + Start from B links (12) + offset in "B Links" */
            ...
            fe_queues_info->dch_queues_info[1].nof_dch[i].nof_link_c = i*SOC_DNXF_DEFS_GET(unit, nof_links_in_dcq) + 2*(SOC_DNXF_DEFS_GET(unit,nof_links_in_dcq)/3) + nof_fifo; /* Start from relevant DCH block + Start from C Links(24) + offset in "C Links" */
        }
    }
    /* Pipe 2 */
    if (nof_pipes == 3)
    {
        for (i = 0 ; i < SOC_DNXF_DEFS_GET(unit, nof_instances_dch); i++)
        {
            ...
            fe_queues_info->dch_queues_info[2].nof_dch[i].nof_link_a = i*SOC_DNXF_DEFS_GET(unit, nof_links_in_dcq) + nof_fifo;
            ...
            fe_queues_info->dch_queues_info[2].nof_dch[i].nof_link_b = i*SOC_DNXF_DEFS_GET(unit, nof_links_in_dcq) + SOC_DNXF_DEFS_GET(unit, nof_links_in_dcq)/3 + nof_fifo; /* Start from relevant DCH block + Start from B links (12) + offset in "B Links" */
            ...
            fe_queues_info->dch_queues_info[2].nof_dch[i].nof_link_c = i*SOC_DNXF_DEFS_GET(unit, nof_links_in_dcq) + 2*(SOC_DNXF_DEFS_GET(unit,nof_links_in_dcq)/3) + nof_fifo; /* Start from relevant DCH block + Start from C Links(24) + offset in "C Links" */
        }
    }
    ...
    {
        for (j = 0; j < SOC_DNXF_DEFS_GET(unit, nof_instances_dcm); j++)
        {
            DNXC_IF_ERR_EXIT(READ_DCM_DCM_MAX_OCUP_Pr(unit, j, i, &reg_val64));
    ...
    for (i = 0; i < nof_pipes ; i++)
    {
        for (j = 0; j < SOC_DNXF_DEFS_GET(unit, nof_instances_dcl); j++)
        {
            DNXC_IF_ERR_EXIT(READ_DCL_MAX_OCCUPANCY_FIFO_Pr(unit, j, i, &reg_val));
            ...
            fe_queues_info->dcl_queues_info[i].nof_dcl[j].nof_link = j*SOC_DNXF_DEFS_GET(unit, nof_links_in_dcq) + nof_fifo;
        }
    }
...
soc_ramon_diag_mesh_topology_get(int unit, soc_dnxc_fabric_mesh_topology_diag_t *mesh_topology_diag)
{
    ...
    DNXC_IF_ERR_EXIT(READ_MESH_TOPOLOGY_REG_0000r(unit, &reg32_val));
    ...
    DNXC_IF_ERR_EXIT(READ_MESH_TOPOLOGY_REG_01C5r(unit, &reg32_val));
    ...
    /*Status 1*/
    DNXC_IF_ERR_EXIT(READ_MESH_TOPOLOGY_REG_01C8r(unit, &reg64_val));
    ...
    /*Status 2*/
    DNXC_IF_ERR_EXIT(READ_MESH_TOPOLOGY_REG_01C9r(unit, &reg64_val));
