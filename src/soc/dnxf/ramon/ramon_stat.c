...
soc_ramon_stat_init(int unit){
    ...
    if (!SOC_WARM_BOOT(unit)) {
        ...
        DNXC_IF_ERR_EXIT(WRITE_BRDC_FMAC_AC_FMAL_STATISTICS_OUTPUT_CONTROLr(unit, reg_val));
        DNXC_IF_ERR_EXIT(WRITE_BRDC_FMAC_BD_FMAL_STATISTICS_OUTPUT_CONTROLr(unit, reg_val));
    }
