/*
 * $Id: ramon_fe1600_fabric_multicast.c,v 1.9 Broadcom SDK $
 *
 * $Copyright: (c) 2016 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 *
 * SOC RAMON_FE1600 FABRIC MULTICAST
 */
...
/*local functions*/
STATIC soc_error_t soc_ramon_fe1600_fabric_multicast_multi_read_range(int unit, soc_multicast_t group_min, soc_multicast_t group_max, uint32 *entry_array);

/*defines */
#define _SOC_RAMON_FE1600_FABRIC_MULTICAST_MAX_MC_MODULES (144)
#define _SOC_RAMON_FE1600_FABRIC_MULTICAST_TABLE_SIZE (64 * 1024)
 ...
 */
soc_error_t 
soc_ramon_fe1600_fabric_multicast_low_prio_drop_select_priority_set(int unit, soc_dnxf_fabric_priority_t prio)
{
    ...
    switch(prio)
    {
        ...
        case soc_dnxf_fabric_priority_3:
            ...
            break;
        default:
            DNXC_EXIT_WITH_ERR(SOC_E_PARAM, (_BSL_DNXC_MSG("Wrong priority %d"),prio));
    }

    /*Set MC low priority at RTP*/
    DNXC_IF_ERR_EXIT(READ_RTP_LOW_PR_MUL_CTRLr(unit, &reg_val));
    soc_reg_field_set(unit, RTP_LOW_PR_MUL_CTRLr, &reg_val, LOW_PR_MUL_PRIOSELf, low_prio_select);
    DNXC_IF_ERR_EXIT(WRITE_RTP_LOW_PR_MUL_CTRLr(unit, reg_val));
    ...
    if (SOC_IS_RAMON(unit))
    {
        ...
        {
                DNXC_IF_ERR_EXIT(READ_DCH_DCH_ENABLERS_REGISTER_2r(unit, blk, &reg_val));
                soc_reg_field_set(unit, DCH_DCH_ENABLERS_REGISTER_2r, &reg_val, LOW_PR_DROP_ENf, low_prio_select);
                DNXC_IF_ERR_EXIT(WRITE_DCH_DCH_ENABLERS_REGISTER_2r(unit, blk, reg_val));
        }
    }
#endif /*BCM_88790*/
 ...
 */
soc_error_t 
soc_ramon_fe1600_fabric_multicast_low_prio_drop_select_priority_get(int unit, soc_dnxf_fabric_priority_t* prio)
{
    uint32 reg_val, low_prio_select;
    DNXC_INIT_FUNC_DEFS; 
    ...
    switch(low_prio_select)
    {
        ...
        case 0xf:
            *prio = soc_dnxf_fabric_priority_3;
            break;
        default:
            DNXC_EXIT_WITH_ERR(SOC_E_INTERNAL, (_BSL_DNXC_MSG("Unrecognized priority %d"),low_prio_select));
    }
 ...
 */
soc_error_t 
soc_ramon_fe1600_fabric_multicast_low_prio_threshold_validate(int unit, bcm_fabric_control_t type, int arg)
{
    uint64  val64;
    DNXC_INIT_FUNC_DEFS; 
    ...
    switch(type)
    {
        case bcmFabricMcLowPrioDropThUp:
            if(SOC_FAILURE(soc_reg64_field_validate(unit, RTP_LOW_PR_MULTHr, LOW_PR_MUL_DROP_TH_HIGHf, val64))) {
                DNXC_EXIT_WITH_ERR(SOC_E_PARAM, (_BSL_DNXC_MSG("Argument is too big %d"),arg));
            }
            break;
        case bcmFabricMcLowPrioDropThDown:
            ...
            break;
        default:
            DNXC_EXIT_WITH_ERR(SOC_E_PARAM, (_BSL_DNXC_MSG("Unsupported control type %d"),type));
    }
 ...
 */
soc_error_t 
soc_ramon_fe1600_fabric_multicast_low_prio_threshold_set(int unit, bcm_fabric_control_t type, int arg)
{
    uint64 reg_val, val64;
    DNXC_INIT_FUNC_DEFS; 
	
    DNXC_IF_ERR_EXIT(READ_RTP_LOW_PR_MULTHr(unit, &reg_val));
    COMPILER_64_SET(val64, 0, arg);
    switch(type)
    {
        case bcmFabricMcLowPrioDropThUp:
    ...
    DNXC_IF_ERR_EXIT(WRITE_RTP_LOW_PR_MULTHr(unit, reg_val));
 ...
 */
soc_error_t 
soc_ramon_fe1600_fabric_multicast_low_prio_threshold_get(int unit, bcm_fabric_control_t type, int* arg)
{
    uint64 reg_val;
    DNXC_INIT_FUNC_DEFS; 
 ...
 */
soc_error_t 
soc_ramon_fe1600_fabric_multicast_low_priority_drop_enable_set(int unit, int arg)
{
    uint32 reg_val;
    DNXC_INIT_FUNC_DEFS; 
 ...
 */
soc_error_t 
soc_ramon_fe1600_fabric_multicast_low_priority_drop_enable_get(int unit, int* arg)
{
    uint32 reg_val;
    DNXC_INIT_FUNC_DEFS; 
 ...
 */
soc_error_t 
soc_ramon_fe1600_fabric_multicast_priority_range_validate(int unit, bcm_fabric_control_t type, int arg)
{
    uint32 max_id ;
    DNXC_INIT_FUNC_DEFS; 
    
    DNXC_IF_ERR_EXIT(MBCM_DNXF_DRIVER_CALL(unit, mbcm_dnxf_multicast_table_size_get, (unit, &max_id)));

     if(arg < 0 || arg >= max_id) {
         DNXC_EXIT_WITH_ERR(SOC_E_PARAM, (_BSL_DNXC_MSG("arg %d is invalid for type %d, outside of multicast id range"),arg, type));
     }
 ...
 */
soc_error_t 
soc_ramon_fe1600_fabric_multicast_priority_range_set(int unit, bcm_fabric_control_t type, int arg)
{
    uint32 reg_val = 0;
    DNXC_INIT_FUNC_DEFS; 
    ...
    {    
        case bcmFabricMcLowPrioMin:
            ...
            DNXC_IF_ERR_EXIT(WRITE_DCH_LOW_PR_MUL_0r(unit, 0, reg_val));
            DNXC_IF_ERR_EXIT(WRITE_DCH_LOW_PR_MUL_0r(unit, 1, reg_val));
            DNXC_IF_ERR_EXIT(WRITE_DCH_LOW_PR_MUL_0r(unit, 2, reg_val));
            DNXC_IF_ERR_EXIT(WRITE_DCH_LOW_PR_MUL_0r(unit, 3, reg_val));
            break;
        case bcmFabricMcLowPrioMax:
            soc_reg_field_set(unit, DCH_LOW_PR_MUL_1r, &reg_val, LOW_PR_MUL_QUE_HIGHf, arg);
            DNXC_IF_ERR_EXIT(WRITE_DCH_LOW_PR_MUL_1r(unit, 0, reg_val));
            DNXC_IF_ERR_EXIT(WRITE_DCH_LOW_PR_MUL_1r(unit, 1, reg_val));
            DNXC_IF_ERR_EXIT(WRITE_DCH_LOW_PR_MUL_1r(unit, 2, reg_val));
            DNXC_IF_ERR_EXIT(WRITE_DCH_LOW_PR_MUL_1r(unit, 3, reg_val));
            break;
        case bcmFabricMcMidPrioMin:
            soc_reg_field_set(unit, DCH_MID_PR_MUL_0r, &reg_val, MID_PR_MUL_QUE_LOWf, arg);
            DNXC_IF_ERR_EXIT(WRITE_DCH_MID_PR_MUL_0r(unit, 0, reg_val));
            DNXC_IF_ERR_EXIT(WRITE_DCH_MID_PR_MUL_0r(unit, 1, reg_val));
            DNXC_IF_ERR_EXIT(WRITE_DCH_MID_PR_MUL_0r(unit, 2, reg_val));
            DNXC_IF_ERR_EXIT(WRITE_DCH_MID_PR_MUL_0r(unit, 3, reg_val));
            break;
        case bcmFabricMcMidPrioMax:
            soc_reg_field_set(unit, DCH_MID_PR_MUL_1r, &reg_val, MID_PR_MUL_QUE_HIGHf, arg);
            DNXC_IF_ERR_EXIT(WRITE_DCH_MID_PR_MUL_1r(unit, 0, reg_val));
            DNXC_IF_ERR_EXIT(WRITE_DCH_MID_PR_MUL_1r(unit, 1, reg_val));
            DNXC_IF_ERR_EXIT(WRITE_DCH_MID_PR_MUL_1r(unit, 2, reg_val));
            DNXC_IF_ERR_EXIT(WRITE_DCH_MID_PR_MUL_1r(unit, 3, reg_val));
            break;
        default:
            DNXC_EXIT_WITH_ERR(SOC_E_PARAM, (_BSL_DNXC_MSG("Unsupported control type %d"),type));
    }
 ...
 */
soc_error_t 
soc_ramon_fe1600_fabric_multicast_priority_range_get(int unit, bcm_fabric_control_t type, int* arg)
{
    uint32 reg_val = 0;
    DNXC_INIT_FUNC_DEFS;
    ...
    bcm_fabric_module_vector_t *dest_array) 
{
    ...
    if (!flags || (flags & _SHR_FABRIC_MULTICAST_SET_ONLY))
    {
        ...
        {
            DNXC_EXIT_WITH_ERR(SOC_E_PARAM, (_BSL_DNXC_MSG("Wrong params - groups\n")));
        }
        ...
        if (entry_array == NULL) {
             DNXC_EXIT_WITH_ERR(SOC_E_PARAM, (_BSL_DNXC_MSG("failed to allocate memory")));
        }

        if (SOC_IS_FE1600(unit))
        {
            /*RAMON_FE1600 does not support read-modify-write*/
            sal_memset(entry_array, 0, size);
        } 
        else
        {
            rv = soc_ramon_fe1600_fabric_multicast_multi_read_range(unit, index_min, index_max, entry_array);
            DNXC_IF_ERR_EXIT(rv);
        }
    ...
    rv = MBCM_DNXF_DRIVER_CALL(unit, mbcm_dnxf_fabric_multicast_multi_write_range, (unit, mem_flags, index_min, index_max, entry_array));
    DNXC_IF_ERR_EXIT(rv);
...
STATIC 
soc_dnxf_multicast_read_range_info_t _soc_ramon_fe1600_fabric_multicast_read_range_info_standard[] = {
    {
        0,
        _SOC_RAMON_FE1600_FABRIC_MULTICAST_TABLE_SIZE - 1,
        0,
        1
    }
};
...
soc_error_t
soc_ramon_fe1600_fabric_multicast_multi_read_info_get(int unit, soc_dnxf_multicast_read_range_info_t **info, int *info_size)
{
    DNXC_INIT_FUNC_DEFS;
    SOC_RAMON_FE1600_ONLY(unit);

    *info = _soc_ramon_fe1600_fabric_multicast_read_range_info_standard;
    *info_size = sizeof(_soc_ramon_fe1600_fabric_multicast_read_range_info_standard) / sizeof(soc_dnxf_multicast_read_range_info_t);
 ...
 */
soc_error_t
soc_ramon_fe1600_fabric_multicast_multi_write_range(int unit, int mem_flags, soc_multicast_t group_min, soc_multicast_t group_max, uint32 *entry_array)
{
    int rv;
    DNXC_INIT_FUNC_DEFS;
    SOC_RAMON_FE1600_ONLY(unit);
 ...
 */
STATIC soc_error_t
soc_ramon_fe1600_fabric_multicast_multi_read_range(int unit, soc_multicast_t group_min, soc_multicast_t group_max, uint32 *entry_array)
{
    int rv;
    uint32 *cur_entry_array, *entry;
    int entry_index,info_index,  entry_words;
    int read_index_min, read_index_max;
    uint32 data[_SHR_BITDCLSIZE(_SOC_RAMON_FE1600_FABRIC_MULTICAST_MAX_MC_MODULES)];
    uint32 mc_table_entry_size;
    soc_dnxf_multicast_read_range_info_t *info;
    int info_size;
    DNXC_INIT_FUNC_DEFS;
         ...
         info_index++)
    {
        if (group_min < info[info_index].group_max && group_max > info[info_index].group_min) /*check if enries are required from this part*/
        {
            ...
            read_index_max = (group_max < info[info_index].group_max) ? (group_max - info[info_index].group_min) : _SOC_RAMON_FE1600_FABRIC_MULTICAST_TABLE_SIZE - 1;
...
soc_error_t 
soc_ramon_fe1600_fabric_multicast_read_info(int unit, soc_multicast_t group, int *mc_table_index, int *mc_table_entry, int *is_first_half)
{
    soc_dnxf_multicast_read_range_info_t *info;
    ...
    if (found == 0)
    {
        DNXC_EXIT_WITH_ERR(SOC_E_PARAM, (_BSL_DNXC_MSG("group (%d) read info wasn't found\n"), group));
    }
exit:
    DNXC_FUNC_RETURN;
}
