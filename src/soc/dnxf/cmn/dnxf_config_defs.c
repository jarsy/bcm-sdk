...
soc_dnxf_defines_t *soc_dnxf_defines[SOC_MAX_NUM_DEVICES] = {NULL};
...
int soc_dnxf_defines_init(int unit)
{
    ...
    case SOC_INFO_CHIP_TYPE_RAMON:
        SOCDNX_IF_ERR_EXIT(soc_ramon_defines_init(unit));
        break;
#endif /* BCM_88790_A0 */
...
#ifdef BCM_88790_A0
    case SOC_INFO_CHIP_TYPE_RAMON:
        SOCDNX_IF_ERR_EXIT(soc_ramon_defines_deinit(unit));
        break;
#endif /* BCM_88790_A0 */
