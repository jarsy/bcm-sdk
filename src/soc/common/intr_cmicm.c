...
#if defined(BCM_ESW_SUPPORT) || defined(BCM_CALADAN3_SUPPORT) || defined(BCM_PETRA_SUPPORT)
...
STATIC intr_handler_t soc_cmicdv4_intr_handlers6[] = {
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 0, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 1, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 2, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 3, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 4, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 5, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 6, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 7, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 8, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 9, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 10, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 11, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 12, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 13, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 14, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 15, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 16, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 17, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 18, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 19, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 20, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 21, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 22, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 23, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 24, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 25, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 26, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 27, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 28, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 29, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 30, "PARITY INTR" },
    { IRQ_CMCx_PARITY, soc_cmicdv4_block_intr6, 31, "PARITY INTR" },
    { 0, NULL, 0, "" } /* Termination */
};
...
#endif /* defined(BCM_ESW_SUPPORT) || defined(BCM_CALADAN3_SUPPORT) || defined(BCM_PETRA_SUPPORT) */
...
soc_cmicm_intr_sbusdma_done(int unit, uint32 vchan)
{
    ...
    if (soc_feature(unit, soc_feature_cmicm_multi_dma_cmc)) {
        ...
        if (ch > CMIC_CMCx_SBUSDMA_CHAN_MAX - 1) {
...
soc_cmicm_fifo_dma_done(int unit, uint32 vchan)
{
    ...
    if (SOC_IS_CALADAN3(unit)) {
...
#endif
    }else if (SOC_IS_JERICHO(unit) && (vchan == oam_status_channel))  {
#ifdef BCM_PETRA_SUPPORT
        uint8 oam_is_init=0;
        uint8 bfd_is_init=0;
        uint32 rv;
        ...
        if  (oam_is_init || bfd_is_init) {
            (void)soc_cmicm_cmcx_intr0_disable(unit, cmc, IRQ_CMCx_FIFO_CH_DMA(ch));
            sal_dpc(soc_ppd_oam_dma_event_handler, INT_TO_PTR(unit), INT_TO_PTR(SOC_PPC_OAM_DMA_EVENT_TYPE_STAT_EVENT), INT_TO_PTR(cmc), INT_TO_PTR(ch), 0);
        }
#endif
        ...
        if  (oam_is_init || bfd_is_init) {
            (void)soc_cmicm_cmcx_intr0_disable(unit, cmc, IRQ_CMCx_FIFO_CH_DMA(ch));
            sal_dpc(soc_ppd_oam_dma_event_handler, INT_TO_PTR(unit), INT_TO_PTR(SOC_PPC_OAM_DMA_EVENT_TYPE_EVENT), INT_TO_PTR(cmc), INT_TO_PTR(ch), 0);
        }
#endif
        ...
        (void)soc_cmicm_cmcx_intr0_disable(unit, cmc, IRQ_CMCx_FIFO_CH_DMA(ch));
        sal_dpc(arad_pp_frwrd_mact_learning_dma_event_handler, INT_TO_PTR(unit), 0, INT_TO_PTR(cmc), INT_TO_PTR(ch), 0);
...
#endif /* (BCM_ESW_SUPPORT) || (BCM_CALADAN3_SUPPORT)  || defined(BCM_PETRA_SUPPORT) */
