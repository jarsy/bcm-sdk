    ...
    *blk = 0;/* not really needed, just to avoid coverity defect */
    ...
    if ((!block_id_mask) && (!schan_id_mask) && (REG_PORT_ANY == port || instance_mask || !SOC_BLOCK_IN_LIST(regblktype, portblktype))) {
		...
		case SOC_BLK_CFC:
            ...
            break;
		case SOC_BLK_OCB:
			block = OCB_BLOCK(unit, blkport);
            break;
        case SOC_BLK_CRPS:
            block = CRPS_BLOCK(unit);
            break;
		case SOC_BLK_EPRE:
			block = EPRE_BLOCK(unit, blkport);
            break;
        case SOC_BLK_FDTL:
        ...
        case SOC_BLK_IQM:
            ...
            break;
        case SOC_BLK_PQP:
            block = PQP_BLOCK(unit, blkport);
            break;
        case SOC_BLK_KAPS:
            block = SOC_IS_DNX(unit) ? KAPS_MI_BLOCK(unit,blkport) : KAPS_BLOCK(unit);
            break;
        ...
        case SOC_BLK_OLP:
            ...
            break;
        case SOC_BLK_SIF:
            block = SIF_BLOCK(unit, blkport);
            break;
	    case SOC_BLK_MCP:
            block = MCP_BLOCK(unit, blkport);
            break;					
        case SOC_BLK_ITPP:
            block = ITPP_BLOCK(unit, blkport);
            break;			
        case SOC_BLK_PDM:
            block = PDM_BLOCK(unit, blkport);
            break;
        case SOC_BLK_BDM:
            block = BDM_BLOCK(unit, blkport);
            break;
        case SOC_BLK_CDU:
            block = CDU_BLOCK(unit, blkport);
            break;
        case SOC_BLK_CDUM:
            block = CDUM_BLOCK(unit, blkport);
            break;
        case SOC_BLK_EPS:
            block = EPS_BLOCK(unit, blkport);
            break;
        ...
        case SOC_BLK_ETPPC:
            block = ETPPC_BLOCK(unit, blkport);
            break;
        ...
        case SOC_BLK_ILE:
            block = ILE_BLOCK(unit, blkport);
            break;
        case SOC_BLK_ILU:
            block = ILU_BLOCK(unit, blkport);
            break;
        case SOC_BLK_NMG:
            block = NMG_BLOCK(unit, blkport);
            break;

        case SOC_BLK_IPPE:
            block = IPPE_BLOCK(unit, blkport);
            break;

        case SOC_BLK_TCAM:
            block = TCAM_BLOCK(unit, blkport);
            break;

        case SOC_BLK_TDU:
            block = TDU_BLOCK(unit, blkport);
            break;
        ...
        case SOC_BLK_HBM:
            ...
            break;
        case SOC_BLK_RQP:
            block = RQP_BLOCK(unit, blkport);
            break;
        case SOC_BLK_FQP:
            block = FQP_BLOCK(unit, blkport);
            break;
        case SOC_BLK_HBMC:
        ...
        case SOC_BLK_MDB:
            ...
            break;
        case SOC_BLK_ERPP:
            block = ERPP_BLOCK(unit, blkport);
            break;
        case SOC_BLK_ETPPA:
            block = ETPPA_BLOCK(unit, blkport);
            break;			
        case SOC_BLK_ETPPB:
            block = ETPPB_BLOCK(unit, blkport);
            break;			
        case SOC_BLK_MACT:
            block = MACT_BLOCK(unit);
            break;			
        case SOC_BLK_IPPA:
            block = IPPA_BLOCK(unit, blkport);
            break;			
        case SOC_BLK_IPPB:
            block = IPPB_BLOCK(unit, blkport);
            break;			
        case SOC_BLK_IPPC:
            block = IPPC_BLOCK(unit, blkport);
            break;			
        case SOC_BLK_IPPD:
            block = IPPD_BLOCK(unit, blkport);
            break;				
        case SOC_BLK_FSRD:
