                              ...
                              soc_port_ability_t *ability)
{
    ...
    speed_full_duplex|= PHYMOD_BAM_CL73_CAP_50G_CR4_GET(reg73_ability) ?SOC_PA_SPEED_50GB:0;
    speed_full_duplex|= PHYMOD_BAM_CL73_CAP_50G_KR4_GET(reg73_ability) ?SOC_PA_SPEED_50GB:0;
    ...
    if (PHYMOD_AN_CAP_25G_CRS1_GET(reg73_ability) || PHYMOD_AN_CAP_25G_CRS1_GET(reg73_ability)) {
    ...
    if (PHYMOD_AN_CAP_100G_CR4_GET(reg73_ability) || PHYMOD_AN_CAP_40G_CR4_GET(reg73_ability)  ||
        ...
        PHYMOD_BAM_CL73_CAP_20G_CR2_GET(reg73_ability)  || PHYMOD_BAM_CL73_CAP_40G_CR2_GET(reg73_ability) ||
        PHYMOD_BAM_CL73_CAP_50G_CR2_GET(reg73_ability)  || PHYMOD_BAM_CL73_CAP_25G_CR1_GET(reg73_ability) ||
        PHYMOD_BAM_CL73_CAP_50G_CR4_GET(reg73_ability)) {
