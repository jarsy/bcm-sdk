...
#ifdef BE_HOST
        x_bfcmap_port_cfg.trcm_attribs = BCMSWAP32(pCfg->trcm_attribs);
#else
...
#ifdef BE_HOST
        x_bfcmap_port_cfg.cos_to_pri.cos = BCMSWAP16(pCfg->cos_to_pri.cos);
        x_bfcmap_port_cfg.cos_to_pri.pri = BCMSWAP16(pCfg->cos_to_pri.pri);
#else
...
#ifdef BE_HOST
        pCfg->trcm_attribs = BCMSWAP32(x_bfcmap_port_cfg.trcm_attribs);
#else
...
#ifdef BE_HOST
        pCfg->cos_to_pri.cos = BCMSWAP16(x_bfcmap_port_cfg.cos_to_pri.cos);
        pCfg->cos_to_pri.pri = BCMSWAP16(x_bfcmap_port_cfg.cos_to_pri.pri);
#else
