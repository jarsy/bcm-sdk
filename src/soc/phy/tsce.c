                              ...
                              soc_port_ability_t *ability)
{
    ...
    phymod_autoneg_ability_t  phymod_autoneg_ability; 
    phymod_autoneg_control_t  an_control;
    int                       an_complete, all=0, cl73grp=0, cl37grp=0;
    ...
    PHYMOD_MEMSET(&an_control, 0x0, sizeof(an_control));
    SOC_IF_ERROR_RETURN
        (phymod_phy_autoneg_get(&phy->pm_phy, &an_control, (uint32_t *) &an_complete)); 
    
    speed_full_duplex = 0;
    
    switch(an_control.an_mode) {
    case phymod_AN_MODE_NONE: 
        all = 1;
        break;
    ...
    case phymod_AN_MODE_CL37_SGMII:
        cl37grp = 1;
        break;
    default:
        all = 1;
