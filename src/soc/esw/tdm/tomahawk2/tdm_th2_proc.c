...
tdm_th2_vmap_alloc( tdm_mod_t *_tdm )
{
	...
	if (_tdm->_core_data.vars_pkg.lr_buffer[0] != _tdm->_chip_data.soc_pkg.num_ext_ports) {
		_tdm->_core_data.vars_pkg.lr_enable = 1;
	}
	if (_tdm->_core_data.vars_pkg.os_buffer[0] != _tdm->_chip_data.soc_pkg.num_ext_ports) {
