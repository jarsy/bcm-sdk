...
extern int soc_alpm_cmn_mode_get(int u);
...
static int
_soc_th_alpm_128_lpm_ent_key_init(int unit, uint32 *addr, int len, int vrf, int ipv6,
                                    defip_pair_128_entry_t *lpm_entry, int init)
{
    uint32 tmp;
    ...
    _soc_th_alpm_128_pfx_len_to_mask(unit, (void *)lpm_entry, len);
                                 ...
                                 int do_urpf)
{
    ...
    ent_num = SOC_TH_ALPM_SCALE_CHECK(u, v6) ? 16 : 8;
...
static int
_soc_th_alpm_128_fill_aux_entry_for_op(int unit,
               void *key_data,
               int ipv6,    /* Entry is ipv6. */
               int db_type, /* database type */
               int ent_type,
               ...
               defip_aux_scratch_entry_t *aux_entry)
{
    ...
    ipv4a = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, key_data,
                                    VALID0_LWRf);
    soc_mem_field32_set(unit, L3_DEFIP_AUX_SCRATCHm, aux_entry, VALIDf, ipv4a);

    ipv4a = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, key_data, MODE0_LWRf);
    ...
    ipv4a = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, key_data, ECMPf);
    soc_mem_field32_set(unit, L3_DEFIP_AUX_SCRATCHm, aux_entry, ECMPf, ipv4a);

    ipv4a = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, key_data, ECMP_PTRf);
    ...
    ipv4a = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, key_data, PRIf);
    soc_mem_field32_set(unit, L3_DEFIP_AUX_SCRATCHm, aux_entry, PRIf, ipv4a);

    ipv4a = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, key_data, RPEf);
    ...
    ipv4a = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, key_data, CLASS_IDf);
    soc_mem_field32_set(unit, L3_DEFIP_AUX_SCRATCHm, aux_entry, CLASS_IDf,
                        ipv4a);


    /* Set IP Address and IP length */
    ip6_word[0] = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, key_data,
                                      IP_ADDR0_LWRf);
    ip6_word[1] = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, key_data,
                                      IP_ADDR1_LWRf);
    ip6_word[2] = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, key_data,
                                      IP_ADDR0_UPRf);
    ip6_word[3] = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, key_data,
                                      IP_ADDR1_UPRf);
    soc_mem_field_set(unit, L3_DEFIP_AUX_SCRATCHm, (uint32*)aux_entry,
                      IP_ADDRf, (uint32*)ip6_word);

    rv = _soc_th_alpm_128_ip6_mask_len_get(unit, key_data, &pfx);
    if (SOC_FAILURE(rv)) {
        return rv;
    }
...
static int
_soc_th_alpm_128_mem_ent_init(int unit, void *lpm_entry,
                       void *alpm_entry, void *alpm_sip_entry, soc_mem_t mem,
                       uint32 src_flags, uint32 *is_default, int bucket_id)
{
    ...
    ipv4a = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, HITf);
    soc_mem_field32_set(unit, mem, alpm_entry, HITf, ipv4a);

    ipv4a = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                                    VALID0_LWRf);
    soc_mem_field32_set(unit, mem, alpm_entry, VALIDf, ipv4a);

    ipv4a = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, ECMPf);
    soc_mem_field32_set(unit, mem, alpm_entry, ECMPf, ipv4a);

    ipv4a = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, ECMP_PTRf);
    ...
    ipv4a = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, PRIf);
    soc_mem_field32_set(unit, mem, alpm_entry, PRIf, ipv4a);

    ipv4a = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, RPEf);
    ...
    ipv4a = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, CLASS_IDf);
    ...
    /* Set IP Address and IP length */
    ip6_word[0] = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                                          IP_ADDR0_LWRf);
    ip6_word[1] = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                                          IP_ADDR1_LWRf);
    ip6_word[2] = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                                          IP_ADDR0_UPRf);
    ip6_word[3] = SOC_MEM_OPT_F32_GET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                                          IP_ADDR1_UPRf);
    soc_mem_field_set(unit, mem, (uint32*)alpm_entry, KEYf, (uint32*)ip6_word);

    rv = _soc_th_alpm_128_ip6_mask_len_get(unit, lpm_entry, &pfx);
    if (SOC_FAILURE(rv)) {
        return rv;
    }
...
static int
_soc_th_alpm_128_lpm_ent_init(int unit, void *alpm_entry, soc_mem_t mem, int ipv6,
                              ...
                              int flex)
{
    ...
    SOC_MEM_OPT_F32_SET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, HITf, ipv4a);
    ...
    SOC_MEM_OPT_F32_SET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, ECMPf, ipv4a);

    ipv4a = soc_mem_field32_get(unit, mem, alpm_entry, ECMP_PTRf);
    SOC_MEM_OPT_F32_SET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, ECMP_PTRf, ipv4a);
    ...
    SOC_MEM_OPT_F32_SET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, PRIf, ipv4a);

    ipv4a = soc_mem_field32_get(unit, mem, alpm_entry, RPEf);
    SOC_MEM_OPT_F32_SET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, RPEf, ipv4a);

    ipv4a = soc_mem_field32_get(unit, mem, alpm_entry, DST_DISCARDf);
    SOC_MEM_OPT_F32_SET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, DST_DISCARDf, ipv4a);

    ipv4a = soc_mem_field32_get(unit, mem, alpm_entry, SRC_DISCARDf);
    SOC_MEM_OPT_F32_SET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, SRC_DISCARDf, ipv4a);

    ipv4a = soc_mem_field32_get(unit, mem, alpm_entry, CLASS_IDf);
    SOC_MEM_OPT_F32_SET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, CLASS_IDf, ipv4a);

    SOC_MEM_OPT_F32_SET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, ALG_BKT_PTRf,
                            ALPM_PHY_BKT(unit, bucket));
    SOC_MEM_OPT_F32_SET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, ALG_SUB_BKT_PTRf,
                            ALPM_SUB_BKT(u, bucket));
    if (index > 0) {
        SOC_MEM_OPT_F32_SET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, ALG_HIT_IDXf,
                                index);
    }
    ...
    SOC_MEM_OPT_F32_SET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, IP_ADDR0_LWRf,
                            ip6_word[0]);
    SOC_MEM_OPT_F32_SET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, IP_ADDR1_LWRf,
                            ip6_word[1]);
    SOC_MEM_OPT_F32_SET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, IP_ADDR0_UPRf,
                            ip6_word[2]);
    SOC_MEM_OPT_F32_SET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, IP_ADDR1_UPRf,
                            ip6_word[3]);

    ip6_word[0] = ip6_word[1] = ip6_word[2] = ip6_word[3] = 0;

    ipv4a = soc_mem_field32_get(unit, mem, alpm_entry, LENGTHf);
    _soc_th_alpm_128_pfx_len_to_mask(unit, lpm_entry, ipv4a);
    ...
    SOC_MEM_OPT_F32_SET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, ENTRY_VIEWf, flex);
    ...
    SOC_MEM_OPT_F32_SET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, FLEX_CTR_BASE_COUNTER_IDXf, ipv4a);

    ipv4a = soc_mem_field32_get(unit, mem, alpm_entry, FLEX_CTR_OFFSET_MODEf);
    SOC_MEM_OPT_F32_SET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, FLEX_CTR_OFFSET_MODEf, ipv4a);

    ipv4a = soc_mem_field32_get(unit, mem, alpm_entry, FLEX_CTR_POOL_NUMBERf);
    SOC_MEM_OPT_F32_SET_128(unit, L3_DEFIP_PAIR_128m, lpm_entry, FLEX_CTR_POOL_NUMBERf, ipv4a);
...
soc_th_alpm_128_warmboot_lpm_reinit_done(int unit)
{
    ...
    if (soc_alpm_cmn_mode_get(unit) == SOC_ALPM_MODE_COMBINED) {
