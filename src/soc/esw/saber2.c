...
const static uint32 sb2_tdm_56460_A_ref[SB2_TDM_A_SIZE] = {
    /*Col:1*/       /*Col:2*/       /*Col:3*/       /*Col:4*/   /*Col:5*/   /*Col:6*/  /*Col:7*/
/*1*/	25,		26,		27,		28,	SB2_LPBK,	1,	5,          
/*2*/	25, 		26,		27,		28,	9,		13,	17,         
/*3*/	25,		26,		27,		28,	SB2_CMIC,	21,	2,
/*4*/	25,		26,		27,		28,	6,		10,	14,
/*5*/	25,		26,		27,		28,	SB2_LPBK,	18,	22,
/*6*/	25,		26,		27,		28,	3,		7,	11,
/*7*/	25,		26,		27,		28,	SB2_CMIC,	15,	19,
/*8*/	25,		26,		27,		28,	23,		4,	8,
/*9*/	25,		26,		27,		28,	SB2_LPBK,	12,	16,
/*10*/	25,		26,		27,		28,	20,		24,	1,
/*11*/	25,		26,		27,		28,	SB2_CMIC,	5,	9,
/*12*/	25,		26,		27,		28,	13,		17,	21,
/*13*/	25,		26,		27,		28,	SB2_LPBK,	2,	6,
/*14*/	25,		26,		27,		28,	10,		14,	18,
/*15*/	25,		26,		27,		28,	SB2_CMIC,	22,	3,
/*16*/	25,		26,		27,		28,	7,		11,	15, 
/*17*/	25,		26,		27,		28,	SB2_LPBK,	19,	25,
/*18*/	26,		27,		28,		23,	4,		25,	26,
/*19*/	27,		28,		8,		12,	25,		26,	27,
/*20*/	28,		16,		20,		25,	26,		27,	28,
/*21*/	24,		SB2_IDLE,	SB2_IDLE,	25,	26,		27,	28,
/*22*/	SB2_LPBK,	1,		5,		25,	26,		27,	28,         
/*23*/	9,		13,		17,		25,     26,		27,	28,
/*24*/	SB2_CMIC,	21,		2,		25,	26,		27,	28,
/*25*/	6,		10,		14,		25,	26,		27,	28,
/*26*/	SB2_LPBK,	18,		22,		25,	26,		27,	28,
/*27*/	3,		7,		11,		25,	26,		27,	28,
/*28*/	SB2_CMIC,	15,		19, 		25,	26,		27,	28,
/*29*/	23,		4,		8,		25,	26,		27,	28,
/*30*/	SB2_LPBK,	12,		16,		25,	26,		27,	28,
/*31*/	20,		24,		1,		25,	26,		27,	28,
/*32*/	SB2_CMIC,	5,		9,		25,	26,		27,	28,
/*33*/	13,		17,		21,		25,	26,		27,	28,
/*34*/	SB2_LPBK,	2,		6,		25,	26,		27,	28,
/*35*/	10,		14,		18,		25,	26,		27,	28,
/*36*/	SB2_CMIC,	22,		3,		25,	26,		27,	28,
/*37*/	7,		11,		15,		25,	26,		27,	28,
/*38*/	SB2_LPBK,	19,		25,		26,	27,		28,	23,
/*39*/	4,		25,		26,		27,	28,		8,	12,
/*40*/	25,		26,		27,		28,	16,		20,	25,
/*41*/	26,		27,		28,		24      /* ------  EMPTY     ---*/
};
 ...
 */
STATIC 
int _soc_saber2_mmu_init_helper(int unit)
{
    soc_info_t    *si= &SOC_INFO(unit); 
    uint16        dev_id=0;
    uint8         rev_id=0;
...
int _soc_saber2_mmu_reconfigure(int unit)
{
  SOC_IF_ERROR_RETURN(_soc_saber2_mmu_init_helper(unit));
  LOG_CLI((BSL_META_U(unit,
                      "MMU is reconfigured \n")));
  return SOC_E_NONE;
}
...
soc_saber2_num_cosq_init(int unit)
{
    ...
    for (port = si->cmic_port + 1 ; port < si->lb_port; port++) {
        ...
        si->port_uc_cosq_base[port] = si->port_uc_cosq_base[port - 1] +
            numq;
        ...
        if (((!ext_mem_type && !SOC_PBMP_MEMBER(PBMP_EXT_MEM (unit), port)) ||
            ...
            for (queue = si->port_uc_cosq_base[port];
                ...
                temp_val = soc_mem_field32_get(unit, MMU_THDO_QCONFIG_CELLm,
                                    ...
                                    Q_LIMIT_DYNAMIC_CELLf);
                if (!temp_val) {
                    cur_limit = soc_mem_field32_get(unit, MMU_THDO_QCONFIG_CELLm,
                                        &mmu_thdo_qconfig_cell_entry, 
                                        Q_SHARED_LIMIT_CELLf);
                    if (_soc_sb2_mmu_config_shared_update_check(
                            unit, cur_limit, shared_size, flags)) {
