...
/* Internal Use Only : Test Purpose */
#define _HR3_SER_SKIP_MMU  (1)
#define _HR3_SER_SKIP_TCAM (1)
#define _HR3_SER_SKIP_EP   (1)
#define _HR3_SER_SKIP_IP0  (1)
...
static _soc_hr3_ser_info_t _soc_hr3_ip0_ser_info[] = {
    ...
    { _SOC_PARITY_TYPE_ECC, NULL,
        ...
        LPORT_TABm, "LPORT_TABLE/LPORT_PROFILE_TABLE",
    ...
    { _SOC_PARITY_TYPE_PARITY, NULL,
        ...
        INVALIDr, INVALIDf,
        INVALIDr, INVALIDr, INVALIDr,
        (_SOC_SER_SKIP_HR3L | _SOC_SER_SKIP_FH2)
    },
    { _SOC_PARITY_TYPE_PARITY, NULL,
...
static _soc_hr3_ser_info_t _soc_hr3_ep_ser_info[] = {
    ...
    { _SOC_PARITY_TYPE_PARITY, NULL,
        ...
        INVALIDr, INVALIDf,
        INVALIDr, INVALIDr, INVALIDr,
        _SOC_SER_SKIP_FH2 | _SOC_SER_SKIP_HR3L
    },
    { _SOC_PARITY_TYPE_PARITY, NULL,
...
static _soc_hr3_ser_route_block_t _soc_hr3_ser_route_blocks[] = {
...
STATIC int
_soc_hr3_ser_mem_skip(int unit, int skip_info)
{
    int sku;
    int skip = 0;
    ...
    case (SOC_HR3_SKU_HURRICANE3LITE):
        if (skip_info & _SOC_SER_SKIP_HR3L) {
            skip = 1;
        }
        break;
    case (SOC_HR3_SKU_BUCKHOUND):
        if (skip_info & _SOC_SER_SKIP_BH) {
            skip = 1;
        }
        break;
    case (SOC_HR3_SKU_FOXHOUND2):
        if (skip_info & _SOC_SER_SKIP_FH2) {
            skip = 1;
        }
        break;
    default:
...

{
    ...
    uint32  reg_val, valid_val;
    int index, double_bit, multiple = 0;
    uint32 minfo;
    int port;
    ...
    for (idx = 0; reg_ptr[idx].reg != INVALIDr; idx++) {
        ...
        if (soc_reg_field_get(unit, reg, rval, parity_error_field)) {
            ...
            if (parity_type == _SOC_PARITY_TYPE_ECC) {
                ...
                double_bit = soc_reg_field_get(unit, reg,
                                   rval, DOUBLE_BIT_ERRf);
            }
...

{
    ...
    for (info_index = 0; ; info_index++) {
        ...
        if (_soc_hr3_ser_mem_skip(unit, info->sku_skip)) {
            continue;
        }        
...
_soc_hr3_ser_process_all(int unit, uint32 cmic_rval)
{
    ...
    for (rbi = 0; ; rbi++) {
        rb = &_soc_hr3_ser_route_blocks[rbi];
