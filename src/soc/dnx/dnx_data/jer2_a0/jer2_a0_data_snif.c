 ...
 */
static shr_error_e
jer2_a0_dnx_data_snif_ingress_nof_profiles_set(
    int unit)
{
    ...
    int unit)
{
    ...
    define->set = jer2_a0_dnx_data_snif_ingress_nof_profiles_set;
