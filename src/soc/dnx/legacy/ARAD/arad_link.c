/* 
 * $Id: jer2_arad_link.c,v 1.3 Broadcom SDK $
 * $Copyright: (c) 2016 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 *
 * File:        jer2_arad_link.c
...
/*
 * Function:
 *     _soc_jer2_arad_linkctrl_linkscan_hw_init
 * Purpose:
 ...
 */
static int
_soc_jer2_arad_linkctrl_linkscan_hw_init(int unit)
{
...
static int
jer2_arad_ports_phy_to_cmic_bitmap_map(
   uint32      unit,
...
static int
_soc_jer2_arad_linkscan_ports_write(int unit, pbmp_t hw_mii_pbm)
{
    uint32      link_pbmp;
    soc_pbmp_t  tmp_pbmp, jer2_arad_pbmp;
    ...
    DNXC_IF_ERR_EXIT(jer2_arad_ports_phy_to_cmic_bitmap_map(unit, tmp_pbmp, &jer2_arad_pbmp));
    SOC_PBMP_ASSIGN(tmp_pbmp, jer2_arad_pbmp);
...
/*
 * Function:
 *     _soc_jer2_arad_linkctrl_linkscan_pause
 * Purpose:
 ...
 */
static int
_soc_jer2_arad_linkctrl_linkscan_pause(int unit)
{
    int stall_count;
    pbmp_t pbm;
    uint32 schan_ctrl;
    ...
    SOC_PBMP_CLEAR(pbm);
    DNXC_IF_ERR_EXIT(_soc_jer2_arad_linkscan_ports_write(unit, pbm));
...
/*
 * Function:
 *     _soc_jer2_arad_linkctrl_linkscan_continue
 * Purpose:
 ...
 */
static int
_soc_jer2_arad_linkctrl_linkscan_continue(int unit)
{
    ...
    */
    ...
    DNXC_IF_ERR_EXIT(_soc_jer2_arad_linkscan_ports_write(unit, soc->hw_linkscan_pbmp));
    DNXC_IF_ERR_EXIT(READ_CMIC_MIIM_SCAN_CTRLr(unit,&schan_ctrl));
...
/*
 * Function:
 *     _soc_jer2_arad_linkctrl_linkscan_config
 * Purpose:
 ...
 */
static int
_soc_jer2_arad_linkctrl_linkscan_config(int unit, pbmp_t hw_mii_pbm,
...
/*
 * Function:    
 *     _soc_jer2_arad_linkctrl_update
 * Purpose:
 ...
 */
static int
_soc_jer2_arad_linkctrl_update(int unit)
{
    DNXC_INIT_FUNC_DEFS;
...
static int
_soc_jer2_arad_linkctrl_hw_link_get(int unit, soc_pbmp_t *hw_link)
{
    uint32 reg_val;
    uint32 link_changed;
    DNXC_INIT_FUNC_DEFS;
    ...
    link_changed = 0;
    reg_val  = 0;
    DNXC_IF_ERR_EXIT(READ_CMIC_MIIM_SCAN_STATUSr(unit, &reg_val));
 ...
 */
CONST soc_linkctrl_driver_t  soc_linkctrl_driver_jer2_arad = {
    NULL,                                     /* port mapping */
    _soc_jer2_arad_linkctrl_linkscan_hw_init,     /* ld_linkscan_hw_init */
    _soc_jer2_arad_linkctrl_linkscan_config,      /* ld_linkscan_config */
    _soc_jer2_arad_linkctrl_linkscan_pause,       /* ld_linkscan_pause */
    _soc_jer2_arad_linkctrl_linkscan_continue,    /* ld_linkscan_continue */
    _soc_jer2_arad_linkctrl_update,                /* ld_update */
    _soc_jer2_arad_linkctrl_hw_link_get           /* ld_hw_link_get */
