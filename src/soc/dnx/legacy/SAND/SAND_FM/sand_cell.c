  ...
  )
{
  ...
  DNX_SAND_INIT_ERROR_DEFINITIONS(DNX_SAND_PACK_DEST_ROUTED_DATA_CELL);
...
exit:
   DNX_SAND_EXIT_AND_SEND_ERROR("error in dnx_sand_pack_dest_routed_data_cell()",iter,0);
}
  ...
  )
{
  ...
  DNX_SAND_INIT_ERROR_DEFINITIONS(DNX_SAND_UNPACK_DEST_ROUTED_DATA_CELL);
  ...
  for(iter=0; iter < DNX_SAND_DATA_CELL_PAYLOAD_IN_BYTES ; ++iter)
  {
    ...
    DNX_SAND_CHECK_FUNC_RESULT(res, 271, exit);
...
exit:
  DNX_SAND_EXIT_AND_SEND_ERROR("error in dnx_sand_unpack_dest_routed_data_cell()",iter,0);
}
  ...
  )
{
  ...
  DNX_SAND_INIT_ERROR_DEFINITIONS(DNX_SAND_PACK_SOURCE_ROUTED_DATA_CELL);
  ...
  DNX_SAND_CHECK_FUNC_RESULT(res, 215, exit);
  res = dnx_sand_bitstream_set_any_field(
          &(tmp_u32_sr_extra_field),
  ...
  DNX_SAND_CHECK_FUNC_RESULT(res, 225, exit);
  res = dnx_sand_bitstream_set_any_field(
          &(tmp_u32_sr_extra_field),
  ...
  DNX_SAND_CHECK_FUNC_RESULT(res, 235, exit);
  res = dnx_sand_bitstream_set_any_field(
          &(tmp_u32_sr_extra_field),
  ...
  DNX_SAND_CHECK_FUNC_RESULT(res, 245, exit);
  res = dnx_sand_bitstream_set_any_field(
          &(tmp_u32_sr_extra_field),
...
exit:
  DNX_SAND_EXIT_AND_SEND_ERROR("error in dnx_sand_pack_source_routed_data_cell()",iter,0);
  ...
  )
{
  ...
  DNX_SAND_INIT_ERROR_DEFINITIONS(DNX_SAND_UNPACK_SOURCE_ROUTED_DATA_CELL);
  ...
  DNX_SAND_CHECK_FUNC_RESULT(res, 223, exit);
  ...
  DNX_SAND_CHECK_FUNC_RESULT(res, 233, exit);
  ...
  DNX_SAND_CHECK_FUNC_RESULT(res, 243, exit);
  ...
  DNX_SAND_CHECK_FUNC_RESULT(res, 253, exit);
...
exit:
  DNX_SAND_EXIT_AND_SEND_ERROR("error in dnx_sand_unpack_source_routed_data_cell()",iter,0);
  ...
  )
{
  ...
  DNX_SAND_INIT_ERROR_DEFINITIONS(DNX_SAND_DATA_CELL_TO_BUFFER);
...
exit:
   DNX_SAND_EXIT_AND_SEND_ERROR("error in dnx_sand_data_cell_to_buffer()",0,0);
  ...
  )
{
  ...
  DNX_SAND_INIT_ERROR_DEFINITIONS(DNX_SAND_BUFFER_TO_DATA_CELL);
...
exit:
  DNX_SAND_EXIT_AND_SEND_ERROR("error in dnx_sand_buffer_to_data_cell()",0,0);
}
