...
#define l64 static
#define lf uint32
#define l11 DNX_SAND_INOUT
#define l3 DNX_SAND_EXACT_MATCH_INFO
#define l6 DNX_SAND_INIT_ERROR_DEFINITIONS
#define l103 DNX_SAND_EXACT_MATCH_MALLOC_STACK
#define lk DNX_SAND_CHECK_NULL_INPUT
#define lh init_info
#define l47 max_insert_steps
#define l2 for
#define l12 DNX_SAND_EXACT_MATCH_NOF_TABLES
#define ll mgmt_info
#define lo stack
#define l83 DNX_SAND_EXACT_MATCH_STACK_ENTRY
#define l24 dnx_sand_os_malloc_any_size
#define l16 sizeof
#define lj key
#define l18 DNX_SAND_EXACT_MATCH_KEY
#define lx uint8
#define lp key_size
#define l61 dnx_sand_os_memset
#define lu hash_indx
#define lg exit
#define l8 DNX_SAND_EXIT_AND_SEND_ERROR
#define l100 DNX_SAND_EXACT_MATCH_FREE_STACK
#define l20 dnx_sand_os_free_any_size
#define l0 DNX_SAND_IN
#define lt DNX_SAND_OUT
#define l85 dnx_sand_exact_match_create
#define l5 DNX_SAND_EXACT_MATCH_INIT_INFO
#define l17 DNX_SAND_EXACT_MATCH_T
#define le res
#define l111 DNX_SAND_EXACT_MATCH_CREATE
...
#define l27 DNX_SAND_SET_ERROR_CODE
#define l78 DNX_SAND_EXACT_MATCH_SIZE_OUT_OF_RANGE_ERR
#define lr table_size
#define l46 DNX_SAND_NOF_BITS_IN_UINT32
#define l38 DNX_SAND_DIV_ROUND_UP
#define l39 DNX_SAND_NOF_BITS_IN_BYTE
#define l51 verifier_size
#define lz keys
#define l71 DNX_SAND_MALLOC_FAIL
#define l15 use_bitmap
#define l73 dnx_sand_bitstream_clear
#define lm DNX_SAND_CHECK_FUNC_RESULT
#define ls tmp_entry
#define l72 DNX_SAND_EXACT_MATCH_ENTRY
#define l14 verifier
#define l87 DNX_SAND_EXACT_MATCH_VERIFIER
#define l13 payload
#define l68 DNX_SAND_EXACT_MATCH_PAYLOAD
#define l74 payload_size
#define l119 dnx_sand_exact_match_destroy
#define l90 DNX_SAND_EXACT_MATCH_DESTROY
#define l99 dnx_sand_exact_match_entry_add
#define l77 DNX_SAND_EXACT_MATCH_HASH_VAL
#define l112 DNX_SAND_EXACT_MATCH_ENTRY_ADD
#define l26 hw_set_fun
#define l53 key_to_verifier
#define ly prime_handle
#define l55 TRUE
#define l44 goto
#define l43 dnx_sand_os_memcpy
#define l33 key_to_hash
#define l28 is_valid_entry_get
#define l7 sec_handle
#define l79 break
#define l59 FALSE
#define l117 dnx_sand_os_printf
#define l34 is_valid_entry_set
#define l40 hw_get_fun
#define l107 dnx_sand_exact_match_entry_remove
#define l94 DNX_SAND_EXACT_MATCH_ENTRY_REMOVE
#define l81 DNX_SAND_EXACT_MATCH_ENTRY_LOOKUP
#define l118 dnx_sand_os_memcmp
#define l123 dnx_sand_exact_match_entry_lookup
#define l120 dnx_sand_exact_match_clear
#define l101 DNX_SAND_EXACT_MATCH_CLEAR
#define l60 DNX_SAND_NULL_POINTER_ERR
#define l91 dnx_sand_exact_match_get_block
#define l96 DNX_SAND_TABLE_BLOCK_RANGE
#define l108 DNX_SAND_EXACT_MATCH_GET_BLOCK
#define l89 DNX_SAND_GET_BIT
#define l48 iter
#define l88 DNX_SAND_GET_BITS_RANGE
#define l93 entries_to_act
#define l104 entries_to_scan
#define l92 DNX_SAND_EXACT_MATCH_NULL
#define l105 dnx_sand_exact_match_get_size_for_save
#define l57 const
#define l35 total_size
#define l95 dnx_sand_exact_match_save
#define l122 buffer_size_bytes
#define l22 cur_size
#define l70 DNX_SAND_COPY_TO_BUFF_AND_INC
#define l106 dnx_sand_exact_match_restore
#define l121 DNX_SAND_EXACT_MATCH_KEY_TO_HASH
#define l109 DNX_SAND_EXACT_MATCH_KEY_TO_VERIFY
#define l113 DNX_SAND_EXACT_MATCH_SW_DB_ENTRY_SET
#define l114 DNX_SAND_EXACT_MATCH_SW_DB_ENTRY_GET
#define l115 DNX_SAND_EXACT_MATCH_HW_ENTRY_SET
#define l116 DNX_SAND_EXACT_MATCH_HW_ENTRY_GET
#define l102 DNX_SAND_EXACT_MATCH_IS_ENTRY_VALID_SET
#define l110 DNX_SAND_EXACT_MATCH_IS_ENTRY_VALID_GET
#define l80 DNX_SAND_EXACT_MATCH_INFO_clear
#define l86 void
#define ln info
#define l56 NULL
#define l97 DNX_SAND_MAGIC_NUM_SET
#define l98 DNX_SAND_VOID_EXIT_AND_SEND_ERROR
