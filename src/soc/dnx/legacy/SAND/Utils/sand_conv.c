  ...
  )
{
  ...
  DNX_SAND_INIT_ERROR_DEFINITIONS(DNX_SAND_IP_ADDR_NUMERIC_TO_STRING);
  DNX_SAND_CHECK_NULL_INPUT(decimal_ip);
...
exit:
  DNX_SAND_EXIT_AND_SEND_ERROR("error in dnx_sand_ip_addr_numeric_to_string()",0,0);
}
  ...
  )
{
  ...
  DNX_SAND_INIT_ERROR_DEFINITIONS(DNX_SAND_IP_ADDR_STRING_TO_NUMERIC);
  DNX_SAND_CHECK_NULL_INPUT(decimal_ip);
...
exit:
  DNX_SAND_EXIT_AND_SEND_ERROR("error in dnx_sand_ip_addr_string_to_numeric()",0,0);
