/*
* $Id: dnx_fabric_cell.c,v 1.4 Broadcom SDK $
...
static
void clear_data_out_strcute (soc_dnxc_captured_control_cell_t* data_out)
{
...
int 
soc_dnx_cell_filter_set(int unit, uint32 array_size, soc_dnxc_filter_type_t* filter_type_arr, uint32* filter_type_val) 
{
    ...
    if (soc_feature(unit, soc_feature_no_fabric)) {
        DNXC_EXIT_WITH_ERR(SOC_E_UNAVAIL, (_BSL_DNXC_MSG("The device doesn't support FDR")));
    }
    ...
    rc = soc_jer2_arad_cell_filter_set(unit, array_size, filter_type_arr, filter_type_val);
    DNXC_IF_ERR_EXIT(rc);
...
int 
soc_dnx_cell_filter_clear(int unit)
{
    ...
    if (soc_feature(unit, soc_feature_no_fabric)) {
     ...
     rc = soc_jer2_arad_cell_filter_clear(unit);
    DNXC_IF_ERR_EXIT(rc);
...
int 
soc_dnx_cell_filter_receive(int unit, dnxc_captured_cell_t* data_out)
{
    ...
    rc = soc_jer2_arad_cell_filter_receive(unit, data_out);
    DNXC_IF_ERR_EXIT(rc);
...
/*
* Function:
*      soc_dnx_control_cell_filter_set
* Purpose:
...
int soc_dnx_control_cell_filter_set(int unit, soc_dnxc_control_cell_types_t cell_type, uint32 array_size, soc_dnxc_control_cell_filter_type_t* control_cell_filter_type_arr, uint32* filter_type_val) 
{
    ...
    rc = soc_jer2_arad_control_cell_filter_set(unit, cell_type, array_size, control_cell_filter_type_arr, filter_type_val);
    DNXC_IF_ERR_EXIT(rc);
...
/*
* Function:
*      soc_dnx_control_cell_filter_clear
* Purpose:
...
*/
int 
soc_dnx_control_cell_filter_clear(int unit)
{
   ...
   int rc;
    ...
    rc = soc_jer2_arad_control_cell_filter_clear(unit);
    DNXC_IF_ERR_EXIT(rc);
...
/*
* Function:
*      soc_dnx_control_cell_filter_receive
* Purpose:
...
int 
soc_dnx_control_cell_filter_receive(int unit, soc_dnxc_captured_control_cell_t* data_out)
{
    ...
    rc = soc_jer2_arad_control_cell_filter_receive(unit, data_out);
    DNXC_IF_ERR_EXIT(rc);
