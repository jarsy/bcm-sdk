...
/*
 * Function:
 *     _soc_jer2_jer_linkctrl_linkscan_hw_init
 * Purpose:
 ...
 */
static int
_soc_jer2_jer_linkctrl_linkscan_hw_init(int unit)
{
...
static int
_soc_jer2_jer_ports_phy_to_cmic_bitmap_map(int unit, pbmp_t hw_mii_pbm, soc_pbmp_t  *cmic_bitmap)
{
    soc_port_t port;
    ...
    PBMP_ITER(hw_mii_pbm, port)
    {
        ...
        {
            phy_port = SOC_DNX_FABRIC_PORT_TO_LINK(unit, port);
...
static int
_soc_jer2_jer_linkscan_ports_write(int unit, pbmp_t hw_mii_pbm)
{
    uint32      link_pbmp;
    pbmp_t cmic_bmp;
     
    DNXC_INIT_FUNC_DEFS;
    DNXC_IF_ERR_EXIT(_soc_jer2_jer_ports_phy_to_cmic_bitmap_map(unit, hw_mii_pbm, &cmic_bmp));
    ...
    DNXC_IF_ERR_EXIT(WRITE_CMIC_MIIM_SCAN_PORTS_5r(unit, link_pbmp));
...
/*
 * Function:
 *     _soc_jer2_jer_linkctrl_linkscan_pause
 * Purpose:
 ...
 */
static int
_soc_jer2_jer_linkctrl_linkscan_pause(int unit)
{
    int stall_count;
    pbmp_t pbm;
    uint32 schan_ctrl;
    ...
    SOC_PBMP_CLEAR(pbm);
    DNXC_IF_ERR_EXIT(_soc_jer2_jer_linkscan_ports_write(unit, pbm));
...
/*
 * Function:
 *     _soc_jer2_jer_linkctrl_linkscan_continue
 * Purpose:
 ...
 */
static int
_soc_jer2_jer_linkctrl_linkscan_continue(int unit)
{
    soc_control_t *soc = SOC_CONTROL(unit);
    uint32 schan_ctrl;
    DNXC_INIT_FUNC_DEFS;

    DNXC_IF_ERR_EXIT(_soc_jer2_jer_linkscan_ports_write(unit, soc->hw_linkscan_pbmp));
    DNXC_IF_ERR_EXIT(READ_CMIC_MIIM_SCAN_CTRLr(unit,&schan_ctrl));
...
/*
 * Function:
 *     _soc_jer2_jer_linkctrl_linkscan_config
 * Purpose:
 ...
 */
static int
_soc_jer2_jer_linkctrl_linkscan_config(int unit, pbmp_t hw_mii_pbm,
 ...
 */
static int
_soc_jer2_jer_linkctrl_update(int unit)
{
    DNXC_INIT_FUNC_DEFS;
...
static int
_soc_jer2_jer_linkctrl_hw_link_get(int unit, soc_pbmp_t *hw_link)
{
    DNXC_INIT_FUNC_DEFS;
...
/*
 * Link Control Driver - JER2_JERICHO
 */
CONST soc_linkctrl_driver_t  soc_linkctrl_driver_jer2_jer = {
    NULL,                                       /* port mapping */
    _soc_jer2_jer_linkctrl_linkscan_hw_init,      /* ld_linkscan_hw_init */
    _soc_jer2_jer_linkctrl_linkscan_config,       /* ld_linkscan_config */
    _soc_jer2_jer_linkctrl_linkscan_pause,        /* ld_linkscan_pause */
    _soc_jer2_jer_linkctrl_linkscan_continue,     /* ld_linkscan_continue */
    _soc_jer2_jer_linkctrl_update,                /* ld_update */
    _soc_jer2_jer_linkctrl_hw_link_get            /* ld_hw_link_get */
