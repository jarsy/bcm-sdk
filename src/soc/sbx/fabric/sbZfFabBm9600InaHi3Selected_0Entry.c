/*
 * $Id: sbZfFabBm9600InaHi3Selected_0Entry.c,v 1.2 Broadcom SDK $
...
sbZfFabBm9600InaHi3Selected_0Entry_Pack(sbZfFabBm9600InaHi3Selected_0Entry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_FAB_BM9600_INAHI3SELECTED_0ENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_FAB_BM9600_INAHI3SELECTED_0ENTRY_SIZE_IN_BYTES;
}
