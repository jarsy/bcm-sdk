/*
 * $Id: sbZfFabBm9600InaHi2Selected_1Entry.c,v 1.2 Broadcom SDK $
...
sbZfFabBm9600InaHi2Selected_1Entry_Pack(sbZfFabBm9600InaHi2Selected_1Entry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_FAB_BM9600_INAHI2SELECTED_1ENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_FAB_BM9600_INAHI2SELECTED_1ENTRY_SIZE_IN_BYTES;
}
