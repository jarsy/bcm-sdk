/*
 * $Id: sbZfFabBm9600NmEmtdebugbank0Entry.c,v 1.3 Broadcom SDK $
...
sbZfFabBm9600NmEmtdebugbank0Entry_Pack(sbZfFabBm9600NmEmtdebugbank0Entry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_FAB_BM9600_NMEMTDEBUGBANK0ENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_FAB_BM9600_NMEMTDEBUGBANK0ENTRY_SIZE_IN_BYTES;
}
