/*
 * $Id: sbZfFabBm9600NmEmt_1Entry.c,v 1.3 Broadcom SDK $
...
sbZfFabBm9600NmEmt_1Entry_Pack(sbZfFabBm9600NmEmt_1Entry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_FAB_BM9600_NMEMT_1ENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_FAB_BM9600_NMEMT_1ENTRY_SIZE_IN_BYTES;
}
