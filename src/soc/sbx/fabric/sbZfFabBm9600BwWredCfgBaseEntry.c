/*
 * $Id: sbZfFabBm9600BwWredCfgBaseEntry.c,v 1.2 Broadcom SDK $
...
sbZfFabBm9600BwWredCfgBaseEntry_Pack(sbZfFabBm9600BwWredCfgBaseEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_FAB_BM9600_BWWREDCFGBASEENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_FAB_BM9600_BWWREDCFGBASEENTRY_SIZE_IN_BYTES;
}
