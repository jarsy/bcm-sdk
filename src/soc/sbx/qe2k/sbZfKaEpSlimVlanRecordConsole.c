/*
 * $Id: sbZfKaEpSlimVlanRecordConsole.c,v 1.3 Broadcom SDK $
...
sbZfKaEpSlimVlanRecord_Print(sbZfKaEpSlimVlanRecord_t *pFromStruct) {
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: vid0=0x%03x"), (unsigned int)  pFromStruct->m_nVid0));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" vid1=0x%03x"), (unsigned int)  pFromStruct->m_nVid1));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META(" offset=0x%01x"), (unsigned int)  pFromStruct->m_nOffset));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: vlan_packet_counter=0x%08x"), (unsigned int)  pFromStruct->m_nVlanPacketCounter));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: vlan_byte_counter=0x%01x%08x"),   COMPILER_64_HI(pFromStruct->m_nnVlanByteCounter), COMPILER_64_LO(pFromStruct->m_nnVlanByteCounter)));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: drop_packet_counter=0x%08x"), (unsigned int)  pFromStruct->m_nDropPacketCounter));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));

  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: drop_byte_counter=0x%01x%08x"),   COMPILER_64_HI(pFromStruct->m_nnDropByteCounter), COMPILER_64_LO(pFromStruct->m_nnDropByteCounter)));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: port_state_1=0x%01x"), (unsigned int)  pFromStruct->m_nPortState_1));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: port_state_4=0x%01x"), (unsigned int)  pFromStruct->m_nPortState_4));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: port_state_7=0x%01x"), (unsigned int)  pFromStruct->m_nPortState_7));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: port_state_10=0x%01x"), (unsigned int)  pFromStruct->m_nPortState_10));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: port_state_13=0x%01x"), (unsigned int)  pFromStruct->m_nPortState_13));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: port_state_16=0x%01x"), (unsigned int)  pFromStruct->m_nPortState_16));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: port_state_19=0x%01x"), (unsigned int)  pFromStruct->m_nPortState_19));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: port_state_22=0x%01x"), (unsigned int)  pFromStruct->m_nPortState_22));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: port_state_25=0x%01x"), (unsigned int)  pFromStruct->m_nPortState_25));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: port_state_28=0x%01x"), (unsigned int)  pFromStruct->m_nPortState_28));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: port_state_31=0x%01x"), (unsigned int)  pFromStruct->m_nPortState_31));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: port_state_34=0x%01x"), (unsigned int)  pFromStruct->m_nPortState_34));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: port_state_37=0x%01x"), (unsigned int)  pFromStruct->m_nPortState_37));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: port_state_40=0x%01x"), (unsigned int)  pFromStruct->m_nPortState_40));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: port_state_43=0x%01x"), (unsigned int)  pFromStruct->m_nPortState_43));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: port_state_46=0x%01x"), (unsigned int)  pFromStruct->m_nPortState_46));
  LOG_WARN(BSL_LS_SOC_COMMON,
  ...
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("KaEpSlimVlanRecord:: port_state_49=0x%01x"), (unsigned int)  pFromStruct->m_nPortState_49));
  LOG_WARN(BSL_LS_SOC_COMMON,
           (BSL_META("\n")));
...
sbZfKaEpSlimVlanRecord_SPrint(sbZfKaEpSlimVlanRecord_t *pFromStruct, char *pcToString, uint32 lStrSize) {
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"KaEpSlimVlanRecord:: vlan_byte_counter=0x%01x%08x",   COMPILER_64_HI(pFromStruct->m_nnVlanByteCounter), COMPILER_64_LO(pFromStruct->m_nnVlanByteCounter));
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"\n");
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"KaEpSlimVlanRecord:: drop_byte_counter=0x%01x%08x",   COMPILER_64_HI(pFromStruct->m_nnDropByteCounter), COMPILER_64_LO(pFromStruct->m_nnDropByteCounter));
...
sbZfKaEpSlimVlanRecord_Validate(sbZfKaEpSlimVlanRecord_t *pZf) {
  uint64 nnByteCounterMax = COMPILER_64_INIT(0x7, 0xFFFFFFFF);
  ...
  if (COMPILER_64_GT(pZf->m_nnVlanByteCounter, nnByteCounterMax)) return 0;
  if (pZf->m_nDropPacketCounter > 0x1fffffff) return 0;
  if (COMPILER_64_GT(pZf->m_nnDropByteCounter, nnByteCounterMax)) return 0;
