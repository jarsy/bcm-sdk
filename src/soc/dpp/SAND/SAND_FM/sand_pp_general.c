...
/******************************************************************
*
* FILENAME:       DuneDriver/soc_sand/src/soc_sand_pp_general.c
*
* MODULE PREFIX:  soc_sand_pp
*
* FILE DESCRIPTION:
*
* REMARKS:
  ...
  )
{
  ...
  if(info->dest_type == SOC_SAND_PP_DEST_TRAP) { /* tap in hex as has encoding in val */
      LOG_CLI((BSL_META_U(unit,
