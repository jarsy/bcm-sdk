...
#define ARAD_PP_ESEM_KEY_LIF_VSI_VSI_NOF_BITS                  SOC_SAND_RNG_COUNT(ARAD_PP_ESEM_KEY_LIF_VSI_VSI_LSB(unit), ARAD_PP_ESEM_KEY_LIF_VSI_VSI_MSB(unit))
  ...
  )
{
  ...
  case ARAD_PP_ESEM_KEY_TYPE_LIF_VSI:
      ...
      res = soc_sand_bitstream_set_any_field(&esem_key->key_info.lif_vsi.vsi, ARAD_PP_ESEM_KEY_LIF_VSI_VSI_LSB(unit), ARAD_PP_ESEM_KEY_LIF_VSI_VSI_MSB(unit), buffer);
