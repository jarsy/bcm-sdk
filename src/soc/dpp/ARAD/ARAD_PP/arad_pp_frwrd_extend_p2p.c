...

{
    ...
    rv = arad_pp_fwd_decision_in_buffer_parse(unit, payload.dest, payload.asd, ARAD_PP_FWD_DECISION_PARSE_DEST|ARAD_PP_FWD_DECISION_PARSE_OUTLIF/*flags*/, frwrd_info);
    SOCDNX_SAND_IF_ERR_EXIT(rv);
