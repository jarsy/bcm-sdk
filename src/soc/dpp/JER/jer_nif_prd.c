...
STATIC int
soc_jer_plus_prd_control_plane_ilkn_set_get(int unit, int port, soc_jer_nif_prd_control_plane_t *control_frame_conf, int to_set)
{
    uint32 offset, num_lanes;
    soc_reg_above_64_val_t reg_above64_val;
    soc_reg_t reg;
...
STATIC int
soc_jer_plus_prd_control_plane_qmlf_set_get(int unit, int port, soc_jer_nif_prd_control_plane_t *control_frame_conf, int to_set)
{
    int first_phy=-1, reg_port, first_phy_index_in_qmlf, first_field_index_in_arr;
    ...
    SOCDNX_IF_ERR_EXIT(soc_reg_above_64_get(unit, regs[qmlf_index], reg_port, first_phy_index_in_qmlf, reg_above64_val));
    if (to_set)
    {
        ...
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_set(unit, regs[qmlf_index], reg_port, first_phy_index_in_qmlf, reg_above64_val));
    }
    else
    {
...
int soc_jer_plus_prd_control_plane_set(int unit, int port, soc_jer_nif_prd_control_plane_t *control_frame_conf)
{
    ...
    if (IS_IL_PORT(unit, port))
    {
        SOCDNX_IF_ERR_EXIT(soc_jer_plus_prd_control_plane_ilkn_set_get(unit, port, control_frame_conf, 1));
    }
    else
    {
        SOCDNX_IF_ERR_EXIT(soc_jer_plus_prd_control_plane_qmlf_set_get(unit, port, control_frame_conf, 1));
    }
...
int soc_jer_plus_prd_control_plane_get(int unit, int port, soc_jer_nif_prd_control_plane_t *control_frame_conf)
{
    ...
    if (IS_IL_PORT(unit, port))
    {
        SOCDNX_IF_ERR_EXIT(soc_jer_plus_prd_control_plane_ilkn_set_get(unit, port, control_frame_conf, 0));
    }
    else
    {
        SOCDNX_IF_ERR_EXIT(soc_jer_plus_prd_control_plane_qmlf_set_get(unit, port, control_frame_conf, 0));
    }
