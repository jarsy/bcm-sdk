  ...
  )
{
     ...
     */
    soc_sand_u64_multiply_longs(tbl_data->c2, (wred_param->max_avrg_th - wred_param->min_avrg_th), &u64_1);
       ...
       )
{
    ...
    if (enable) {
        ...
        if (SOC_PORT_IF_ILKN == interface_type) {
            ...
            if (interface_type == SOC_PORT_IF_RCY || interface_type == SOC_PORT_IF_CPU) {
                non_phy_port = 1; 
            } else {
