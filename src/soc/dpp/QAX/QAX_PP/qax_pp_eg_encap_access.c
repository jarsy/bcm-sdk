    ...
    ARAD_PP_EG_ENCAP_ACCESS_OUT_RIF_ENTRY_FORMAT  *tbl_data)
{
    ...
    SOCDNX_SAND_IF_ERR_EXIT(_bcm_dpp_am_template_out_rif_profile_exchange(unit, /*BCM_DPP_AM_TEMPLATE_FLAG_CHECK*/0, tbl_data->outrif_profile_index,&new_profile,&is_last,&new_profile_index,&is_first));
    if(is_last){
