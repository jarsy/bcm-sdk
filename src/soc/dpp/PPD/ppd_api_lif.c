/* $Id: arad_pp_api_lif.c,v 1.15 Broadcom SDK $
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_ppd_l2_lif_isid_remove()", /*vsi_ndx*/0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_ppd_l2_lif_gre_remove()", /*vsi_ndx*/0, 0);
}
...
exit_semaphore:
  ...
  ARAD_PP_DO_NOTHING_AND_EXIT;
exit:
  SOC_SAND_EXIT_AND_SEND_ERROR("error in soc_ppd_l2_lif_vxlan_remove()", /*vsi_ndx*/0, 0);
}

/*********************************************************************
 *     Enable a Port Extender, and set the Port Extender attributes.
 *     Bind the port-extender-key to the LIF, and set the LIF attributes
 *     Details: in the H file. (search for prototype)
*********************************************************************/
...
/*********************************************************************
 *   Get the action info (forwarding/snooping) to assign
 *   for packets upon failure lookup in the MACT (MACT
 *   default forwarding).
 *     Details: in the H file. (search for prototype)
*********************************************************************/
