...
CONST mbcm_pp_functions_t mbcm_pp_jericho_plus_driver = {
	/**********************************************/
...
soc_jer_pp_oam_oamp_lb_tst_header_set,
	NULL,/*soc_qax_pp_oam_oamp_lm_dm_delete,*/
	NULL,/*soc_qax_pp_oam_oamp_lm_dm_pointed_shared_find,*/
	NULL, /*soc_qax_pp_oam_oamp_lm_dm_set,*/
