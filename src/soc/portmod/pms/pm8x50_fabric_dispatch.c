...
__portmod__dispatch__t__ portmod_pm8x50_fabric_driver = {
    ...
    pm8x50_fabric_ext_phy_lane_attach_to_pm,
    pm8x50_fabric_ext_phy_lane_detach_from_pm,
    ...
    pm8x50_fabric_port_lane_map_set,
    pm8x50_fabric_port_lane_map_get,
    ...
    pm8x50_fabric_slow_read_rate_set,
