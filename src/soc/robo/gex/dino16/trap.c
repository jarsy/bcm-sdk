 ...
 */
int 
drv_dino16_trap_set(int unit, soc_pbmp_t bmp, uint32 trap_mask)
{
 ...
 */
int 
drv_dino16_trap_get(int unit, soc_port_t port, uint32 *trap_mask)
{
 ...
 */
int 
drv_dino16_snoop_set(int unit, uint32 snoop_mask)
{
    uint32  reg_value, temp;
 ...
 */
int 
drv_dino16_snoop_get(int unit, uint32 *snoop_mask)
{
    uint32  reg_value, temp = 0;
...
/*
 *  Function : drv_dino16_igmp_mld_snoop_mode_get
 *
 *  Purpose :
 ...
 */
int 
drv_dino16_igmp_mld_snoop_mode_get(int unit, int type, int *mode)
{
...
/*
 *  Function : drv_dino16_igmp_mld_snoop_mode_set
 *
 *  Purpose :
 ...
 */
int 
drv_dino16_igmp_mld_snoop_mode_set(int unit, int type, int mode)
{
    uint32  reg_val = 0, temp = 0;
    ...
    /* bcm5396 support trap mode only */
