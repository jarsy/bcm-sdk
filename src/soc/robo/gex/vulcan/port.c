...
/*
 *  Function : drv_vulcan_port_pri_mapop_set
 *
 *  Purpose :
 ...
 */
int 
drv_vulcan_port_pri_mapop_set(int unit, int port, int op_type, 
...
/*
 *  Function : drv_vulcan_port_pri_mapop_get
 *
 *  Purpose :
 ...
 */
int 
drv_vulcan_port_pri_mapop_get(int unit, int port, int op_type, 
                uint32 pri_old, uint32 cfi_old, uint32 *pri_new, uint32 *cfi_new)
{
    uint32  temp;
    uint64  reg_value64;
