/*
 * $Id: tomahawk2_efp.c Broadcom SDK $
 * $Copyright: (c) 2016 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 *
 * File:    tomahawk2_efp.c
...
/* "efp" feature's diag command list valid only for tomahawk2 */
char * techsupport_efp_tomahawk2_diag_cmdlist[] = {
     NULL /* Must be the last element in this structure */
};

#ifndef BCM_SW_STATE_DUMP_DISABLE
/* "efp" feature's software dump command list valid only for tomahawk2 */
char * techsupport_efp_tomahawk2_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
 ...
 * "efp" feature for tomahawk2 chipset. */
static soc_mem_t techsupport_efp_tomahawk2_memory_table_list[] = {
    PORT_TABm,
 ...
 * "efp" feature for tomahawk2 chipset. */
techsupport_reg_t techsupport_efp_tomahawk2_reg_list[] = {
 ...
 * "efp" feature for tomahawk2 chipset. */
techsupport_data_t techsupport_efp_tomahawk2_data = {
    techsupport_efp_diag_cmdlist,
    techsupport_efp_tomahawk2_reg_list,
    techsupport_efp_tomahawk2_memory_table_list,
    techsupport_efp_tomahawk2_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_efp_sw_dump_cmdlist,
    techsupport_efp_tomahawk2_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
};
