...
/* "l3uc" feature's diag command list valid only for Trident2plus */
char * techsupport_l3uc_trident2plus_diag_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};

#ifndef BCM_SW_STATE_DUMP_DISABLE
/* "l3uc" feature's software dump command list valid only for Trident2plus */
char * techsupport_l3uc_trident2plus_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
...
techsupport_data_t techsupport_l3uc_trident2plus_data = {
    ...
    techsupport_l3uc_trident2plus_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_l3uc_sw_dump_cmdlist,
    techsupport_l3uc_trident2plus_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
};
