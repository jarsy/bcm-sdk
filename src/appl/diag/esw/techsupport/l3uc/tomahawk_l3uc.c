...
techsupport_reg_t techsupport_l3uc_tomahawk_reg_list[] = {
   ...
   {IL2L3_BUS_SER_CONTROLr, register_type_global },
   ...
   {L3_ENTRY_CONTROL_0r, register_type_global },
   {L3_ENTRY_CONTROL_1r, register_type_global },
   {L3_ENTRY_CONTROL_2r, register_type_global },
   {L3_ENTRY_CONTROL_3r, register_type_global },
   {L3_ENTRY_CONTROL_4r, register_type_global },
   {L3_ENTRY_CONTROL_5r, register_type_global },
   {L3_ENTRY_CONTROL_6r, register_type_global },
   {L3_ENTRY_CONTROL_7r, register_type_global },
   {L3_ENTRY_CONTROL_8r, register_type_global },
   {L3_ENTRY_CONTROL_9r, register_type_global },
   {L3_ENTRY_CONTROL_10r, register_type_global },
   {L3_ENTRY_PARITY_CONTROLr, register_type_global },
   {L3_IIF_PARITY_CONTROLr, register_type_global },
   {L3_TABLE_HASH_CONTROLr, register_type_global },
   {L3_TUNNEL_CAM_DBGCTRLr, register_type_global },
