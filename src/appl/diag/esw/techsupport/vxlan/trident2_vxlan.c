/*
 * $Id: trident2_vxlan.c Broadcom SDK $
 * $Copyright: (c) 2016 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 *
 * File:    trident2_vxlan.c
...
/* "vxlan" feature's diag command list only for Trident2 */
char * techsupport_vxlan_trident2_diag_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};

#ifndef BCM_SW_STATE_DUMP_DISABLE
/* "VXLAN" feature's software dump command list only for Trident2 */
char * techsupport_vxlan_trident2_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
 ...
 * "vxlan" feature for Trident2 chipset. */
static soc_mem_t techsupport_vxlan_trident2_memory_table_list[] = {
 ...
 * "vxlan" feature for Trident2 chipset. */
techsupport_reg_t techsupport_vxlan_trident2_reg_list[] = {
 ...
 * "vxlan" feature for Trident2 chipset. */
techsupport_data_t techsupport_vxlan_trident2_data = {
    techsupport_vxlan_diag_cmdlist,
    techsupport_vxlan_trident2_reg_list,
    techsupport_vxlan_trident2_memory_table_list,
    techsupport_vxlan_trident2_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_vxlan_sw_dump_cmdlist,
    techsupport_vxlan_trident2_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
};
