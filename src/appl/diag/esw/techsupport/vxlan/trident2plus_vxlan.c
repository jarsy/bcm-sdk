...
/* "vxlan" feature's diag command list only for Trident2plus */
char * techsupport_vxlan_trident2plus_diag_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};

#ifndef BCM_SW_STATE_DUMP_DISABLE
/* "VXLAN" feature's software dump command list only for Trident2plus */
char * techsupport_vxlan_trident2plus_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
...
techsupport_data_t techsupport_vxlan_trident2plus_data = {
    ...
    techsupport_vxlan_trident2plus_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_vxlan_sw_dump_cmdlist,
    techsupport_vxlan_trident2plus_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
};
