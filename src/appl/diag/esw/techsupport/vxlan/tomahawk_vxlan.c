/*
 * $Id: tomahawk_vxlan.c Broadcom SDK $
 * $Copyright: (c) 2016 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 *
 * File:    tomahawk_vxlan.c
...
char * techsupport_vxlan_tomahawk_diag_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};

#ifndef BCM_SW_STATE_DUMP_DISABLE
/* "VXLAN" feature's software dump command list only for Tomahawk */
char * techsupport_vxlan_tomahawk_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
 ...
 * "vxlan" feature for tomahawk chipset. */
static soc_mem_t techsupport_vxlan_tomahawk_memory_table_list[] = {
 ...
 * "vxlan" feature for tomahawk chipset. */
techsupport_reg_t techsupport_vxlan_tomahawk_reg_list[] = {
...
techsupport_data_t techsupport_vxlan_tomahawk_data = {
    techsupport_vxlan_diag_cmdlist,
    techsupport_vxlan_tomahawk_reg_list,
    techsupport_vxlan_tomahawk_memory_table_list,
    techsupport_vxlan_tomahawk_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_vxlan_sw_dump_cmdlist,
    techsupport_vxlan_tomahawk_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
