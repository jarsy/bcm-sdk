/*
 * $Id: trident2_mpls.c Broadcom SDK $
 * $Copyright: (c) 2016 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 *
 * File:    trident2_mpls.c
...
/* "mpls" feature's diag command list valid only for Trident2 */
char * techsupport_mpls_trident2_diag_cmdlist[] = {
     NULL /* Must be the last element in this structure */
};

#ifndef BCM_SW_STATE_DUMP_DISABLE
/* "MPLS" feature's software dump command list valid  only for Trident2 */
char * techsupport_mpls_trident2_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
 ...
 * "mpls" feature for Trident2 chipset. */
static soc_mem_t techsupport_mpls_trident2_memory_table_list[] = {
 ...
 * "mpls" feature for Trident2 chipset. */
techsupport_reg_t techsupport_mpls_trident2_reg_list[] = {
 ...
 * "mpls" feature for Trident2 chipset. */
techsupport_data_t techsupport_mpls_trident2_data = {
    techsupport_mpls_diag_cmdlist,
    techsupport_mpls_trident2_reg_list,
    techsupport_mpls_trident2_memory_table_list,
    techsupport_mpls_trident2_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_mpls_sw_dump_cmdlist,
    techsupport_mpls_trident2_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
};
