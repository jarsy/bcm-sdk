/*
 * $Id: trident2_l3mc.c Broadcom SDK $
 * $Copyright: (c) 2016 Broadcom.
 * Broadcom Proprietary and Confidential. All rights reserved.$
 *
 * File:    trident2_l3mc.c
...
/* "l3mc" feature's diag command list valid only for Trident2 */
char * techsupport_l3mc_trident2_diag_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};

#ifndef BCM_SW_STATE_DUMP_DISABLE
/* "L3MC" feature's software dump command list valid only for Trident2 */
char * techsupport_l3mc_trident2_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
 ...
 * "l3mc" feature for Trident2 chipset. */
static soc_mem_t techsupport_l3mc_trident2_memory_table_list[] = {
 ...
 * "l3mc" feature for Trident2 chipset. */
techsupport_reg_t techsupport_l3mc_trident2_reg_list[] = {
 ...
 * "l3mc" feature for Trident2 chipset. */
techsupport_data_t techsupport_l3mc_trident2_data = {
    techsupport_l3mc_diag_cmdlist,
    techsupport_l3mc_trident2_reg_list,
    techsupport_l3mc_trident2_memory_table_list,
    techsupport_l3mc_trident2_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_l3mc_sw_dump_cmdlist,
    techsupport_l3mc_trident2_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
};
