...
#define MAX_VS_CONFIG_PER_BOARD 9
    ...
    if (board_name != NULL) {
        if (sal_strcmp(board_name, "BCM953406K") == 0) {
            ...
            cli_out("board_name = %s, supported board names are BCM953406K, "
                    "BCM953411K, BCM953416K and BCM56160D.\n"
...
dac_params[NUM_BOARD_TYPES][MAX_VS_CONFIG_PER_BOARD] = {
    ...
    {{0,"Analog",-1,1,0,0,LTC2974_1V_DACVAL,LTC2974_0_6V_DACVAL,LTC2974_0_8V_DACVAL,1},
     {1,"1.2V",-1,1,0,0,LTC2974_1_35V_DACVAL,LTC2974_0_6V_DACVAL,LTC2974_1_2V_DACVAL,1},
     {2,"1.8V",-1,1,0,0,LTC2974_1_95V_DACVAL,LTC2974_0_6V_DACVAL,LTC2974_1_8V_DACVAL,1},
     {3,"3.3V",-1,1,0,0,LTC2974_3_4V_DACVAL,LTC2974_0_6V_DACVAL,LTC2974_3_3V_DACVAL,1},
    },
...
bb_vs_config[NUM_BOARD_TYPES][MAX_VS_CONFIG_PER_BOARD] = {
    ...
    /* Tomahawk2 design: aka G57 */
    {{0,"Analog",1 << MUX_3, I2C_LTC2974_5C, I2C_LTC2974_CH0, I2C_LTC2974_0, PWR_DAC_IO_SRC },
     {1,"1.8",   1 << MUX_3, I2C_LTC2974_5C, I2C_LTC2974_CH1, I2C_LTC2974_0, PWR_DAC_IO_SRC },
     {2,"1.8",   1 << MUX_3, I2C_LTC2974_5C, I2C_LTC2974_CH2, I2C_LTC2974_0, PWR_DAC_IO_SRC },
     {3,"3.3",   1 << MUX_3, I2C_LTC2974_5C, I2C_LTC2974_CH3, I2C_LTC2974_0, PWR_DAC_IO_SRC },
...
bb_vs_all[NUM_BOARD_TYPES][MAX_VOLTAGES_PER_BOARD] = {
    ...
    /* Tomahawk2 design: aka G57 */
    {{0,"Analog",1 << MUX_3, I2C_LTC2974_5C, I2C_LTC2974_CH0, I2C_LTC2974_0, PWR_DAC_IO_SRC },
     {1,"1.2",   1 << MUX_3, I2C_LTC2974_5C, I2C_LTC2974_CH1, I2C_LTC2974_0, PWR_DAC_IO_SRC },
     {2,"1.8",   1 << MUX_3, I2C_LTC2974_5C, I2C_LTC2974_CH2, I2C_LTC2974_0, PWR_DAC_IO_SRC },
     {3,"3.3",   1 << MUX_3, I2C_LTC2974_5C, I2C_LTC2974_CH3, I2C_LTC2974_0, PWR_DAC_IO_SRC },
     {4,"Core",  1 << MUX_3, I2C_NCP81233_0, I2C_LTC2974_CH0, I2C_LTC2974_0, PWR_DAC_IO_PMBUS },
    },
    ...
    if( value ) {
        ...
        if ( (show_cal = !sal_strcasecmp(value,"calibrate")) ||
            ...
            if (cpu_mode) {
                ...
                if ( (cpu_i2c_dev_ioctl(bus, dac, I2C_DAC_IOC_SETDAC_MAX,
                                &volts, bb_vs_config[bx][i].chan) < 0)) {
            ...
            } else
            {
                ...
                if ( (bcm_i2c_ioctl(unit, dac, I2C_DAC_IOC_SETDAC_MAX,
                                &volts, bb_vs_config[bx][i].chan) < 0)) {
                    cli_out("Error: failed to set max DAC Vout.\n");
                }
...
cmd_bb(int unit, args_t *a)
{
    ...
    double dac_op_data=0, current=0, power=0, time_ms;
#else
    int volts, clockval, curr_zero = 1, curr_sens;
    int dac_op_data=0, current=0, power=0, time_ms;
#endif
    int show_cal = 0;
    i2c_adc_t  adc_data;
