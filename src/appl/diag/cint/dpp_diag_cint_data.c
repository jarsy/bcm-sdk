/*
 * $Id: dpp_diag_cint_data.c,v 1.47 Broadcom SDK $
 *
...
ser_mem_write_cb(int unit, soc_mem_t mem, void* data)
{
  ...
  SOC_MEM_BLOCK_ITER(unit, mem, blk) {   
       ...
       ret = dcmn_fill_table_with_entry(unit, mem, blk, patterns);
  }
  return ret;
}
...
cint_data_t dpp_diag_cint_data =
{
    NULL,
...
#else
int _dpp_diag_cint_data_not_empty;
