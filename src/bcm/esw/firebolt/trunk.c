    ...
    if (SOC_IS_GREYHOUND2(unit)) {
        ...
        for (hgtid = 0; hgtid < num_hg_trunk_groups; hgtid++) {
            ...
            hg_trunk_bmap_f = soc_reg64_field_get(unit,
                HG_TRUNK_BITMAP_LOr, val64, HIGIG_TRUNK_BITMAPf);
            ...
            hg_trunk_bmap_f = soc_reg64_field_get(unit,
                HG_TRUNK_BITMAP_HIr, val64, HIGIG_TRUNK_BITMAPf);
                           ...
                           trunk_private_t *t_info)
{
    ...
    if (SOC_IS_HBX(unit) || SOC_IS_TRX(unit)) {
        ...
        if (SOC_IS_GREYHOUND2(unit)) {
            ...
            hg_trunk_bmap_f =
                soc_reg64_field_get(unit, HG_TRUNK_BITMAP_LOr, val64, HIGIG_TRUNK_BITMAPf);
                SOC_PBMP_CLEAR(hg_pbm);
            ...
            hg_trunk_bmap_f =
                soc_reg64_field_get(unit, HG_TRUNK_BITMAP_HIr, val64, HIGIG_TRUNK_BITMAPf);
                               ...
                               trunk_private_t *t_info)
{
    ...
    if (SOC_IS_GREYHOUND2(unit)) {
        ...
        SOC_PBMP_CLEAR(new_trunk_pbmp);
        BCM_IF_ERROR_RETURN(
            _bcm_xgs3_trunk_fabric_port_set(unit, hgtid, old_trunk_pbmp, new_trunk_pbmp));
       ...
       if (soc_feature(unit, soc_feature_hg_trunk_failover)) {
        ...
        BCM_IF_ERROR_RETURN
            (_bcm_xgs3_trunk_swfailover_fabric_set(unit, hgtid, 0, new_trunk_pbmp));
