...
mbcm_functions_t mbcm_apache_driver = {
    /*  L2 functions */
    bcm_td2_l2_init,
    bcm_tr_l2_term,
    bcm_tr_l2_addr_get,
    ...
    bcm_ap_cosq_port_bandwidth_set,
    bcm_ap_cosq_port_bandwidth_get,
    bcm_ap_cosq_discard_set,
    bcm_ap_cosq_discard_get,
...
int bcm_esw_apache_mbcm_not_empty;
