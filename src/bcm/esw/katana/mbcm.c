...
mbcm_functions_t mbcm_katana_driver = {
    /*  L2 functions */
    bcm_tr_l2_init,
    bcm_tr_l2_term,
    bcm_tr_l2_addr_get,
    ...
    bcm_kt_cosq_port_bandwidth_set,
    bcm_kt_cosq_port_bandwidth_get,
...
int bcm_esw_katana_mbcm_not_empty;
