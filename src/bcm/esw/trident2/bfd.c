...
bcmi_td2_bfd_init(int unit)
{
    ...
    if (bfd_feature_enable & BFD_MHOP_FEATURE_ENABLE) {
         ...
         bcm_td2_bfd_hw_defs.bfd_feature_enable = BFD_MHOP_FEATURE_ENABLE;
        ...
        /* Set UDP Dest port for Micro BFD session */
          ...
          bcm_td2_bfd_hw_defs.bfd_feature_enable = BFD_MICRO_FEATURE_ENABLE;
          ...
          bcm_td2_bfd_hw_defs.bfd_feature_enable = BFD_ECHO_FEATURE_ENABLE;
    }
#if defined(BCM_APACHE_SUPPORT)
    }
#endif
