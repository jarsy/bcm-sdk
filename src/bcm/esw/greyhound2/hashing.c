 ...
 *  tgid - trunk port id
 *  hash_index - hash value calculated from compute_gh2_rtag7_hash_trunk
 *  hash_rh_index -  hash value calculated from compute_gh2_rtag7_hash_rh_trunk
 ...
 */
STATIC int
get_gh2_hash_trunk(int unit, int tgid, uint32 hash_index, bcm_gport_t *dst_gport)
{
    ...
    trunk_index = hash_index % (trunk_group_size);
...
STATIC int
get_gh2_hash_hg_trunk(int unit, int hgtid, uint32 hash_index, bcm_gport_t *dst_gport)
{
