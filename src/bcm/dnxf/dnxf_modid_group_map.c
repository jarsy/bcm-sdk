...
int bcm_dnxf_modid_group_map_clear(int unit)
{
    ...
    {
        rv = SOC_DNXF_WARM_BOOT_ARR_VAR_SET(unit, MODID_GROUP_MAP, i, &group_map);
    ...
    {
        rv = SOC_DNXF_WARM_BOOT_ARR_VAR_SET(unit, MODID_MODID_TO_GROUP_MAP, i, &modid_to_group_id);
        BCMDNX_IF_ERR_EXIT(rv);
    }
...
int bcm_dnxf_modid_group_map_clear_group(int unit, bcm_module_t group)
{
    ...
    sal_memset(group_map.raw,0,SOC_DNXF_MODID_NOF_UINT32_SIZE * sizeof(uint32));
    rv = SOC_DNXF_WARM_BOOT_ARR_VAR_SET(unit, MODID_GROUP_MAP, group, &group_map);
    BCMDNX_IF_ERR_EXIT(rv);

    for(i=0 ; i < SOC_DNXF_MODID_NOF ; i++)
    {
        rv = SOC_DNXF_WARM_BOOT_ARR_VAR_GET(unit, MODID_MODID_TO_GROUP_MAP, i, &modid_to_group_id);
        BCMDNX_IF_ERR_EXIT(rv);
...
{  
    ...
    rv = SOC_DNXF_WARM_BOOT_ARR_VAR_GET(unit, MODID_GROUP_MAP, group, &group_map);
    BCMDNX_IF_ERR_EXIT(rv);
    ...
    rv = SOC_DNXF_WARM_BOOT_ARR_VAR_SET(unit, MODID_MODID_TO_GROUP_MAP, module, &modid_to_group_id);
    BCMDNX_IF_ERR_EXIT(rv);
...
int bcm_dnxf_modid_group_map_get_group(int unit, bcm_module_t module, bcm_module_t* group)
{
    ...
    rv = SOC_DNXF_WARM_BOOT_ARR_VAR_GET(unit, MODID_MODID_TO_GROUP_MAP, module, group);
    BCMDNX_IF_ERR_EXIT(rv);
