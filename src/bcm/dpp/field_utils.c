                                       ...
                                       uint32 *ppdMask)
{
    ...
    *ppdMask = 0x3F;
    ...
    case bcmFieldHeaderFormatMplsLabel1AnyL2L3:
        *hdr_stk_type = DPP_PFC_MPLS1_ETH;
    ...
    case bcmFieldHeaderFormatMplsLabel2AnyL2L3:
        *hdr_stk_type = DPP_PFC_MPLS2_ETH;
    ...
    case bcmFieldHeaderFormatMplsLabel3AnyL2L3:
        *hdr_stk_type = DPP_PFC_MPLS3_ETH;
        if (header_format == bcmFieldHeaderFormatMplsLabel3AnyL2L3) {
            *ppdMask = 0x7; /* Match on all the MPLS2 packets */
        }
        break;
    case bcmFieldHeaderFormatMplsAnyLabelAnyL2L3:
         *hdr_stk_type = DPP_PFC_MPLS1_ETH; /*Due to mask it doesnt really matter which SOC_TMC to choose*/
         *ppdMask = 0x4;/* Match on all the MPLS Labels packets */
        break;
    case bcmFieldHeaderFormatEthEth:
        *hdr_stk_type = DPP_PFC_ETH_ETH;
        break;
    case bcmFieldHeaderFormatTrill:
    case bcmFieldHeaderFormatEthTrillEth:
        *hdr_stk_type = DPP_PFC_ETH_TRILL_ETH;
        break;
    case bcmFieldHeaderFormatIp4Ip4:
        *hdr_stk_type = DPP_PFC_IPV4_IPV4_ETH;
        break;
    case bcmFieldHeaderFormatIp6Ip4:
        *hdr_stk_type = DPP_PFC_IPV6_IPV4_ETH;
        break;
    case bcmFieldHeaderFormatIp4MplsLabel1:
        *hdr_stk_type = DPP_PFC_IPV4_MPLS1_ETH;
        break;
    case bcmFieldHeaderFormatIp4MplsLabel2:
        *hdr_stk_type = DPP_PFC_IPV4_MPLS2_ETH;
        break;
    case bcmFieldHeaderFormatIp4MplsLabel3:
        *hdr_stk_type = DPP_PFC_IPV4_MPLS3_ETH;
        break;
    case bcmFieldHeaderFormatIp6MplsLabel1:
        *hdr_stk_type = DPP_PFC_IPV6_MPLS1_ETH;
        break;
    case bcmFieldHeaderFormatIp6MplsLabel2:
        *hdr_stk_type = DPP_PFC_IPV6_MPLS2_ETH;
        break;
    case bcmFieldHeaderFormatIp6MplsLabel3:
        *hdr_stk_type = DPP_PFC_IPV6_MPLS3_ETH;
        break;
    case bcmFieldHeaderFormatEthMplsLabel1:
        *hdr_stk_type = DPP_PFC_ETH_MPLS1_ETH;
        break;
    case bcmFieldHeaderFormatEthMplsLabel2:
        *hdr_stk_type = DPP_PFC_ETH_MPLS2_ETH;
        break;
    case bcmFieldHeaderFormatEthMplsLabel3:
        *hdr_stk_type = DPP_PFC_ETH_MPLS3_ETH;
        break;
    case bcmFieldHeaderFormatEthIp4Eth:
        *hdr_stk_type = DPP_PFC_ETH_IPV4_ETH;
        break;
    case bcmFieldHeaderFormatFCoE:
        *hdr_stk_type = DPP_PFC_FC_ENCAP_ETH;
        break;
    default:
...
int
_bcm_dpp_field_HeaderFormat_ppd_to_bcm(DPP_PFC_E hdr_stk_type,
                                       uint32 ppdMask,
       ...
       default:
        ...
        case DPP_PFC_ETH_IPV4_ETH:
            *header_format = bcmFieldHeaderFormatEthIp4Eth;
            break;
        case DPP_PFC_FC_ENCAP_ETH:
            *header_format = bcmFieldHeaderFormatFCoE;
            break;
        default:
        case DPP_PFC_FC_STD_ETH:
            /*FIX: add bcm type */
            BCMDNX_ERR_EXIT_MSG(BCM_E_INTERNAL,
                             (_BSL_BCM_MSG_NO_UNIT("unexpected PPD header format %d"),
                              hdr_stk_type));
