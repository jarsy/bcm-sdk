                                        ...
                                        _bcm_dpp_field_tc_b_act_t *propActs)
{
    ...
    _bcm_dpp_field_tc_p_act_t hwAct[SOC_PPC_FP_NOF_ACTIONS_PER_DB_MAX +
        ...
        if (SOC_PPC_FP_DATABASE_STAGE_INGRESS_PMF ==
            ...
            case bcmFieldActionRedirect:  
                ...
                if (BCM_GPORT_IS_SET(propActs[bcmIndex].bcmParam1)) {
                    ...
                    BCMDNX_IF_ERR_EXIT(MBCM_DPP_DRIVER_CALL(unit, mbcm_dpp_local_to_tm_port_get, (unit, propActs[bcmIndex].bcmParam1, &tm_port, &core)));
...
/* coverity[uninit_use_in_call] */
            ...
            case bcmFieldActionForwardingTypeNew:
                ...
                if(SOC_IS_JERICHO(unit)) {
                    ...
                    local_offset = (propActs[bcmIndex].bcmParam2)? propActs[bcmIndex].bcmParam2: 0;
            ...
            case bcmFieldActionSnoopAndTrap:
                ...
                /* param1 = Double Action Mode */
                if (propActs[bcmIndex].bcmParam1 == 0) {
                    /* Snoop */
                    if (BCM_GPORT_IS_SET(propActs[bcmIndex].bcmParam0) &&
                        BCM_GPORT_IS_TRAP(propActs[bcmIndex].bcmParam0)) {
                        SOC_PPC_TRAP_CODE ppd_trap_code;
                ...
                } else if (propActs[bcmIndex].bcmParam1 == 3) {
                    /* Trap */
                    hwAct[ppdIndex].hwType = SOC_PPC_FP_ACTION_TYPE_SNOOP_AND_TRAP;
                    if (BCM_GPORT_IS_SET(propActs[bcmIndex].bcmParam0)) {
                        if (!BCM_GPORT_IS_TRAP(propActs[bcmIndex].bcmParam0)) {
                ...
                } else if (propActs[bcmIndex].bcmParam1 == 2) {
                    /* Both */
                ...
                _BCM_DPP_FIELD_STAGE_DEV_INFO(unit, groupD_stage).hwStageId) 
        {
            ...
            case bcmFieldActionStat:
                ...
                if (SOC_IS_JERICHO(unit)) 
                {
                    ...
                    param0 = propActs[bcmIndex].bcmParam0 ;
                    param1 = propActs[bcmIndex].bcmParam1 ;
                    param2 = propActs[bcmIndex].bcmParam2 ;
                    ...
                    if (param0 == BCM_ILLEGAL_ACTION_PARAMETER) {
                        ...
                        if(!(soc_property_suffix_num_get(unit,-1,spn_CUSTOM_FEATURE,"lsr_cnt_egress",0)
                            ...
                            /*
                             * Check the counter section of Stat-ID (LS 17 or 19 bits). If these bits in
    			        ...
    			        if (param1 != BCM_ILLEGAL_ACTION_PARAMETER) {
                                    ...
                                    BCMDNX_IF_ERR_EXIT_MSG(
                                        ...
                                        (_BSL_BCM_MSG_NO_UNIT(
                                            ...
                                            __FUNCTION__,(bcm_gport_t)param1)) ;
                                    control_ndx.type = SOC_PPC_FP_CONTROL_TYPE_ACE_POINTER_PP_PORT ;
                                    control_ndx.val_ndx = cntr ;
                                    control_info.val[0] = pp_port ;
                                    SHR_BITCOPY_RANGE(&(control_info.val[1]), 0, (uint32 *)&(param0), 
            ...
            case bcmFieldActionRedirectVportPort:
                ...
                /* Use the action-profile action instead in Arad - no simple Out-LIF action */
                    hwAct[ppdIndex].hwType = SOC_PPC_FP_ACTION_TYPE_EGR_TRAP;
                    hwAct[ppdIndex].hwFlags = SOC_PPC_TRAP_ACTION_PROFILE_OVERWRITE_CUD;

                    hwAct[ppdIndex + 1].hwType = SOC_PPC_FP_ACTION_TYPE_EGR_TRAP;
                    hwAct[ppdIndex + 1].hwFlags = SOC_PPC_TRAP_ACTION_PROFILE_OVERWRITE_DEST;
            ...
            switch (propActs[bcmIndex].bcmType) {
                case bcmFieldActionExternalValue0Set:/*48 bit so param1 can be used*/                
                    ...
                    if (propActs[bcmIndex].bcmParam1) {
                        hwAct[ppdIndex + 1].hwType = SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_0;
                        hwAct[ppdIndex + 1].hwParam = propActs[bcmIndex].bcmParam1;
                        /* two hardware actions are used here */
                        actCount = 2;
                    }
                ...
                case bcmFieldActionExternalValue1Set:
                    ...
                    if (propActs[bcmIndex].bcmParam1) {
						if(SOC_IS_JERICHO(unit)){
                        	hwAct[ppdIndex + 1].hwType = SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_1;
                        	hwAct[ppdIndex + 1].hwParam = propActs[bcmIndex].bcmParam1;
                        	/* two hardware actions are used here */
                        	actCount = 2;
						}else{
                ...
                case bcmFieldActionExternalValue2Set:
                    ...
                    if (propActs[bcmIndex].bcmParam1) {
						if(SOC_IS_JERICHO(unit)){
                        	hwAct[ppdIndex + 1].hwType = SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_2;
                        	hwAct[ppdIndex + 1].hwParam = propActs[bcmIndex].bcmParam1;
                        	/* two hardware actions are used here */
                        	actCount = 2;
						}else{
                ...
                case bcmFieldActionExternalValue3Set:
                    ...
                    if (propActs[bcmIndex].bcmParam1) {
						if(SOC_IS_JERICHO(unit)){
                        	hwAct[ppdIndex + 1].hwType = SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_3;
                        	hwAct[ppdIndex + 1].hwParam = propActs[bcmIndex].bcmParam1;
                        	/* two hardware actions are used here */
                        	actCount = 2;
						}else{
                ...
                case bcmFieldActionExternalValue4Set:
                    ...
                    if (propActs[bcmIndex].bcmParam1) {
						if(SOC_IS_JERICHO(unit)){
                        	hwAct[ppdIndex + 1].hwType = SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_4;
                        	hwAct[ppdIndex + 1].hwParam = propActs[bcmIndex].bcmParam1;
                        	/* two hardware actions are used here */
                        	actCount = 2;
						}else{
                ...
                case bcmFieldActionExternalValue5Set:
                    ...
                    if (propActs[bcmIndex].bcmParam1) {
						if(SOC_IS_JERICHO(unit)){
                        	hwAct[ppdIndex + 1].hwType = SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_5;
                        	hwAct[ppdIndex + 1].hwParam = propActs[bcmIndex].bcmParam1;
                        	/* two hardware actions are used here */
                        	actCount = 2;
						}else{
...
exit:
    {
        _bcm_dpp_field_tc_p_act_t loc_tcActP[SOC_PPC_FP_NOF_ACTIONS_PER_DB_MAX];
    ...
    for (index = 0, avail = _BCM_DPP_NOF_BCM_ACTIONS_PER_DB_MAX;
        ...
        if (type == tempActs[index].bcmType) {
            ...
            LOG_DEBUG(BSL_LS_BCM_FP,
                      (BSL_META_U(unit,
                                  "unit %d entry %u action %d, %s(%d)"
                                  " %d(%08X) %d(%08X) %d(%08X) will be replaced\n"),
                       unit,
                       _BCM_DPP_FIELD_TCAM_GLOBAL_ID(unit, entry, isExternalTcam),
                       index,
                       _bcm_dpp_field_action_name[tempActs[index].bcmType],
                                  ...
                                  _bcm_dpp_field_ent_idx_t entry)
{
    ...
    /*
     * Was:
     *   groupD_group = _BCM_DPP_FIELD_TCAM_ENTRY_GROUP(isExternalTcam, entry);
     */
    BCMDNX_IF_ERR_EXIT(_BCM_DPP_FIELD_TCAM_ENTRY_GROUP_GET(unit,isExternalTcam, entry, groupD_group)) ;
    ...
    if (entryFlags & _BCM_DPP_FIELD_ENTRY_IN_USE) {
        ...
        if (BCM_E_NONE == result) {
             ...
             */
            BCMDNX_IF_ERR_EXIT(_BCM_DPP_FIELD_TCAM_ENTRY_PREV_SET(unit,isExternalTcam, entry, tcam_entry_limit)) ;
             ...
             *   }
             */
            BCMDNX_IF_ERR_EXIT(_BCM_DPP_FIELD_TCAM_ENTRY_FLAGS_SET(unit,isExternalTcam, entry, 0)) ;
            _BCM_DPP_FIELD_TCAM_ENTRY_TC_FREE(entryType); /* sets 'next' variable with the next free entry */
            if (next < tcam_entry_limit) {
                BCMDNX_IF_ERR_EXIT(_BCM_DPP_FIELD_TCAM_ENTRY_PREV_SET(unit,_BCM_DPP_FIELD_ENT_TYPE_IS_EXTTCAM(entryType), next, entry)) ;
            }
                                     ...
                                     uint32 *param1)
{
    ...
    SOC_PPC_FP_ACTION_TYPE ppdType;
    uint32 groupD_hwHandle;
...

    {
        ...
        /*
         * Was:
         *   BCMDNX_IF_ERR_EXIT(FIELD_ACCESS.groupD.groupFlags.get(unit, _BCM_DPP_FIELD_TCAM_ENTRY_GROUP(isExternalTcam, entry), &groupD_groupFlags));
         */
        ...
        if (entryFlags & _BCM_DPP_FIELD_ENTRY_IN_USE) {
            if ((isExternalTcam) && (entryFlags & _BCM_DPP_FIELD_ENTRY_IN_HW)) {
                ...
                SOC_PPC_FP_ENTRY_INFO_clear(&entInfo);
                {
                    ...
                    /*
                     * Was:
                     *   BCMDNX_IF_ERR_EXIT(FIELD_ACCESS.groupD.hwHandle.get(unit, _BCM_DPP_FIELD_TCAM_ENTRY_GROUP(isExternalTcam, entry), &groupD_hwHandle));
                     */
                    BCMDNX_IF_ERR_EXIT(FIELD_ACCESS.groupD.hwHandle.get(unit, entryGroup, &groupD_hwHandle));
                ...
                if (BCM_E_NONE == result) {
                    if (found) {
                        ...
                        if (index < SOC_PPC_FP_NOF_ACTIONS_PER_DB_MAX) {
                            ...
                            *param1 = 0;
                            if ((entInfo.actions[index].type == SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_0) && (index < SOC_PPC_FP_NOF_ACTIONS_PER_DB_MAX-1)) {
                                *param1 = entInfo.actions[index+1].val;
                            }
							if ((index < SOC_PPC_FP_NOF_ACTIONS_PER_DB_MAX-1) && SOC_IS_JERICHO(unit)&&
								((entInfo.actions[index].type == SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_1)||
								 (entInfo.actions[index].type == SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_2)||
								 (entInfo.actions[index].type == SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_3)||
								 (entInfo.actions[index].type == SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_4)||
								 (entInfo.actions[index].type == SOC_PPC_FP_ACTION_TYPE_FLP_ACTION_5))
								) {
                                *param1 = entInfo.actions[index+1].val;
                            }
                        }
    ...
    _bcm_dpp_field_tcam_entry_remove_by_key(bcm_dpp_field_info_OLD_t *unitData, uint8 isExternalTcam, _bcm_dpp_field_ent_idx_t entry)
{
     ...
     */
    BCMDNX_IF_ERR_EXIT(FIELD_ACCESS.groupD.hwHandle.get(unit, entryGroup, &groupD_hwHandle));
    ppdr = soc_ppd_fp_entry_remove_by_key(unitData->unitHandle, groupD_hwHandle, &entryInfo);
                                         ...
                                         SOC_PPC_FP_ENTRY_INFO *entInfoTc)
{
    ...
    /*
     * Was:
     *   BCMDNX_IF_ERR_EXIT(FIELD_ACCESS.groupD.hwHandle.get(unit, _BCM_DPP_FIELD_TCAM_ENTRY_GROUP(_BCM_DPP_FIELD_ENT_IS_EXTTCAM(unit, entry), ent), &groupD_hwHandle));
     */
    BCMDNX_IF_ERR_EXIT(FIELD_ACCESS.groupD.hwHandle.get(unit, entryGroup, &groupD_hwHandle));
    ...
    for (index = 0;
         ...
         index++) {
        _BCM_DPP_FIELD_TCAM_ENTRY_QUALS_GET(unit,_BCM_DPP_FIELD_ENT_IS_EXTTCAM(unit, entry), entry, index, qual) ;
        /*
         * was
