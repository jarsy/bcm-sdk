...
/* Define introduce to verify that local stack will not be overflowed by */
#define MAX_CONTENT_SIZE    2400
...
xmlValidBuildContentModel(xmlValidCtxtPtr ctxt, xmlElementPtr elem) {
	...
	char expr[MAX_CONTENT_SIZE];
	expr[0] = 0;
	xmlSnprintfElementContent(expr, MAX_CONTENT_SIZE, elem->content, 1);
	xmlErrValidNode(ctxt, (xmlNodePtr) elem,
