...
/*! \file utilex_integer_arithmetic.c 
 *  
 *  Math utils for integers 
 * 
 */
    ...
    uint32 * x)
{
    ...
    utilex_u64_multiply_longs(eq_const_multi, (mnt + eq_const_mnt_inc), &tmp_result);   /* eq_const_multi * (mnt + eq_const_mnt_inc) */
    ...
    uint32 * x)
{
    ...
    if (res)    /* overflow */
    {
         ...
         */
        res = utilex_u64_devide_u64_long(&tmp_result, (1 << rev_exp) * eq_const_div, &tmp_result_2);    /* tmp_result / (2^rev_exp * eq_const_div) */
    ...
    else
    {
         ...
         */
        utilex_u64_multiply_longs(tmp_res, (mnt + eq_const_mnt_inc), &tmp_result);      /* tmp_res * (mnt + eq_const_mnt_inc) */

        res = utilex_u64_devide_u64_long(&tmp_result, (1 << rev_exp) * eq_const_div, &result);  /* tmp_result / (2^rev_exp * eq_const_div) */
    }
