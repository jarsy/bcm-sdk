/*
 * $Id: dnx_shr_template.c,v 1.21 Broadcom SDK $
 * 
...
#define TEMPLATE_ACCESS sw_state_access[unit].dnx.shr.template_info


#define DNX_SHR_TEMPLATE_MAX_BUFFER_SIZE_FOR_PRINT  2048

/* A handle for a non-unit-based template manager instance */
typedef struct _dnx_shr_template_unit_desc_s *shr_mtemplate_handle_t;


/*
 *  Various function prototypes per method for the alloc managers.
 */
typedef int (*_dnx_shr_template_manage_create)(int unit,
                                           int pool_id,
                                         int template_low_id,
                                         int template_count,
                                         int max_entities,
                                         ...
                                         const void *extras,
                                         const char *name);
typedef int (*_dnx_shr_template_manage_destroy)(int unit, int pool_id);
typedef int (*_dnx_shr_template_manage_alloc)(int unit, 
                                          int pool_id,
                                        uint32 flags,
                                        const void* data,
                                        int *is_allocated,
                                        int *template);
typedef int (*_dnx_shr_template_manage_alloc_group)(int unit, 
                                                int pool_id,
                                                uint32 flags,
                                                const void* data,
                                                int nof_additions,
                                                int *is_allocated,
                                                int *template);
typedef int (*_dnx_shr_template_manage_exchange)(int unit, 
                                             int pool_id,
                                            uint32 flags,
                                            const void *data,
                                            int old_template,
                                            ...
                                            int *template,
                                            int *is_allocated); 
typedef int (*_dnx_shr_template_manage_exchange_test)(int unit, 
                                                  int pool_id,
                                                uint32 flags,
                                                const void *data,
                                                int old_template,
                                                ...
                                                int *template,
                                                int *is_allocated);                       
typedef int (*_dnx_shr_template_manage_free)(int unit, 
                                         int pool_id,                                  
                                        int template,
                                        int *is_free);
typedef int (*_dnx_shr_template_manage_free_group)(int unit, 
                                               int pool_id,                                  
                                                int template,
                                                int nof_deductions,
                                                int *is_free);
typedef int (*_dnx_shr_template_manage_data_get)(int unit, 
                                             int pool_id,
                                            int template,
                                            void *data);
typedef int (*_dnx_shr_template_manage_index_get)(int unit, 
                                              int pool_id,
                                            const void *data, 
                                            int *template);
typedef int (*_dnx_shr_template_manage_ref_count_get)(int unit, 
                                                  int pool_id,
                                                int template,
                                                uint32 *ref_count);
typedef int (*_dnx_shr_template_manage_clear)(int unit, int pool_id);
 ...
 */
typedef struct _dnx_shr_template_managements_s {
    _dnx_shr_template_manage_create create;
    _dnx_shr_template_manage_destroy destroy;
    _dnx_shr_template_manage_alloc alloc;
    _dnx_shr_template_manage_alloc_group alloc_group;
    _dnx_shr_template_manage_exchange exchange;
    _dnx_shr_template_manage_exchange_test exchange_test;
    _dnx_shr_template_manage_free free;
    _dnx_shr_template_manage_free_group free_group;
    _dnx_shr_template_manage_data_get data_get;
    _dnx_shr_template_manage_ref_count_get ref_count_get;
    _dnx_shr_template_manage_clear clear;
    _dnx_shr_template_manage_index_get index_get;
    char *name;
} _dnx_shr_template_managements_t;

/*
 *  These prototypes are for the global const structure below that points to
 *  all of the various implementations.
 */
static int _dnx_shr_template_hash_create(int unit, 
                                     int pool_id,
                                     int template_low_id,
                                     int template_count,
                                     int max_entities,
                                     ...
                                     const void *extras,
                                     const char *name);
static int _dnx_shr_template_hash_destroy(int unit, int pool_id);
static int _dnx_shr_template_hash_alloc(int unit, 
                                    int pool_id,
                                     uint32 flags,
                                     const void* data,
                                     int *is_allocated,
                                     int *template);
static int _dnx_shr_template_hash_alloc_group(int unit, 
                                          int pool_id,
                                         uint32 flags,
                                         const void* data,
                                         int nof_additions,
                                         int *is_allocated,
                                         int *template);
static int _dnx_shr_template_hash_free(int unit, 
                                   int pool_id,
                                    int template,
                                    int *is_last);
static int _dnx_shr_template_hash_free_group(int unit, 
                                         int pool_id,
                                        int template,
                                        int nof_deductions,
                                        int *is_last);
static int _dnx_shr_template_hash_exchange(int unit, 
                                       int pool_id,
                                        uint32 flags,
                                        const void *data,
                                        int old_template,
                                        ...
                                        int *template,
                                        int *is_allocated);
static int _dnx_shr_template_hash_exchange_test(int unit, 
                                            int pool_id,
                                            uint32 flags,
                                            const void *data,
                                            int old_template,
                                            ...
                                            int *template,
                                            int *is_allocated);
static int _dnx_shr_template_hash_data_get(int unit, 
                                       int pool_id,
                                        int template,
                                        void *data);
static int _dnx_shr_template_hash_ref_count_get(int unit, 
                                            int pool_id,
                                            int template,
                                            uint32 *ref_count);
static int _dnx_shr_template_hash_clear(int unit, int pool_id);
static int _dnx_shr_template_hash_index_get(int unit, 
                                        int pool_id,
                                        const void *data,
                                        int* template);
/*
 ...
 */
static const _dnx_shr_template_managements_t _dnx_shr_template_managements_mgrs[DNX_SHR_TEMPLATE_MANAGE_COUNT] =
    {
        {
            _dnx_shr_template_hash_create,
            _dnx_shr_template_hash_destroy,
            _dnx_shr_template_hash_alloc,
            _dnx_shr_template_hash_alloc_group,
            _dnx_shr_template_hash_exchange,
            _dnx_shr_template_hash_exchange_test,
            _dnx_shr_template_hash_free,
            _dnx_shr_template_hash_free_group,
            _dnx_shr_template_hash_data_get,
            _dnx_shr_template_hash_ref_count_get,
            _dnx_shr_template_hash_clear,
            _dnx_shr_template_hash_index_get,
            "DNX_SHR_TEMPLATE_MANAGE_HASH"
        } /* hash */
    };
 ...
 */
static dnx_shr_template_to_stream_t     *hash_compare_to_stream_cb[BCM_MAX_NUM_UNITS];
static dnx_shr_template_from_stream_t   *hash_compare_from_stream_cb[BCM_MAX_NUM_UNITS];
...
shr_mtemplate_create(int unit,
                ...
                dnx_shr_template_to_stream_t *to_stream_cb_arr,
                dnx_shr_template_from_stream_t *from_stream_cb_arr,
                int cb_arr_length);
static int
...
shr_mtemplate_pool_get(int unit,
                      ...
                      int *max_entities,
                      size_t *data_size,
                      dnx_shr_template_manage_hash_compare_extras_t *extras,
                      dnx_sw_state_template_name_t *name);
static int
 ...
 */
int
dnx_shr_template_init(int unit,
                  int num_template_types,
                  int num_template_pools,
                  dnx_shr_template_to_stream_t *to_stream_cb_arr,
                  dnx_shr_template_from_stream_t *from_stream_cb_arr,
 ...
 */
int
dnx_shr_template_pool_set(int unit,
                 int pool_id,
                 dnx_shr_template_manage_t manager,
                 int template_low_id,
                 int template_count,
 ...
 */
int
dnx_shr_template_pool_get(int unit,
                      int pool_id,
                      dnx_shr_template_manage_t *manager,
                      int *template_low_id,
                      int *template_count,
 ...
 */
int
dnx_shr_template_pool_unset(int unit,
                   int pool_id)
{
    /* a little parameter checking */
    TEMPLATE_UNIT_CHECK(unit);
 ...
 */
int
dnx_shr_template_type_set(int unit,
                      int template_type,
                      int pool_id,
                      const char *name)
{
 ...
 */
extern int
dnx_shr_template_type_get(int unit,
                      int template_type,
                      int *pool_id,
                      dnx_sw_state_template_name_t *name)
{
 ...
 */
int
dnx_shr_template_type_unset(int unit,
                   int template_id)
{
    /* a little parameter checking */
    TEMPLATE_UNIT_CHECK(unit);
 ...
 */
int
dnx_shr_template_detach(int unit)
{
    int result = BCM_E_NONE;
    uint8 exists;
 ...
 */
int
dnx_shr_template_allocate(int unit,
                      int template_type,
                      uint32 flags,
                      const void *data,
                      int *is_allocated,
 ...
 */
int
dnx_shr_template_allocate_group(int unit,
                      int template_type,
                      uint32 flags,
                      const void *data,
                      int nof_additions,
 ...
 */
extern int
dnx_shr_template_free(int unit,
                  int template_type,
                  int template,
                  int *is_last)
{
 ...
 */
extern int
dnx_shr_template_free_group(int unit,
                  int template_type,
                  int template,
                  int nof_deductions,
                  int *is_last)
 ...
 */
int
dnx_shr_template_exchange(int unit,
                      int template_type,
                      uint32 flags,
                      const void *data,
                      int old_template,
 ...
 */
int
dnx_shr_template_exchange_test(int unit,
                      int template_type,
                      uint32 flags,
                      const void *data,
                      int old_template,
 ...
 */
int
dnx_shr_template_data_get(int unit,
                      int template_type,
                      int template,
                      void *data)
{
 ...
 */
int
dnx_shr_template_template_get(int unit,
                      int template_type,
                      const void *data,
                      int *template)
{
...
/*
 *   Function
 *      dnx_shr_template_ref_count_get
 *   Purpose
 ...
 */
int
dnx_shr_template_ref_count_get(int unit,
                      int template_type,
                      int template,
                      uint32 *ref_count)
{
 ...
 */
int
dnx_shr_template_dump(int unit, int template_type)
{
    /* a little parameter checking */
    TEMPLATE_UNIT_CHECK(unit);
 ...
 */
int
dnx_shr_template_clear(int unit,
                   int template_type)
{
    /* a little parameter checking */
    TEMPLATE_UNIT_CHECK(unit);
               ...
               int *template)               
{
    int thisPool;
    int result = BCM_E_NONE;
    dnx_shr_template_manage_t mngr_type;
    ...
    if (flags & (~DNX_SHR_TEMPLATE_MANAGE_SINGLE_FLAGS)) {
        LOG_ERROR(BSL_LS_SOC_COMMON,
                  (BSL_META("invalid flags %08X\n"),
                   flags & (~DNX_SHR_TEMPLATE_MANAGE_SINGLE_FLAGS)));
        return BCM_E_PARAM;
    }
    ...
    /* make the call */
    result = _dnx_shr_template_managements_mgrs[mngr_type].alloc(unit,
                                                             thisPool,
                                                             flags,
                                                             data,
                                                             is_allocated,
               ...
               int *template)               
{
    ...
    if ((flags & (DNX_SHR_TEMPLATE_MANAGE_SET_WITH_ID)) == 0) {
        LOG_ERROR(BSL_LS_SOC_COMMON,
    ...
    SW_STATE_ACCESS_ERROR_CHECK(result); 
    /* make the call */
    result = _dnx_shr_template_managements_mgrs[mngr_type].alloc_group(unit,
                                                                     thisPool,
                                                                     flags,
                                                                     data,
                                                                     nof_additions,
               ...
               int *is_last)
{
    ...
    /* make the call */
    result = _dnx_shr_template_managements_mgrs[mngr_type].free(unit,
                                                            thisPool,
                                                            template,
                                                            is_last);
               ...
               int *is_last)
{
    ...
    result = TEMPLATE_ACCESS.pool.templateManagerType.get(unit, thisPool, &mngr_type);
    SW_STATE_ACCESS_ERROR_CHECK(result); 
    result = _dnx_shr_template_managements_mgrs[mngr_type].free_group(unit,
                                                                thisPool,
                                                                template,
                                                                nof_deductions,
                                                                is_last);
                      ...
                      int *is_allocated)
{
    ...
    int thisPool;
    int result = BCM_E_NONE;
    uint32 valid_flags = DNX_SHR_TEMPLATE_MANAGE_SINGLE_FLAGS | DNX_SHR_TEMPLATE_MANAGE_SET_WITH_ID | DNX_SHR_TEMPLATE_MANAGE_IGNORE_DATA;
    ...
    if ((flags & DNX_SHR_TEMPLATE_MANAGE_IGNORE_DATA) && !(flags & DNX_SHR_TEMPLATE_MANAGE_SET_WITH_ID)) {
        LOG_ERROR(BSL_LS_SOC_COMMON,
                  (BSL_META("DNX_SHR_TEMPLATE_MANAGE_IGNORE_DATA is only valid in combination with DNX_SHR_TEMPLATE_MANAGE_SET_WITH_ID\n")));
        return BCM_E_PARAM;
    }
    ...
    result = TEMPLATE_ACCESS.pool.templateManagerType.get(unit, thisPool, &mngr_type);
    SW_STATE_ACCESS_ERROR_CHECK(result); 
    result = _dnx_shr_template_managements_mgrs[mngr_type].exchange(unit,
                                                                thisPool,
                                                                 flags,
                                                                 data,
                                                                 old_template,
                      ...
                      int *is_allocated)
{
    ...
    result = TEMPLATE_ACCESS.pool.templateManagerType.get(unit, thisPool, &mngr_type);
    SW_STATE_ACCESS_ERROR_CHECK(result); 
    result = _dnx_shr_template_managements_mgrs[mngr_type].exchange_test(unit,
                                                                     thisPool,
                                                                     flags,
                                                                     data,
                                                                     old_template,
                      ...
                      void *data)
{
    ...
    result = TEMPLATE_ACCESS.pool.templateManagerType.get(unit, thisPool, &mngr_type);
    SW_STATE_ACCESS_ERROR_CHECK(result); 
    result = _dnx_shr_template_managements_mgrs[mngr_type].data_get(unit,
                                                                thisPool,
                                                                template,
                                                                data);
                      ...
                      int *template)
{
    ...
    result = TEMPLATE_ACCESS.pool.templateManagerType.get(unit, thisPool, &mngr_type);
    SW_STATE_ACCESS_ERROR_CHECK(result); 
    result = _dnx_shr_template_managements_mgrs[mngr_type].index_get(unit,
                                                                 thisPool,
                                                                 data,
                                                                 template);
                            ...
                            uint32 *ref_count)
{
    ...
    result = TEMPLATE_ACCESS.pool.templateManagerType.get(unit, thisPool, &mngr_type);
    SW_STATE_ACCESS_ERROR_CHECK(result); 
    result = _dnx_shr_template_managements_mgrs[mngr_type].ref_count_get(unit, 
                                                                     thisPool,
                                                                     template,
                                                                     ref_count);
                 ...
                 const char *name)
{
    ...
    uint8 exists;
    const char *noname = "???";
    dnx_sw_state_template_name_t name_handle;
    int name_len;
    ...
    LOG_DEBUG(BSL_LS_SOC_COMMON,
              (BSL_META("(%d, %d, %s, %d, %d, %d, %d, %p, \"%s\") enter\n"),
               unit,
               pool_id,
               ((0 <= manager) && (DNX_SHR_TEMPLATE_MANAGE_COUNT > manager))?_dnx_shr_template_managements_mgrs[manager].name:"INVALID",
               template_low_id,
               template_count,
               max_entities,
               (int)data_size,
    ...
    if ((0 > manager) || (DNX_SHR_TEMPLATE_MANAGE_COUNT <= manager)) {
        LOG_ERROR(BSL_LS_SOC_COMMON,
    ...
    if (name_len>= DNX_SW_STATE_TEMPLATE_NAME_MAX_LENGTH) {
        LOG_ERROR(BSL_LS_SOC_COMMON,
    ...
    /* create the new pool */
    result = _dnx_shr_template_managements_mgrs[manager].create(unit,
                                                         pool_id,
                                                         template_low_id,
                                                         template_count,
                                                         max_entities,
    ...
    LOG_DEBUG(BSL_LS_SOC_COMMON,
              (BSL_META("(%d, %d, %s, %d, %d, %d, %d, %p, \"%s\") return %d (%s)\n"),
               unit,
               pool_id,
               _dnx_shr_template_managements_mgrs[manager].name,
               template_low_id,
               template_count,
               max_entities,
               (int)data_size,
                      ...
                      dnx_sw_state_template_name_t *name)
{
    ...
    LOG_DEBUG(BSL_LS_SOC_COMMON,
              (BSL_META("(%d, %d, &(%s), &(%d), &(%d), &(%d), &(%d), &(%p), &(\"%s\")) return %d (%s)\n"),
               unit,
               pool_id,
               manager?_dnx_shr_template_managements_mgrs[*manager].name:"NULL",
...
shr_mtemplate_pool_unset(int unit,
                    int pool_id)
{
    _dnx_shr_template_pool_desc_t oldPool;
    int result = _SHR_E_NONE;
    uint8 exists;
    ...
    if (exists) {
        ...
        if (oldPool.refCount) {
            ...
            result = _dnx_shr_template_managements_mgrs[oldPool.templateManagerType].destroy(unit, pool_id);
                      ...
                      const char *name)
{
    ...
    if (len_name>= DNX_SW_STATE_TEMPLATE_NAME_MAX_LENGTH) {
        LOG_ERROR(BSL_LS_SOC_COMMON,
                  (BSL_META("Name string \"%s\" too long. Must be shorter than %d "
                            "(including terminal \\0)\n"),
                   name,
...
shr_mtemplate_type_unset(int unit,
                    int template_id)
{
    _dnx_shr_template_type_desc_t oldType;
    int result = _SHR_E_NONE;
    uint8 exists;
    int refCount;
...
_shr_mtemplate_destroy_data(int unit)
{
    ...
    uint8 exists;
    _dnx_shr_template_type_desc_t type;
    _dnx_shr_template_pool_desc_t pool;
    int refCount;
    ...
    if (!SOC_IS_DETACHING(unit) && !SOC_WARM_BOOT(unit)) {
        ...
        for (i = 0;
            ...
            if (exists) {
                ...
                result = _dnx_shr_template_managements_mgrs[pool.templateManagerType].destroy(unit, i);
                if (_SHR_E_NONE != result) {
                    LOG_ERROR(BSL_LS_SOC_COMMON,
...
shr_mtemplate_dump(int unit, int template_type)
{
    _dnx_shr_template_pool_desc_t thisPool;
    _dnx_shr_template_type_desc_t thisTemplate;
    int index, template, start_index, last_index, buff_counter;
    int result = BCM_E_NONE;
    char buff[DNX_SHR_TEMPLATE_MAX_BUFFER_SIZE_FOR_PRINT];
    uint32 ref_count;
    uint16 templateTypeCount, templatePoolCount;
    uint8 exists;
    ...
    for (index = start_index; index < last_index; index++) {
        ...
        if (exists) {
            ...
            LOG_CLI((BSL_META("  template type %d (%s) template pool %d (%s)\n"), index, thisTemplate.name.name, thisTemplate.templatePoolId, thisPool.name.name));
            ...
            bcm_dnx_am_pool_id_to_template_id_get(unit, index, &template_id, &pool_idx);
            if(template_type != -1) {                
                for (template = thisPool.template_low_id; template < thisPool.template_low_id + thisPool.template_count; template++) {
                    result = _dnx_shr_template_managements_mgrs[thisPool.templateManagerType].ref_count_get(unit, thisTemplate.templatePoolId, template, &ref_count);
                    if (BCM_E_NONE != result) {
                        LOG_CLI((BSL_META("  error retriving ref counter \n")));
                        return BCM_E_FAIL;
                    }

                    if (ref_count > 0 && DNX_SHR_TEMPLATE_MAX_BUFFER_SIZE_FOR_PRINT >= thisPool.data_size) {
                        result = _dnx_shr_template_managements_mgrs[thisPool.templateManagerType].data_get(unit, thisTemplate.templatePoolId, template, buff);
                        if (BCM_E_NONE != result) {
                            LOG_CLI((BSL_META("  error geting data for template ID %d\n"), template));
                        } else{
                            LOG_CLI((BSL_META("  template id = %d ref counter = %d \n"), template, ref_count));
                            if (_bcm_dnx_am_template_print_func[template_id] == NULL ) {
                                ...
                                (_bcm_dnx_am_template_print_func[template_id]) (unit, buff);
                            } 
                        }
                    }                    
                }
                    ...
                    int template_type)
{
    ...
    /* make the call */
    result = _dnx_shr_template_managements_mgrs[mngr_type].clear(unit, thisPool);
                                     ...
                                     const char *name)
{
    ...
    int result = BCM_E_NONE;
    const dnx_shr_template_manage_hash_compare_extras_t *info = extras;
    uint32 dnx_sand_rv = 0;
    DNX_SAND_MULTI_SET_PTR multi_set_info;
    DNX_SAND_MULTI_SET_INIT_INFO multi_set_init_info;
    ...
    /* Init hash template */
    dnx_sand_os_memset(&multi_set_init_info, 0x0, sizeof(DNX_SAND_MULTI_SET_INIT_INFO));
    ...
    dnx_sand_rv = dnx_sand_multi_set_create(
        unit,
        &multi_set_info,
        multi_set_init_info
    );
    ...
    if (DNX_SAND_FAILURE(dnx_sand_rv)) {
        /* Init failed */
        return BCM_E_MEMORY;
    }
...
static int _dnx_shr_template_hash_destroy(int unit, int pool_id)
{
    int res = BCM_E_NONE;
    uint32 dnx_sand_rv;
    DNX_SAND_MULTI_SET_PTR hash_handle;

    res = TEMPLATE_ACCESS.pool.templateHandle.get(unit, pool_id, &hash_handle);
    SW_STATE_ACCESS_ERROR_CHECK(res); 

    dnx_sand_rv = dnx_sand_multi_set_destroy(unit, hash_handle);
    DNX_SAND_IF_ERR_RETURN(dnx_sand_rv);
...
static int _dnx_shr_template_hash_alloc(int unit, 
                                    int pool_id,
                                     ...
                                     int *template)
{
    _dnx_shr_template_pool_desc_t desc;
    int res = BCM_E_NONE;   
    DNX_SAND_MULTI_SET_KEY * val;
    DNX_SAND_MULTI_SET_PTR hash_handle;
    uint8 add_success;
    dnx_shr_template_manage_hash_compare_extras_t extra;
    uint32 dnx_sand_rv = DNX_SAND_OK;
    uint8 first_appear;
    int template_alloc = 0;
    dnx_shr_template_to_stream_t *hcts_cb = NULL;
    ...
    if (!val) {
        ...
        if (flags & DNX_SHR_TEMPLATE_MANAGE_SET_WITH_ID) {
            template_alloc = *template - desc.template_low_id;
            dnx_sand_rv = dnx_sand_multi_set_member_add_at_index(
                        unit,
                        hash_handle,
                        val,
                        template_alloc,
           ...
           /* Add new data */
            dnx_sand_rv = dnx_sand_multi_set_member_add(
                        unit,
                        hash_handle,
                        val,
                                     ...
                                     int *template)
{
    ...
    if (!val) {
        ...
        if (flags & DNX_SHR_TEMPLATE_MANAGE_SET_WITH_ID) {
            template_alloc = *template - desc.template_low_id;
            dnx_sand_rv = dnx_sand_multi_set_member_add_at_index_nof_additions(
                        unit,
                        hash_handle,
                        val,
                        template_alloc,
                                    ...
                                    int *is_last)
{
    ...
    /* Remove old template */
    template_alloc = template - desc.template_low_id;
    dnx_sand_rv = dnx_sand_multi_set_member_remove_by_index(
              unit,
              hash_handle,
              template_alloc,
              &last_appear);
                                        ...
                                        int *is_last)
{
    ...
    /* Remove old template */
    template_alloc = template - desc.template_low_id;
    dnx_sand_rv = dnx_sand_multi_set_member_remove_by_index_multiple(
              unit,
              hash_handle,
              template_alloc,
              nof_deductions,
                                        ...
                                        int *is_allocated)
{
    ...
    int res = BCM_E_NONE;   
    DNX_SAND_MULTI_SET_KEY * val;
    DNX_SAND_MULTI_SET_KEY * old_val;
    DNX_SAND_MULTI_SET_PTR hash_handle;
    uint8 add_success;
    ...
    if (!val || !old_val) {
        ...
        dnx_sand_rv = dnx_sand_multi_set_get_by_index(
                      unit,
                      hash_handle,
                      old_template_alloc,
                      old_val,
        ...
        if (ref_count_old == 0 && !(flags & DNX_SHR_TEMPLATE_MANAGE_IGNORE_NOT_EXIST_OLD_TEMPLATE)) {
        ...
        if (flags & DNX_SHR_TEMPLATE_MANAGE_SET_WITH_ID) {
            ...
            if (!(flags & DNX_SHR_TEMPLATE_MANAGE_IGNORE_DATA)) {
                ...
                dnx_sand_rv = dnx_sand_multi_set_member_lookup(
                              unit,
                              hash_handle,
                              val,
            ...
            if ((flags & DNX_SHR_TEMPLATE_MANAGE_IGNORE_DATA) && (old_data_ref_count == 0)) {
        ...
        *is_allocated = first_appear;
        ...
        if (DNX_SAND_FAILURE(dnx_sand_rv) || !add_success) {
                                        ...
                                        void *data)
{
    ...
    uint32 dnx_sand_rv;
    int template_alloc;
    dnx_shr_template_from_stream_t *hcfs_cb = NULL;
    ...
    if (!val) {
        ...
        if (!DNX_SAND_FAILURE(dnx_sand_rv) && ref_count != 0) {
...
static int _dnx_shr_template_hash_clear(int unit, int pool_id)
{
    ...
    dnx_sand_rv = dnx_sand_multi_set_clear(unit, hash_handle);
    DNX_SAND_IF_ERR_RETURN(dnx_sand_rv);    
