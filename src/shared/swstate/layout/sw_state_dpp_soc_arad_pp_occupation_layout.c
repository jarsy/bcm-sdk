...
int sw_state_dpp_soc_arad_pp_occupation_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  
   ...
   int offset = 0; 
   ARAD_PP_OCCUPATION* dummy_struct; 
   SOC_INIT_FUNC_DEFS;
   /* alloc dummy struct */ 
   dummy_struct = sal_alloc(sizeof(ARAD_PP_OCCUPATION),"ARAD_PP_OCCUPATION"); 
   ...
   *root_node_id = *next_free_node_id; 
   ...
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_node_set(unit, 
                                   *root_node_id,                 /* node id var */      
                                   "occupation",             /* name */         
                                   sizeof(ARAD_PP_OCCUPATION),    /* size of the element's type*/          
                                   1,                 /* nof pointers */ 
                                   "ARAD_PP_OCCUPATION",              /* param type */
                                   0,                 /* array size 0 */ 
                                   0));             /* array size 1 */ 
   ...
   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_soc_arad_pp_occupation_inlif_profile_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   ...
   /* update offset */ 
   offset = ((uint8*) &(dummy_struct->inlif_profile)) - (( uint8*) dummy_struct); 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_update_offset(unit, younger_brother_node_id, offset)); 

   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_soc_arad_pp_occupation_outlif_profile_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   /* connect node (1st child) to its parent */ 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_add_child(unit, *root_node_id, younger_brother_node_id)); 
   /* update offset */ 
   offset = ((uint8*) &(dummy_struct->outlif_profile)) - (( uint8*) dummy_struct); 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_update_offset(unit, younger_brother_node_id, offset)); 

   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_soc_arad_pp_occupation_rif_profile_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
   /* connect node (1st child) to its parent */ 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_add_child(unit, *root_node_id, younger_brother_node_id)); 
   /* update offset */ 
   offset = ((uint8*) &(dummy_struct->rif_profile)) - (( uint8*) dummy_struct); 
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_update_offset(unit, younger_brother_node_id, offset)); 
   ...
   *root_node_id = *next_free_node_id; 
   ...
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_node_set(unit, 
                                   *root_node_id,                 /* node id var */      
                                   ...
                                   0,                 /* nof pointers */ 
                                   "int",              /* param type */
                                   SOC_OCC_MGMT_INLIF_SIZE+1,                 /* array size 0 */ 
                                   0));             /* array size 1 */ 
   /* update next free node id */ 
    SW_STATE_NODE_ID_CHECK(unit, ++(*next_free_node_id));  
   ...
   *root_node_id = *next_free_node_id; 
   ...
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_node_set(unit, 
                                   *root_node_id,                 /* node id var */      
                                   ...
                                   0,                 /* nof pointers */ 
                                   "int",              /* param type */
                                   SOC_DPP_IMP_DEFS_MAX(OUTLIF_PROFILE_NOF_BITS)+1,                 /* array size 0 */ 
                                   0));             /* array size 1 */ 
   /* update next free node id */ 
    SW_STATE_NODE_ID_CHECK(unit, ++(*next_free_node_id));  
   ...
   *root_node_id = *next_free_node_id; 
   ...
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_node_set(unit, 
                                   *root_node_id,                 /* node id var */      
                                   ...
                                   0,                 /* nof pointers */ 
                                   "int",              /* param type */
                                   SOC_OCC_MGMT_RIF_SIZE+1,                 /* array size 0 */ 
                                   0));             /* array size 1 */ 
   /* update next free node id */ 
    SW_STATE_NODE_ID_CHECK(unit, ++(*next_free_node_id));  
