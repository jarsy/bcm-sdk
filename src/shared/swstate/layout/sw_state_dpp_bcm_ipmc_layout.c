...
int sw_state_dpp_bcm_ipmc_layout_node_create(int unit, int* root_node_id, uint32* next_free_node_id){  
   ...
   int offset = 0; 
   bcm_dpp_ipmc_info_t* dummy_struct; 
   SOC_INIT_FUNC_DEFS;
   /* alloc dummy struct */ 
   dummy_struct = sal_alloc(sizeof(bcm_dpp_ipmc_info_t),"bcm_dpp_ipmc_info_t"); 
   ...
   *root_node_id = *next_free_node_id; 
   ...
   _SOC_IF_ERR_EXIT(shr_sw_state_ds_layout_node_set(unit, 
                                   *root_node_id,                 /* node id var */      
                                   "ipmc",             /* name */         
                                   sizeof(bcm_dpp_ipmc_info_t),    /* size of the element's type*/          
                                   1,                 /* nof pointers */ 
                                   "bcm_dpp_ipmc_info_t",              /* param type */
                                   0,                 /* array size 0 */ 
                                   0));             /* array size 1 */ 
   ...
   /* add node */ 
   _SOC_IF_ERR_EXIT(sw_state_dpp_bcm_ipmc_init_layout_node_create(unit, &younger_brother_node_id, next_free_node_id));
