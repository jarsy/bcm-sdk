...
int mpls_protection_create_l2_interfaces(int unit){
    ...
    /* Create a vlan port*/
    rv = l2__port_vlan__create(unit, flags,  cint_mpls_protection_info.port1, cint_mpls_protection_info.vlan1, cint_mpls_protection_info.vsi, &cint_mpls_protection_info.vport_id1);
    if (rv != BCM_E_NONE) {
        print rv;
...
int mpls_protection_one_plus_one_example(int unit){
    ...
    flags = BCM_MPLS_SWITCH_TTL_DECREMENT | BCM_MPLS_SWITCH_OUTER_TTL | BCM_MPLS_SWITCH_OUTER_EXP;
