...
int bfd_ipv6_ep_create(int unit, bfd_over_ipv6_ep_create_info_s bfdv6_ep) {
    ...
    printf("getting is_echo via soc_property_get \n");
    bfdv6_ep.is_echo=soc_property_get(unit, "bfd_echo_enabled", 0);
   ...
   if (bfdv6_ep.is_echo) {
    ...
    if (bfdv6_ep.is_echo) {
        bfd_endpoint_info[session].local_min_echo = bfdv6_ep.local_min_rx *3;
    }
