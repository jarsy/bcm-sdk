...
int create_snooping_pmf_group(bcm_field_group_t gid)
{
    ...
    rv |= bcm_field_qualify_Stage(unit, presel_id | BCM_FIELD_QUALIFY_PRESEL, bcmFieldStageIngress); print rv;
    print all_ports;
    rv |= bcm_field_qualify_InPorts(unit, presel_id | BCM_FIELD_QUALIFY_PRESEL, all_ports, all_ports_mask); print rv;
