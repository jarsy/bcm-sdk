/* $Id: cint_port_match.c,v 1.6 Broadcom SDK $
...
vlan_port_create(
    ...
    vp.egress_vlan = egr_vid; /* when forwarded to this port, packet will be set with this out-vlan */
    vp.vsi = vsi; 
    vp.flags = flags; 
