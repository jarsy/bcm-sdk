                  ...
                  int num_l2_se)
{
    ...
    int rv=BCM_E_NONE, port,port_index, prio, l4_index, l3_index,voq_index, cos,se_elem, flags, flags2;
    unsigned int uflags;
        ...
        for (l4_index = 0; l4_index < L4_NUM_ELEMENTS; l4_index++) {
			...
			/* attach VOQ connector to level 2 CL */
                    ...
                    */
                    ...
                    BCM_GPORT_UNICAST_QUEUE_GROUP_CORE_QUEUE_SET(gvoq_base, 0,
