...
int cint_jer_test_coe_fc_port_rec_set_example(int unit, int is_oob, int calendar_port, int calendar_idx, int target_port)
{
    int rv = BCM_E_NONE;
...
int cint_jer_test_coe_fc_port_rec_unset_example(int unit, int is_oob, int calendar_port, int calendar_idx, int target_port)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception_port; 
    bcm_cosq_fc_endpoint_t fc_target;
