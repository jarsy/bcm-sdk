...
int vxlan_example(int unit, int in_port, int out_port, int vpn_id){
    ...
    rv = ipv4_tunnel_build_tunnels(unit, in_port, out_tunnel_intf_ids,out_tunnel_gports, &ll_encap_id);
    if (rv != BCM_E_NONE) {
    ...
    if (g_vxlan.dip_sip_vrf_using_my_vtep_index_mode) {
        ...
        ip_tunnel_term_open_route_interfaces(unit, in_port, out_port, ip_tunnel_term_glbl_info.rif_vrf, 
        ...
        vxlan_port_id[0] = vxlan_port_add.vxlan_port_id; 
