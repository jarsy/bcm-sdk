...
struct falcon_furia_madura_uc_lane_config_field_st {
...
struct falcon_furia_madura_uc_core_config_field_st {
  uint8_t  vco_rate          ;
...
/** Lane Config Struct */
struct  falcon_furia_madura_uc_lane_config_st {
  struct falcon_furia_madura_uc_lane_config_field_st field;  
  uint16_t word;                       
}; 

/** Core Config Struct */
struct  falcon_furia_madura_uc_core_config_st {
  struct falcon_furia_madura_uc_core_config_field_st field; 
  uint16_t word;         
};

/** Eyescan Options Struct */
struct falcon_furia_madura_eyescan_options_st {
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors) 
 */
err_code_t falcon_furia_madura_get_uc_core_config( const phymod_access_t *pa, struct falcon_furia_madura_uc_core_config_st *struct_val);
...
/** Column definition header for falcon_furia_madura_display_core_state() API output.
 * To be called before falcon_furia_madura_display_core_state_line() API. 
 ...
 * Call falcon_furia_madura_display_core_state_hdr() API before and falcon_furia_madura_display_core_state_legend() after 
...
/** Detailed description of each column in falcon_furia_madura_display_core_state_line() API output.
 * To be called after falcon_furia_madura_display_core_state_line() API to display the legends. 
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors) 
 */
 ...
 * Note: falcon_furia_madura_tx_shared_patt_gen_en() API should be called to enable the Pattern generator for that particular lane.
 ...
 * Note: User also needs to configure all lanes through falcon_furia_madura_lane_config_for_iddq()
 ...
 * Along with falcon_furia_madura_core_pwrdn(), all lanes powerdowns should also be issued using 
 * falcon_furia_madura_lane_pwrdn() to complete a Core Powerdown. 
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors) 
 */
err_code_t falcon_furia_madura_get_uc_lane_cfg( const phymod_access_t *pa, struct falcon_furia_madura_uc_lane_config_st *struct_val);
 ...
 * It relies on the accuracy of falcon_furia_madura_delay_us() function. \n\n
 ...
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors) 
 */
err_code_t falcon_furia_madura_meas_eye_density_data(const struct falcon_furia_madura_eyescan_options_st eyescan_options, int32_t *buffer,uint16_t *buffer_size);

/** Displays Eye Density Data measured with falcon_furia_madura_meas_eye_density_data().
 *  
 * The recommended settings are:    \n
 *  eyescan_options.horz_max = 31;  \n
 *  eyescan_options.horz_min = -31; \n
 ...
 * @param eyescan_options is structure of options which control min, max, step, time, and linerate
 * @param *buffer is pointer to array which contains all samples.
 * @param buffer_size must provide buffer_size which is returned from falcon_furia_madura_meas_eye_density_data()
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors) 
 */
err_code_t falcon_furia_madura_display_eye_density_data(const struct falcon_furia_madura_eyescan_options_st eyescan_options, int32_t *buffer,uint16_t buffer_size);

/** Start uC controller eye scan Function.
 * Eye scan function provides a stripe of data at a time either vertical or horizontal.
 * This function only initiates the processor actions.  User must use falcon_furia_madura_read_eye_scan_stripe() function
 ...
 * falcon_furia_madura_start_ber_scan_test(), falcon_furia_madura_read_ber_scan_data(), falcon_furia_madura_display_ber_scan_data().
 *
 * @param rate specifies the data rate in Hz
 * @param ber_scan_mode the type of test used to take the data(use #srds_diag_ber_mode_enum)
 * @param timer_control sets the total test time in units of ~1.31 seconds
 ...
 * \n Note: Call functions falcon_furia_madura_display_lane_state_hdr() before and falcon_furia_madura_display_lane_state_legend() after 
...
/** Column definition header for falcon_furia_madura display state.
 * To be called before falcon_furia_madura_display_lane_state() function. 
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors) 
 */
err_code_t falcon_furia_madura_display_lane_state_hdr( const phymod_access_t *pa );

/** Detailed explanation of each column in falcon_furia_madura display state.
 * To be called after falcon_furia_madura_display_lane_state() function to display the legends. 
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors) 
 */
 ...
 * RX Adaptation needs to be stopped before modifying any of the VGA, PF or DFE taps.
 * To resume RX adaptation, use the falcon_furia_madura_stop_rx_adaptation() API.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors) 
 */
 ...
 * Note: The patt_length input to the function should be the value sent to the falcon_furia_madura_config_shared_tx_pattern() function
 * @param enable Enable shared fixed pattern generator (1 = Enable; 0 = Disable)
 * @param patt_length length of the pattern used in falcon_furia_madura_config_shared_tx_pattern()
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */ 
 ...
 * Once the PRBS generator is configured, to enable PRBS use the falcon_furia_madura_tx_prbs_en() API.
 ...
 * Once the PRBS checker is configured, use the falcon_furia_madura_rx_prbs_en() API to enable the checker.
 ...
 * Note: User needs to configure all lanes through falcon_furia_madura_lane_config_for_iddq() and also call falcon_furia_madura_core_config_for_iddq() 
 * before enabling IDDQ by asserting IDDQ pin.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors) 
 */
