 ...
 * (http://ingbu.broadcom.com/hsip/falcon16_tsc/SerDes%20Documents/PMD_Methodology/Serdes%20External%20Micro%20User%20Guide.docx)
 * \n \n
 *
 * \section API_sec Important API Files
 *
 * falcon16_tsc_interface.h - provides the primary functionality.
 *
 * falcon16_tsc_dependencies.h - defines the functions to be provided by the IP user
 *
 * \n \n
 * Copyright 2014 Broadcom Corporation all rights reserved
 */

/** @file falcon16_tsc_interface.h
 * Main interface functions provided to IP User
 */

#ifndef FALCON16_TSC_API_INTERFACE_H
#define FALCON16_TSC_API_INTERFACE_H

#include "falcon16_tsc_access.h"
#include "falcon16_tsc_config.h"
#include "falcon16_tsc_debug_functions.h"
#include "falcon16_tsc_diag.h"
#include "falcon16_tsc_prbs.h"
#include "falcon16_tsc_pwr_mgt.h"
