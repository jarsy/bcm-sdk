/**************************************************************************************
 **************************************************************************************
 *  File Name     :  falcon16_tsc_field_access.h                                        *
...
/** @file falcon16_tsc_field_access.h
 * Registers and field access
 */

#ifndef FALCON16_TSC_API_FIELD_ACCESS_H
#define FALCON16_TSC_API_FIELD_ACCESS_H
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _falcon16_tsc_pmd_rdt_field_byte(srds_access_t *sa__, uint16_t addr, uint8_t shift_left, uint8_t shift_right, uint8_t *val_p);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t _falcon16_tsc_pmd_rdt_field_signed_byte(srds_access_t *sa__, uint16_t addr, uint8_t shift_left, uint8_t shift_right, int8_t *val_p);
