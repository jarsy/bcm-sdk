...
/** @file falcon16_tsc_prbs.h
 * PRBS test functions provided to IP User
 */

#ifndef FALCON16_TSC_API_PRBS_H
#define FALCON16_TSC_API_PRBS_H
 ...
 * Note: falcon16_tsc_tx_shared_patt_gen_en() API should be called to enable the Pattern generator for that particular lane.
 ...
 * Note: The patt_length input to the function should be the value sent to the falcon16_tsc_config_shared_tx_pattern() function
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param enable Enable shared fixed pattern generator (1 = Enable; 0 = Disable)
 * @param patt_length length of the pattern used in falcon16_tsc_config_shared_tx_pattern()
 ...
 * Once the PRBS generator is configured, to enable PRBS use the falcon16_tsc_tx_prbs_en() API.
 * @param sa__ is an opaque state vector passed through to device access functions.
 ...
 * Once the PRBS checker is configured, use the falcon16_tsc_rx_prbs_en() API to enable the checker.
 * @param sa__ is an opaque state vector passed through to device access functions.
