...
uint16_t falcon16_tsc_pmd_rd_reg(srds_access_t *sa__, uint16_t address){
...
err_code_t falcon16_tsc_pmd_rdt_reg(const phymod_access_t *pa, uint16_t address, uint16_t *val) {
    uint32_t data;
...
err_code_t falcon16_tsc_uc_lane_idx_to_system_id(srds_access_t *sa__, char string[16], uint8_t uc_lane_idx){
