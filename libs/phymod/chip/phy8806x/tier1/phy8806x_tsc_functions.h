/****************************************************************************
* File Name  :  phy8806x_tsc_functions.h
* Created On :  29/04/2013
* Created By :  Kiran Divakar
* Description:  Header file with API functions for Serdes IPs
* Revision   :  $Id: phy8806x_tsc_functions.h 1282 2015-12-04 12:20:52Z eroes $
*
...
#ifndef PHY8806X_TSC_API_FUNCTIONS_H
#define PHY8806X_TSC_API_FUNCTIONS_H
 ...
 */
#define _error(err_code) _print_err_msg(pa, err_code)
...
/**
 * This build includes register access macros for the FALCON2/MT2 core.
 */
 ...
 * variables.
 */
#include "phy8806x_tsc_uc_vars_rdwr_defns.h"
 ...
 * either case, execution should not be allowed to proceed on NULL return.
 */
#define ENULL_STRNCAT(dst, src) ENULL((USR_STRNCAT((dst), (src), USR_STRLEN(src))))
 ...
 * either case, execution should not be allowed to proceed on NULL return.
 */
#define EPNULL_STRNCAT(dst, src) EPNULL((USR_STRNCAT((dst), (src), USR_STRLEN(src))))
