...
*****************************************************************************************
*                                                                                       *
*  Revision      :  $Id: phy8806x_tsc_debug_functions.h 1337 2016-02-04 00:15:32Z kirand $ *
*                                                                                       *
...
struct phy8806x_tsc_usr_ctrl_dfe_func_st {
...
struct phy8806x_tsc_usr_ctrl_disable_functions_st {
	struct phy8806x_tsc_usr_ctrl_func_st field;
	uint16_t word;
};

/** Lane User Control Disable DFE Function Struct */
struct phy8806x_tsc_usr_ctrl_disable_dfe_functions_st {
	struct phy8806x_tsc_usr_ctrl_dfe_func_st field;
	uint8_t byte;
};

/** Falcon Lane status Struct */
struct phy8806x_tsc_detailed_lane_status_st {
 ...
 * See phy8806x_tsc_tdt_char(...) implementation.
 ...
 */
err_code_t phy8806x_tsc_meas_eye_density_data(const struct phy8806x_tsc_eyescan_options_st eyescan_options, int32_t *buffer, uint16_t *buffer_size);

/** Displays Eye Density Data measured with phy8806x_tsc_meas_eye_density_data().
 *
 * The recommended settings are:    \n
 *  eyescan_options.horz_max = 31;  \n
 *  eyescan_options.horz_min = -31; \n
 ...
 * @param buffer_size must provide buffer_size which is returned from phy8806x_tsc_meas_eye_density_data()
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors)
 */
err_code_t phy8806x_tsc_display_eye_density_data(const struct phy8806x_tsc_eyescan_options_st eyescan_options, int32_t *buffer, uint16_t buffer_size);
 ...
 * Note: Stop the microcode [use phy8806x_tsc_stop_rx_adaptation()] before using this API
 ...
 */
uint8_t phy8806x_tsc_rdbl_uc_var (const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */
uint16_t phy8806x_tsc_rdwl_uc_var (const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */
int8_t phy8806x_tsc_rdbls_uc_var (const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */
int16_t phy8806x_tsc_rdwls_uc_var (const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t phy8806x_tsc_rdbc_uc_var (const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t phy8806x_tsc_rdwc_uc_var (const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t phy8806x_tsc_rdbcs_uc_var (const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t phy8806x_tsc_rdwcs_uc_var (const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
...
/** Reads current pmd lane status and populates the provided structure of type #phy8806x_tsc_detailed_lane_status_st.
 * @param pa phymod_access_t struct
...
/** Displays the lane status stored in the input struct of type #phy8806x_tsc_detailed_lane_status_st.
 * @param pa phymod_access_t struct
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t phy8806x_tsc_rdw_uc_ram (const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t phy8806x_tsc_rdb_uc_ram (const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t phy8806x_tsc_rdws_uc_ram (const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t phy8806x_tsc_rdbs_uc_ram (const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
