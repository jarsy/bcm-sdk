...
__phymod__dispatch__t__ phymod_tscf_driver = {
    ...
    tscf_phy_eye_margin_est_get,
    NULL, /* phymod_phy_multi_get */
    NULL, /* phymod_phy_rescal_set */
    NULL, /* phymod_phy_rescal_get */
    tscf_phy_sw_an_control_status_get,
    tscf_phy_sw_an_base_page_exchange_handler,
    tscf_phy_sw_an_lp_page_rdy_handler,
    tscf_phy_sw_an_advert_set,
    tscf_phy_sw_autoneg_enable,
};
