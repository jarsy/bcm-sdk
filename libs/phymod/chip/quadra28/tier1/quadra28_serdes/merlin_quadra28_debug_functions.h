 ...
 *****************************************************************************************
 *                                                                                       *
 *  Revision      :  $Id: merlin_quadra28_debug_functions.h 924 2015-02-24 18:08:11Z eroes $ *
 *                                                                                       *
...
/** @file merlin_quadra28_debug_functions.h
 * Functions used internally and available in debug shell only
 */

#ifndef MERLIN_QUADRA28_DEBUG_FUNCTIONS_H
#define MERLIN_QUADRA28_DEBUG_FUNCTIONS_H
...
struct merlin_quadra28_usr_ctrl_func_st {
...
struct merlin_quadra28_usr_ctrl_dfe_func_st {
...
struct merlin_quadra28_usr_ctrl_disable_functions_st {
  struct merlin_quadra28_usr_ctrl_func_st field;
  uint8_t  byte;
};

/** Lane User Control Disable DFE Function Struct */
struct merlin_quadra28_usr_ctrl_disable_dfe_functions_st {
  struct merlin_quadra28_usr_ctrl_dfe_func_st field;
  uint8_t  byte;
};
 ...
 */
uint8_t merlin_quadra28_rdbl_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */
uint16_t merlin_quadra28_rdwl_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */
int8_t merlin_quadra28_rdbls_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */
int16_t merlin_quadra28_rdwls_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t merlin_quadra28_rdbc_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t merlin_quadra28_rdwc_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t merlin_quadra28_rdbcs_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t merlin_quadra28_rdwcs_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
