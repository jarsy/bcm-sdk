 ...
 **************************************************************************************
 *                                                                                    *
 *  Revision      :  $Id: merlin_quadra28_dependencies.h 947 2015-03-06 21:11:44Z kirand $ *
 *                                                                                    *
...
/** @file merlin_quadra28_dependencies.h
 * Dependencies to be provided by IP User
 */

#ifndef MERLIN_QUADRA28_API_DEPENDENCIES_H
#define MERLIN_QUADRA28_API_DEPENDENCIES_H
 ...
 * If using Serdes MDIO controller to access the registers, implement this function using merlin_quadra28_pmd_mdio_mwr_reg(..)
 *
 * If NOT using a Serdes MDIO controller or the Serdes PMI Masked write feature, please use the following code to
 * implement this function
 *
 *    merlin_quadra28_pmd_wr_reg(const phymod_access_t *pa,addr, ((merlin_quadra28_pmd_rd_reg(addr) & ~mask) | (mask & (val << lsb))));
 *
 ...
 */
int quadra28_logger_write(int message_verbose_level, const char *format, ...);
 ...
 * @return Error code generated by delay function (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_quadra28_delay_ms(uint32_t delay_ms);
...
typedef struct {
    ...
    /** Number of Lanes */
    uint8_t   num_lanes;
} merlin_quadra28_uc_lane_info_st;
...
* @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
*/
err_code_t merlin_quadra28_get_uc_ln_info(const phymod_access_t *pa, merlin_quadra28_uc_lane_info_st *ext_uc_lane_info);
