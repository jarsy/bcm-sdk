 ...
 *****************************************************************************************
 *                                                                                       *
 *  Revision      :  $Id: falcon2_dino_debug_functions.h 1356 2016-02-12 23:27:16Z cvazquez $ *
 *                                                                                       *
...
/** @file falcon2_dino_debug_functions.h
 * Functions used internally and available in debug shell only
 */

#ifndef FALCON2_DINO_DEBUG_FUNCTIONS_H
#define FALCON2_DINO_DEBUG_FUNCTIONS_H
...
struct falcon2_dino_usr_ctrl_func_st {
...
struct falcon2_dino_usr_ctrl_dfe_func_st {
...
struct falcon2_dino_usr_ctrl_disable_functions_st {
  struct falcon2_dino_usr_ctrl_func_st field;
  uint16_t word;
};

/** Lane User Control Disable DFE Function Struct */
struct falcon2_dino_usr_ctrl_disable_dfe_functions_st {
  struct falcon2_dino_usr_ctrl_dfe_func_st field;
  uint8_t  byte;
};

/** Falcon Lane status Struct */
struct falcon2_dino_detailed_lane_status_st {
 ...
 */
err_code_t falcon2_dino_meas_eye_density_data(const struct falcon2_dino_eyescan_options_st eyescan_options, int32_t *buffer,uint16_t *buffer_size);

/** Displays Eye Density Data measured with falcon2_dino_meas_eye_density_data().
 *
 * The recommended settings are:    \n
 *  eyescan_options.horz_max = 31;  \n
 *  eyescan_options.horz_min = -31; \n
 ...
 * @param buffer_size must provide buffer_size which is returned from falcon2_dino_meas_eye_density_data()
 * @return Error Code during data collection (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon2_dino_display_eye_density_data(const struct falcon2_dino_eyescan_options_st eyescan_options, int32_t *buffer,uint16_t buffer_size);
 ...
 * Note: Stop the microcode [use falcon2_dino_stop_rx_adaptation()] before using this API
 ...
 */
uint8_t falcon2_dino_rdbl_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */
uint16_t falcon2_dino_rdwl_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */
int8_t falcon2_dino_rdbls_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 */
int16_t falcon2_dino_rdwls_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t falcon2_dino_rdbc_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t falcon2_dino_rdwc_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t falcon2_dino_rdbcs_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t falcon2_dino_rdwcs_uc_var( const phymod_access_t *pa, err_code_t *err_code, uint8_t addr);
...
/** Reads current pmd lane status and populates the provided structure of type #falcon2_dino_detailed_lane_status_st.
...
/** Displays the lane status stored in the input struct of type #falcon2_dino_detailed_lane_status_st.
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t falcon2_dino_rdw_uc_ram( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t falcon2_dino_rdb_uc_ram( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t falcon2_dino_rdws_uc_ram( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t falcon2_dino_rdbs_uc_ram( const phymod_access_t *pa, err_code_t *err_code, uint16_t addr);
