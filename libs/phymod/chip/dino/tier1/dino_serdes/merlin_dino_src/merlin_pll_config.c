 ...
 *  Revision      :  $Id: merlin_pll_config.c 1263 2015-11-19 19:49:45Z jgaither $ *
 *                                                                              *
...
static err_code_t merlin_dino_configure_pll_ctrl_bus( const phymod_access_t *pa, enum merlin_dino_pll_enum pll_cfg);
...
err_code_t merlin_dino_configure_pll( const phymod_access_t *pa, enum merlin_dino_pll_enum pll_cfg) {
 ...
 /* Use core_s_rstb to re-initialize all registers to default before calling this function. */
    ...
    if(reset_state < 7) {
        EFUN_PRINTF(("ERROR: merlin_dino_configure_pll( pa, ..) called without core_dp_s_rstb=0\n"));
    ...
    case MERLIN_DINO_pll_8p5GHz_106p25MHz:       /* i_pll_ctrl[63:59] div<4:0> =  1100 */
    ...
    case MERLIN_DINO_pll_10GHz_125MHz:           /* i_pll_ctrl[63:59] div<4:0> =  1100 */
        EFUN(wrc_ams_pll_mmd_en               (   0x0));   /* 0x4c58[13:13] */
        EFUN(wrc_ams_pll_div                  (   0xC));   /* 0x6106[15:11] */
        break;

    case MERLIN_DINO_pll_11p181GHz_174p703MHz:
    case MERLIN_DINO_pll_10GHz_156p25MHz:        /* i_pll_ctrl[63:59] div<4:0> =   100 */
        EFUN(wrc_ams_pll_mmd_en               (   0x0));   /* 0x4c44[13:13] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
        break;

    case MERLIN_DINO_pll_10p3125GHz_156p25MHz:   /* i_pll_ctrl[63:59] div<4:0> = 10100 */
        EFUN(wrc_ams_pll_mmd_en               (   0x0));   /* 0x5036[13:13] */
        EFUN(wrc_ams_pll_div                  (  0x14));   /* 0xa106[15:11] */
        break;

    case MERLIN_DINO_pll_9p375GHz_156p25MHz:     /* i_pll_ctrl[63:59] div<4:0> = 11100 */
 ...
 /* case MERLIN_DINO_pll_10GHz_50MHz:          *//* i_pll_ctrl[63:59] div<4:0> =    10 */
 /*     EFUN(wrc_ams_pll_mmd_en               (   0x0));     0x4000[13:13] */
 /*     EFUN(wrc_ams_pll_div                  (   0x2));     0x1106[15:11] */
 /*     break;                                                    */

    case MERLIN_DINO_pll_9p375GHz_50MHz:         /* i_pll_ctrl[63:59] div<4:0> = 11010 */
        EFUN(wrc_ams_pll_mmd_en               (   0x0));   /* 0x4cce[13:13] */
        EFUN(wrc_ams_pll_div                  (  0x1A));   /* 0xd106[15:11] */
        break;

    case MERLIN_DINO_pll_10p3125GHz_161p132MHz:  /* i_pll_ctrl[63:59] div<4:0> = 001XX */
        EFUN(wrc_ams_pll_mmd_en               (   0x0));   /* 0x5036[13:13] */
    ...
    case MERLIN_DINO_pll_10p3125GHz_125MHz:      /* Divider value 82.5      */
    ...
    case MERLIN_DINO_pll_10p709GHz_125MHz:       /* Divider value 85.672    */
    ...
    case MERLIN_DINO_pll_10p7545GHz_125MHz:      /* Divider value 86.036    */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5202[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
    ...
    case MERLIN_DINO_pll_10p9375GHz_125MHz:      /* Divider value 87.5      */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5202[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
        EFUN(wrc_ams_pll_mmd_en               (   0x1));   /* 0x6c56[13:13] */
        EFUN(wrc_ams_pll_mmd_prsc4or5pwdb     (   0x0));   /* 0x6c56[12:12] */
    ...
    case MERLIN_DINO_pll_11p049GHz_125MHz:       /* Divider value 88.392    */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5202[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
    ...
    case MERLIN_DINO_pll_11p095GHz_125MHz:       /* Divider value 88.76     */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5200[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
    ...
    case MERLIN_DINO_pll_11p14273GHz_125MHz:     /* Divider value 89.14184  */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5202[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
        EFUN(wrc_ams_pll_mmd_en               (   0x1));   /* 0x6c59[13:13] */
        EFUN(wrc_ams_pll_mmd_prsc4or5pwdb     (   0x0));   /* 0x6c59[12:12] */
    ...
    case MERLIN_DINO_pll_11p181GHz_125MHz:       /* Divider value 89.448    */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5202[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
    ...
    case MERLIN_DINO_pll_11p25GHz_125MHz:        /* Divider value 90        */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5202[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
        EFUN(wrc_ams_pll_mmd_en               (   0x1));   /* 0x6c59[13:13] */
        EFUN(wrc_ams_pll_mmd_prsc4or5pwdb     (   0x0));   /* 0x6c59[12:12] */
    ...
    case MERLIN_DINO_pll_11p45863GHz_125MHz:     /* Divider value 91.66904  */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5202[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
        EFUN(wrc_ams_pll_mmd_en               (   0x1));   /* 0x6c52[13:13] */
        EFUN(wrc_ams_pll_mmd_prsc4or5pwdb     (   0x0));   /* 0x6c52[12:12] */
    ...
    case MERLIN_DINO_pll_8p5GHz_125MHz:          /* Divider value 68        */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5202[ 0: 0] */
        EFUN(wrc_ams_pll_en_8p5g              (   0x1));
        EFUN(wrc_ams_pll_en_8p5g_vco          (   0x1));
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
    ...
    case MERLIN_DINO_pll_9p375GHz_125MHz:        /* Divider value 75        */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5202[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
    ...
    case MERLIN_DINO_pll_10p709GHz_156p25MHz:    /* Divider value 68.5376   */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5200[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
    ...
    case MERLIN_DINO_pll_10p7545GHz_156p25MHz:   /* Divider value 68.8288   */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5200[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
    ...
    case MERLIN_DINO_pll_10p9375GHz_156p25MHz:   /* Divider value 70        */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5202[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
    ...
    case MERLIN_DINO_pll_11p049GHz_156p25MHz:    /* Divider value 70.7136   */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5200[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
        EFUN(wrc_ams_pll_mmd_en               (   0x1));   /* 0x6000[13:13] */
        EFUN(wrc_ams_pll_mmd_prsc4or5pwdb     (   0x0));   /* 0x6000[12:12] */
    ...
    case MERLIN_DINO_pll_11p095GHz_156p25MHz:    /* Divider value 71.008    */
    ...
    case MERLIN_DINO_pll_11p14273GHz_156p25MHz:  /* Divider value 71.31344  */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5202[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
        EFUN(wrc_ams_pll_mmd_en               (   0x1));   /* 0x6c44[13:13] */
        EFUN(wrc_ams_pll_mmd_prsc4or5pwdb     (   0x0));   /* 0x6c44[12:12] */
    ...
    case MERLIN_DINO_pll_11p181GHz_156p25MHz:    /* Divider value 71.5584   */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5200[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
        EFUN(wrc_ams_pll_mmd_en               (   0x1));   /* 0x6000[13:13] */
        EFUN(wrc_ams_pll_mmd_prsc4or5pwdb     (   0x0));   /* 0x6000[12:12] */
    ...
    case MERLIN_DINO_pll_11p25GHz_156p25MHz:     /* Divider value 72        */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5200[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
        EFUN(wrc_ams_pll_mmd_en               (   0x1));   /* 0x6000[13:13] */
        EFUN(wrc_ams_pll_mmd_prsc4or5pwdb     (   0x0));   /* 0x6000[12:12] */
    ...
    case MERLIN_DINO_pll_11p45863GHz_156p25MHz:  /* Divider value 73.335232 */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5202[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
    ...
    case MERLIN_DINO_pll_11p5GHz_156p25MHz:      /* Divider value 73.6      */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5200[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
    ...
    case MERLIN_DINO_pll_8p5GHz_156p25MHz:       /* Divider value 54.4      */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5200[ 0: 0] */
       EFUN(wrc_ams_pll_en_8p5g              (   0x1));
       EFUN(wrc_ams_pll_en_8p5g_vco          (   0x1));
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
    ...
    case MERLIN_DINO_pll_10GHz_161p132MHz:       /* Divider value 62.060919 */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5204[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
    ...
    case MERLIN_DINO_pll_10p709GHz_161p132MHz:   /* Divider value 66.461038 */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5204[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
    ...
    case MERLIN_DINO_pll_10p7545GHz_161p132MHz:  /* Divider value 66.743415 */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5202[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
    ...
    case MERLIN_DINO_pll_10p9375GHz_161p132MHz:  /* Divider value 67.87913  */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5204[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
        EFUN(wrc_ams_pll_mmd_en               (   0x1));   /* 0x7042[13:13] */
    ...
    case MERLIN_DINO_pll_11p049GHz_161p132MHz:   /* Divider value 68.571109 */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5202[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
        EFUN(wrc_ams_pll_mmd_en               (   0x1));   /* 0x6c44[13:13] */
        EFUN(wrc_ams_pll_mmd_prsc4or5pwdb     (   0x0));   /* 0x6c44[12:12] */
    ...
    case MERLIN_DINO_pll_11p095GHz_161p132MHz:   /* Divider value 68.85659  */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5202[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
        EFUN(wrc_ams_pll_mmd_en               (   0x1));   /* 0x6c45[13:13] */
    ...
    case MERLIN_DINO_pll_11p14273GHz_161p132MHz: /* Divider value 69.152806 */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5202[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
    ...
    case MERLIN_DINO_pll_11p181GHz_161p132MHz:   /* Divider value 69.390314 */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5204[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
    ...
    case MERLIN_DINO_pll_11p25GHz_161p132MHz:    /* Divider value 69.818534 */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5204[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
        EFUN(wrc_ams_pll_mmd_en               (   0x1));   /* 0x703e[13:13] */
        EFUN(wrc_ams_pll_mmd_prsc4or5pwdb     (   0x0));   /* 0x603e[12:12] */
    ...
    case MERLIN_DINO_pll_11p45863GHz_161p132MHz: /* Divider value 71.113311 */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5204[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
        EFUN(wrc_ams_pll_mmd_en               (   0x1));   /* 0x7040[13:13] */
    ...
    case MERLIN_DINO_pll_8p5GHz_161p132MHz:      /* Divider value 52.751781 */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5202[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
       EFUN(wrc_ams_pll_en_8p5g              (   0x1));
       EFUN(wrc_ams_pll_en_8p5g_vco          (   0x1));
    ...
    case MERLIN_DINO_pll_9p375GHz_161p132MHz:    /* Divider value 58.182112 */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5202[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
        EFUN(wrc_ams_pll_mmd_en               (   0x1));   /* 0x6c44[13:13] */
    ...
    case MERLIN_DINO_pll_10GHz_50MHz:            /* Divider value 200       */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5200[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
        EFUN(wrc_ams_pll_mmd_en               (   0x1));   /* 0x6000[13:13] */
        EFUN(wrc_ams_pll_mmd_prsc4or5pwdb     (   0x0));   /* 0x6000[12:12] */
    ...
    case MERLIN_DINO_pll_10p3125GHz_50MHz:       /* Divider value 206.25    */
        EFUN(wrc_ams_pll_mmd_resetb           (   0x0));   /* 0x5200[ 0: 0] */
        EFUN(wrc_ams_pll_div                  (   0x4));   /* 0x2106[15:11] */
     ...
     */
    return merlin_dino_configure_pll_ctrl_bus( pa, pll_cfg);
}
...
static err_code_t merlin_dino_configure_pll_ctrl_bus( const phymod_access_t *pa, enum merlin_dino_pll_enum pll_cfg)
{
    ...
    case MERLIN_DINO_pll_11p049GHz_156p25MHz   : /* Divider value 70.7136   */
    case MERLIN_DINO_pll_11p095GHz_156p25MHz   : /* Divider value 71.008    */
    case MERLIN_DINO_pll_11p14273GHz_156p25MHz : /* Divider value 71.313472 */
    case MERLIN_DINO_pll_11p181GHz_156p25MHz   : /* Divider value 71.5584   */
    case MERLIN_DINO_pll_11p45863GHz_156p25MHz : /* Divider value 73.335232 */
    case MERLIN_DINO_pll_11p5GHz_156p25MHz     : /* Divider value 73.6      */
    case MERLIN_DINO_pll_8p5GHz_156p25MHz      : /* Divider value 54.4      */
    case MERLIN_DINO_pll_10GHz_161p132MHz      : /* Divider value 62.060919 */
    case MERLIN_DINO_pll_10p3125GHz_161p132MHz : /* Divider value 64.000323 */
    case MERLIN_DINO_pll_10p709GHz_161p132MHz  : /* Divider value 66.461038 */
    case MERLIN_DINO_pll_10p7545GHz_161p132MHz : /* Divider value 66.743415 */
    case MERLIN_DINO_pll_10p9375GHz_161p132MHz : /* Divider value 67.87913  */
    case MERLIN_DINO_pll_11p049GHz_161p132MHz  : /* Divider value 68.571109 */
...
} /* merlin_dino_configure_pll_ctrl_bus */
