 ...
 ***********************************************************************************
 *                                                                                 *
 *  Revision    :  $Id: merlin_dino_interface.h 1356 2016-02-12 23:27:16Z cvazquez $   *
 *                                                                                 *
 ...
 * (http://ingbu.broadcom.com/hsip/merlin_dino/SerDes%20Documents/PMD_Methodology/Serdes%20External%20Micro%20User%20Guide.docx)
 * \n \n
 *
 * \section API_sec Important API Files
 *
 * merlin_dino_interface.h - provides the primary functionality.
 *
 * merlin_dino_dependencies.h - defines the functions to be provided by the IP user
 *
 * \n \n
 * Copyright 2014 Broadcom Corporation all rights reserved
 */

/** @file merlin_dino_interface.h
 * Main interface functions provided to IP User
 */

#ifndef MERLIN_DINO_API_INTERFACE_H
#define MERLIN_DINO_API_INTERFACE_H
...
struct merlin_dino_uc_lane_config_field_st {
...
struct merlin_dino_uc_core_config_field_st {
...
/** Lane Config Struct */
struct  merlin_dino_uc_lane_config_st {
  struct merlin_dino_uc_lane_config_field_st field;
  uint16_t word;
};

/** Core Config Struct */
struct  merlin_dino_uc_core_config_st {
  struct merlin_dino_uc_core_config_field_st field;
  uint16_t word;
  int vco_rate_in_Mhz; /* if >0 then will get converted and replace field.vco_rate when update is called */
};

/** Eyescan Options Struct */
struct merlin_dino_eyescan_options_st {
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_dino_get_uc_core_config( const phymod_access_t *pa, struct merlin_dino_uc_core_config_st *struct_val);
...
/** Column definition header for merlin_dino_display_core_state() API output.
 * To be called before merlin_dino_display_core_state_line() API.
 ...
 * Call merlin_dino_display_core_state_hdr() API before and merlin_dino_display_core_state_legend() after
...
/** Detailed description of each column in merlin_dino_display_core_state_line() API output.
 * To be called after merlin_dino_display_core_state_line() API to display the legends.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * \n Note: Micro should be loaded only after issuing a merlin_dino_uc_reset(1) followed by asserting and de-asserting
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculaion [merlin_dino_ucode_crc_verify()] and verifying the CRC value [merlin_dino_start_ucode_crc_calc()].
 * @param ucode_len Length of Microcode Image (number of bytes)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculation [merlin_dino_ucode_crc_verify()] and verifying the CRC value [merlin_dino_start_ucode_crc_calc()].
 * @param expected_crc_value Expected CRC value of the microcode
 ...
 * Note: merlin_dino_tx_shared_patt_gen_en() API should be called to enable the Pattern generator for that particular lane.
 ...
 * Note: User also needs to configure all lanes through merlin_dino_lane_config_for_iddq()
 ...
 * Along with merlin_dino_core_pwrdn(), all lanes powerdowns should also be issued using
 * merlin_dino_lane_pwrdn() to complete a Core Powerdown.
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_dino_get_uc_lane_cfg( const phymod_access_t *pa, struct merlin_dino_uc_lane_config_st *struct_val);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_dino_configure_pll( const phymod_access_t *pa, enum merlin_dino_pll_enum pll_cfg);
 ...
 */
err_code_t merlin_dino_config_tx_hpf( const phymod_access_t *pa, uint8_t hpf_val);
 ...
 * @return Error Code generated by invalid settings (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_dino_rd_tx_hpf_config( const phymod_access_t *pa, uint8_t *hpf_val);
 ...
 * It relies on the accuracy of merlin_dino_delay_us() function. \n\n
 ...
 * This function only initiates the processor actions.  User must use merlin_dino_read_eye_scan_stripe() function
 ...
 * merlin_dino_start_ber_scan_test(), merlin_dino_read_ber_scan_data(), merlin_dino_display_ber_scan_data().
 *
 * @param rate specifies the data rate in Hz
 * @param ber_scan_mode the type of test used to take the data(use #srds_diag_ber_mode_enum)
 * @param timer_control sets the total test time in units of ~1.31 seconds
 ...
 * \n Note: Call functions merlin_dino_display_lane_state_hdr() before and merlin_dino_display_lane_state_legend() after
 * to get a formatted lane state display with legend
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_dino_display_lane_state( const phymod_access_t *pa );

/** Column definition header for merlin_dino display state.
 * To be called before merlin_dino_display_lane_state() function.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin_dino_display_lane_state_hdr( const phymod_access_t *pa );

/** Detailed explanation of each column in merlin_dino display state.
 * To be called after merlin_dino_display_lane_state() function to display the legends.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function is required to be implemented by upper level software to enable merlin_dino support.
...
/** Parameterized diagnostic function which access to all merlin_dino control and status bits
 * This function is required to be implemented by upper level software to enable merlin_dino support.
 ...
 * RX Adaptation needs to be stopped before modifying any of the VGA, PF or DFE taps.
 * To resume RX adaptation, use the merlin_dino_stop_rx_adaptation() API.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Note: The patt_length input to the function should be the value sent to the merlin_dino_config_shared_tx_pattern() function
 * @param enable Enable shared fixed pattern generator (1 = Enable; 0 = Disable)
 * @param patt_length length of the pattern used in merlin_dino_config_shared_tx_pattern()
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Once the PRBS generator is configured, to enable PRBS use the merlin_dino_tx_prbs_en() API.
 ...
 * Once the PRBS checker is configured, use the merlin_dino_rx_prbs_en() API to enable the checker.
 ...
 * Note: User needs to configure all lanes through merlin_dino_lane_config_for_iddq() and also call merlin_dino_core_config_for_iddq()
 * before enabling IDDQ by asserting IDDQ pin.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * If you want loop timing use merlin_dino_rmt_lpbk()
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function should be called prior to merlin_dino_rptr_mode_timing();
 * @param enable Enable/Disable (1 = Enable; 0 = Disable)
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
