...
/** @file merlin16_internal.h
 * Internal API functions
 */

#ifndef MERLIN16_API_INTERNAL_H
#define MERLIN16_API_INTERNAL_H
...
typedef struct {
  ...
  /** PLL Divider value.  (Same encoding as enum merlin16_pll_div_enum.) */
  uint32_t pll_div;
  /** PLL Lock */
  uint8_t  pll_lock;
...
/** Verify the internal merlin16_info.
...
/** Return whether the fraction portion of a merlin16_pll_div_enum value is nonzero. */
#define SRDS_INTERNAL_IS_PLL_DIV_FRACTIONAL(div_) (((uint32_t)(div_) & 0xFFFFF000UL) != 0)

/** Extract the integer portion of a merlin16_pll_div_enum value. */
#define SRDS_INTERNAL_GET_PLL_DIV_INTEGER(div_) (((uint32_t)(div_)) & 0x00000FFFUL)

/** Extract the fraction portion of a merlin16_pll_div_enum value.
...
/** Compose a value in the same format as a merlin16_pll_div_enum value.
 ...
 * @param refclk Reference clock frequency (enumerated), or MERLIN16_PLL_REFCLK_UNKNOWN to auto-compute.
 * @param *refclk_freq_hz Resultant reference clock frequency, in Hz.
 * @param *div Divider value (enumerated), or MERLIN16_PLL_DIV_UNKNOWN to auto-compute.
 *             The final divider value will be filled in if MERLIN16_PLL_DIV_UNKNOWN.
 ...
 * as part of merlin16_display_core_state_line()
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param div Divider value, in the same encoding as enum merlin16_pll_div_enum.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
...
} merlin16_INTERNAL_event_log_dump_state_t;

/** Callback function for dumping event log, intended to be called by merlin16_INTERNAL_read_event_log_with_callback.
 *  It must also be called once after, with a byte count of 0, to finish printing.
 * @param *arg is a merlin16_INTERNAL_event_log_dump_state_t pointer for holding state.
...
/*-----------------------------*/
/** Read current merlin16 core status.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *istate Current merlin16 core status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
...
/*-----------------------------*/
/** Read current merlin16 lane status.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *istate Current merlin16 lane status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_INTERNAL_get_osr_mode(srds_access_t *sa__, merlin16_osr_mode_st *mode);
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *pmd_lock Current merlin16 lane pmd_rx_lock status read back and populated by the API
 * @param *pmd_lock_chg Current merlin16 lane pmd_rx_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *sig_det Current merlin16 lane signal_detect status read back and populated by the API
 * @param *sig_det_chg Current merlin16 lane signal_detect_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *pll_lock Current merlin16 lane pll_lock status read back and populated by the API
 * @param *pll_lock_chg Current merlin16 lane pll_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Along with merlin16_core_clkgate(), all lanes should also be clock gated using merlin16_lane_clkgate() to complete a Core Clockgate
 * @param sa__ is an opaque state vector passed through to device access functions.
 ...
 * Define macro CUSTOM_REG_POLLING to replace the default implementation provided in merlin16_internal.c.
 *
 * @param sa__ is an opaque state vector passed through to device access functions.
...
static const int merlin16_endian_const = 1;
#define is_big_endian() ((*(char*)&merlin16_endian_const) == 0)
...
typedef struct {
    uint8_t *mem_ptr;
} merlin16_INTERNAL_rdblk_callback_arg_t;

/** Callback function for reading uc RAM memory by merlin16_INTERNAL_rdblk_uc_generic_ram().
 * @param *arg is a merlin16_INTERNAL_rdblk_callback_arg_t pointer for holding state.
 ...
 *         indefinitely, until cnt bytes total are read.
 *  In other words, this is the same as merlin16_INTERNAL_rdblk_uc_generic_ram(), but reading in descending address order.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param block_addr Address of RAM block to be read.
 *                   For program RAM, the upper 16 bits are 0x0000.  Otherwise, the upper 16 bits are 0x2000.
 * @param block_size Length of RAM block to read.
