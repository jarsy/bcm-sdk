;
; $Id: sdk56102.asm,v 1.7 Broadcom SDK $
;
; $Copyright: (c) 2016 Broadcom.
; Broadcom Proprietary and Confidential. All rights reserved.$
; 
;
; This is the default program for the (24+2+2 port) BCM956102P24
; To start it, use the following commands from BCM:
;
;       0:led load sdk56102.hex
;       0:led auto on
;       0:led start
;
...
;56102 SDK has support for bi-color LEDs but the connector has uni-color LED
;So led-green is made same as led_amber
led_green:
        pushst  ZERO
        pack
        pushst  ONE
