...
/* $Id: configAll.h,v 1.2 2011/07/21 16:14:20 yshtil Exp $
 * Copyright (c) 1994-2007 Wind River Systems, Inc.
 *
...
--------------------
16v,24feb07,jmt  Fix problem with ATA support in bootrom
16u,21feb07,jmt  Remove INCLUDE_WDB from bootrom builds
16t,23jan07,jmt  Disable unneeded components for bootApp build
16s,06dec06,kch  Added kernel sysctl components to the if FALSE section
                 for reference.
16r,13nov06,jgm  Added INCLUDE_POSIX_TIMER_SHOW as part of defect WIND00039293
16q,15nov06,jmt  Defect 81462: Add BOOT_DISABLE_MMU_BEFORE_ENTRY default
16p,30oct06,h_k  re-increased STACK_SAVE for SH, which was over written by a
                 merge. (CQ:70758)
16o,22sep06,mze  moved SM_MAX_PKTS here from smPktLib.h WIND00058841
16n,24aug06,gls  changed value of MAX_ISR_JOBS (Defect #00059580)
16m,17jul06,ggz  Added INCLUDE_WVTIPC for TIPC WV instrumentation
16l,22jun06,jmp  added INCLUDE_CORE_DUMP_UTIL component.
		 added INCLUDE_CORE_DUMP_STREAM_DEV component.
16k,12jul06,bwa  added VxMP task-deferred ISR parameters.
16j,17jul06,mwv  updating DOSFS and HRFS default cache sizes (WIND00059268).
16i,12jul06,jon  adding ND6_MAX_PREFIXES_CFG UDP_STRICT_MCAST_MSHIP_CFG
16h,12may06,dlk  Added UDP(6)_STRICT_MCAST_MSHIP_CFG (WIND00038260).
16g,05jul06,jln  added thread SPORADIC server support
16f,04jul06,tcr  add INCLUDE_POSIX_TRACE
16e,16jun06,zl   added INCLUDE_MEM_MGR_INFO, MEM_PART_DEFAULT_OPTIONS.
16h,19jul06,kch  Include configAllNetwork.h unconditionally. Also moved
                 SNS component's defines to configNetParams.h.
16g,03jul06,kch  Moved coreip stack components and defines that are not 
                 supported by IPNet to a new configAllCoreip.h. Added default 
                 IPNET stack default build support for command line.
16f,23jun06,dlk  Remove networking components not applicable with IPNET stack.
                 Make INCLUDE_IPCOM a default.
16e,12jun06,dlk  Added INCLUDE_NULLBUFPOOL.
...
/*
 * Excluded Optional Bootrom Facilites
 */
...
#define INCLUDE_CORE_DUMP_UTIL	/* Kernel Core Dump utilities */
#define INCLUDE_CORE_DUMP_COMPRESS /* Zlib Core Dump Compression */
#define INCLUDE_CORE_DUMP_COMPRESS_RLE /* RLE Core Dump Compression */
...
#define INCLUDE_CORE_DUMP_RAW_DEV/* Core Dump generic raw device storage */
				/* support */
#define INCLUDE_CORE_DUMP_STREAM_DEV /* Core Dump stream device support */
...
#define INCLUDE_POSIX_TIMER_SHOW /* show_timer() funciton */ 
...
#define DOSFS_DEFAULT_CACHE_SIZE	 0x20000 /* 128K */
...
#define CORE_DUMP_COMPRESSION_LEVEL	9	/* ZLib coredump compression */
						/* level */
