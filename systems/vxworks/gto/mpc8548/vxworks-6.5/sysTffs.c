...
/* $Id: sysTffs.c,v 1.2 2011/07/21 16:14:17 yshtil Exp $
 * Copyright (c) 2000-2002, 2007 Wind River Systems, Inc.
 *
...
--------------------
01f,30mar07,b_m  add wrSbc8548 TFFS support.
...
/* define this MACRO to include MTD driver for wrSbc8548 */
#define INCLUDE_MTD_SBC8548
...
LOCAL void rfaRegister (void)
    ...
    vol.window.baseAddress =	FLASH1_BASE_ADRS >> 12;
...
LOCAL void rfaSetWindow
    ...
    flSetWindowSize (&vol, FLASH1_SIZE >> 12);
    }
...
STATUS sysTffsFormat (void)
    ...
    tffsDevFormatParams params =
    {
        ...
        FTL_FORMAT/*FTL_FORMAT_IF_NEEDED*/
    };
