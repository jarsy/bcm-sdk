...
/* $Id: usrConfig.c,v 1.6 2011/07/21 16:14:16 yshtil Exp $
...
26o,05sep06,tcr  add initialization for INCLUDE_POSIX_TRACE_TIMESTAMP
...
void usrRoot
    ...
    {
    extern int (*funcUsrBootLineCrack)(char *bootString, BOOT_PARAMS *pParams);
    ...
    funcUsrBootLineCrack = usrBootLineCrack;
