...
/* $Id: configAll.h,v 1.4 2011/07/21 16:14:57 yshtil Exp $
...
#define INCLUDE_SPY             /* spyLib for task monitoring */
#ifdef  QUICK_TURN
#undef  INCLUDE_STAT_SYM_TBL    /* create user-readable error status */
#undef  INCLUDE_STANDALONE_SYM_TBL /* compiled-in symbol table */
