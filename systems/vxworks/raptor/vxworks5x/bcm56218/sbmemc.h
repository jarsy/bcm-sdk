 ...
 *
 * $Id: sbmemc.h,v 1.4 2011/01/19 19:44:22 hamilton Exp $
 */
...
#ifdef QUICK_TURN 
#define MEMC_DQSGATENCDL_INIT	0x0083000a
#else
#define MEMC_DQSGATENCDL_INIT	0x0003000b
#endif /* QUICK_TURN */
#define MEMC_RDNCDLCOR_INIT	0x06060606
#define MEMC_WRNCDLCOR_INIT	0x49351207
...
#define MEMC_REFRESH_INIT	0x0000840f /* was 0x0000840f */
...
#if defined(SDRM32X16X1) /* BCM956018, BCM956014 */
/* This is for 64 MB as 32M X 16 X 1 */
#warning "Memory configured for SDRM32X16X1"
#define MEMC_GEOMETRY
#define MEMC_SDR_INIT           0x0012          /* 1024 col., 16 bit i/f */
#define MEMC_SDR_MODE           0x32            /* CAS: 3, burst 8 */
#define	MEMC_SDR_NCDL		0x00000000      /* was 0x00020032 */
#define	MEMC_SDR1_NCDL          0x00000000      /* was 0x0002020f */
#define MEMC_CONFIG_DDR		0x00000001
#elif defined(DDR16MX16X1)
#warning "Memory configured for DDR16MX16X1"
#define	MEMC_DDR_INIT		0x000b
#define	MEMC_DDR_MODE		0x62
#define MEMC_DDR_NCDL           0x00000000
#define MEMC_DDR1_NCDL          0x00000a0a
#define MEMC_CONFIG_DDR		0x00000001
#elif defined(DDR64MX16X1)
#warning "Memory configured for DDR64MX16X1"
/* Micron MT46V64M16 DDR */
#define	MEMC_DDR_INIT		0x0013  /* Becomes 0x48011 */
/* #define MEMC_DDR_MODE		0x62  */ /* Burst = 4 */
#define MEMC_DDR_MODE		0x62  /* Burst = 8 */
#define MEMC_DDR_NCDL           0x00000000
#define MEMC_CONFIG_DDR		0x00000001
#define MEMC_DDR1_NCDL          0x00000a0a
