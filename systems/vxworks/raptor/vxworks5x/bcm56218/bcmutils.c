/*
    ...
    permission of Broadcom Corporatione
*/
/*
 * Misc useful OS-independent routines.
 *
 * Copyright(c) 2001 Broadcom Corporation
 * $Id: bcmutils.c,v 1.3 2007/10/08 22:31:08 iakramov Exp $
 */
...
void testcrc32(void)
{
	...
	VX_OSL_MFREE(buf, CBUFSIZ*CNBUFS);
	return;
}
#endif
...
bcmdumplog(uchar *buf, int size)
{
	...
	*buf = '\0';
	...
	for (i = (logi + 1) % LOGSIZE; (i != logi) && (buf < limit); i = (++i % LOGSIZE)) {
