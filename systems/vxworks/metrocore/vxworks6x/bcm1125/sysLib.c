...
/* $Id: sysLib.c,v 1.4 2011/07/21 16:14:38 yshtil Exp $
...
void sysMetrocoreLocalBusTlbSet(void);
...
#define METROCORE_LOCAL_BUS_BASE	0x10000000
#define METROCORE_LOCAL_BUS_SIZE	0x02000000
void
sysMetrocoreLocalBusTlbSet(void)
{
    /*
     * Map virtual 0x10000000-0x11ffffff to Physical 0x10000000 - 0x11ffffff
     * This area for metrocore local bus space:
     *
     ...
     */
    mem_map(METROCORE_LOCAL_BUS_BASE, METROCORE_LOCAL_BUS_BASE,
		METROCORE_LOCAL_BUS_SIZE);
}
