...
/* $Id: config.h,v 1.3 2011/07/21 16:14:37 yshtil Exp $
...
#define DEFAULT_BOOT_LINE \
    "sbe(0,0)10.100.17.10:/raid/tftpboot/bcm.metrocore e=10.100.100.39:ffff0000 h=10.100.17.10 g=10.100.1.1 u=hqian pw=vamifexa f=0 tn=SiByte1125 o=flash"
...
#else
#define LOCAL_MEM_SIZE			0x10000000   /* 256M memory */
#endif
...
#define RAM_HIGH_ADRS		0x88000000      /* RAM address for ROM boot */
