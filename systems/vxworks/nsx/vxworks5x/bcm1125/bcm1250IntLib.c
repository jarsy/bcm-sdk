...
/* $Id: bcm1250IntLib.c,v 1.3 2011/07/21 16:14:43 yshtil Exp $
...
(0..5) specified by the MIPS architure.
...
* checks the BCM1250 interupt_status_n register to determine if source
...
LOCAL VOID bcm1250Int
    ...
    UINT64 intBit;
    register UINT64 intStatus __asm__ ("s0");
    register unsigned int intSource __asm__("s1");
...
*
* This routine maps one of the 64 bcm1250 interrupt sources to a SB-1 core interrupt
* line, and establishes a handler for that interrupt.  Only one interrupt
* handler may be established to a given bcm1250 interrupt source.
*
* RETURNS:
...
/*****************************************************************************
*
* bcm1250IntDisconnect - disconnect the interrupt handler from 
*    the BCM1250 interrupt.
*
...
/*****************************************************************************
*
* bcm1250IntEnable - enable an external interrupt source on the SB-1
*
* RETURNS:
...
/*****************************************************************************
*
* bcm1250IntDisable - disable an external interrupt source on the SB-1
*
* RETURNS:
