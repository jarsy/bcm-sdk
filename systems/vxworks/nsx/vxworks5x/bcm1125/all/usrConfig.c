...
/* $Id: usrConfig.c,v 1.3 2011/07/21 16:14:48 yshtil Exp $
...
#ifdef  INCLUDE_FLASH
#include "dosFsLib.h"
#include "flashFsLib.h"   /* FlashFS driver */
#endif  

extern STATUS dosFsDateTimeInstall(FUNCPTR);
...
void sysSetClock(void)
{
    ...
    /*
     * Get date/time from system clock
     */
 ...
 */
  cacheCreateInternalDataRAM((UINT32 *)FD_ORIGIN, FD_NUMLINES);
    ...
    /*
     * Get time from battery powered clock and set VxWorks clock
     */
    sysTodInit();
    sysSetClock();
