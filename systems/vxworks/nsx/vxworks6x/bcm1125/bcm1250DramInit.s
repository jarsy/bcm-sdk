...
/* $Id: bcm1250DramInit.s,v 1.3 2011/07/21 16:14:48 yshtil Exp $
...
--------------------
01d,03aug05,dr   removed copyright_wind_river.
01c,13jul04,agf  comment clean-up
...
bcm1250_dram_msbcs:
	...
	*/
	...
	/* The total size (in bytes) of the DIMM is 1 << ttlbits */
...
*
*  Note: we don't interleave memory channels in this example.
*  
*  Input parameters: 
*  	   lots of stuff
*  	   
...
#ifdef CAS25
 	.byte	V_MC_CLK_RATIO_2X	/*  500 Mhz cpu 125   Mhz mem */
#else
	.byte	V_MC_CLK_RATIO_25X	/*  500 Mhz cpu 100   Mhz mem */
#endif
