...
/* $Id: configAll.h,v 1.7 2011/07/21 16:14:54 yshtil Exp $
...
#if VX_VERSION == 62
/* 
 * Workaround for bogus power of two check in VxWorks 6.2 
 * which causes excInit to fail. This has the side-effect
 * of causing all calls to taskDelete() to wrongly leave 
 * the task in the SUSPENDED state.
 */
#define MAX_ISR_JOBS 17
#else
