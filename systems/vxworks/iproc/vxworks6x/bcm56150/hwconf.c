...
LOCAL struct hcfResource ns1655x0Resources[] = {
    { VXB_REG_BASE,  HCF_RES_INT,  {(void *)IPROC_CCA_UART1_REG_BASE} },
    { "irq",         HCF_RES_INT,  {(void *)INT_PIN_UART1} },
...
struct hcfResource iProcCcbTimer0Resources[] = {
    ...
    { "clkFreq",     HCF_RES_INT,  { (void *)100000000   /* 100 MHz */} },
...
struct hcfResource iProcPCIeResources[] = {
    ...
    { "autoIntRouteSet",    HCF_RES_INT,    { (void *)1 } },
    { "intAssignFuncSet",   HCF_RES_ADDR, {(void *)sysPCIeIntAssign }},
