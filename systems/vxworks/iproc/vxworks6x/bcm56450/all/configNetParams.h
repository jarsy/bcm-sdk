...
--------------------
03i,19Aug10.ggz  Added IPCOM_AUTH_HASH_HOOK_DIGEST 
03f,22jan10,dlk  Add IPNET_MEMORY_LIMIT and IPNET_MAX_REASSEMBLY_LIST_LEN.
03e,15sep09,dlk  Make TCP_CONN_TIMEOUT consistent with VIP build (WIND00179915).
03d,07aug09,jgy  Added parameters for IPSCTP.
03c,14jul09,mdk  merge from networking branch
03b,08jun09,ggz  Add DHCPC ipaddress lease time
03a,20apr09,ggz  Added ipcom authentication hashing routine
02z,20apr09,ggz  Added hashing/cleartext flag to configurable auth user data
02y,16oct08,dlk  Changing default NET_DAEMONS_CPU_AFFINITY to TRUE.
02x,02oct08,uol  Add INET_DELETE_ADDR_ON_DUPLICATE_DETECT.
02w,11sep08,brg  Added default definition of INET_DISABLE_BROADCAST_FWD,
                 INET_ICMP_IGNORE_BROADCAST, TCP_DISABLE_LAND_ATTACK for "BSP"
                 build support
02v,04sep08,spw  Added parameters for IPDHCPC
02u,05jul08,dlk  Added parameters for INCLUDE_VXMUX_PKT_POOL_MIN.
02t,27may08,tlu  Added configuration parameters for ROHC
02s,27may08,rme  Erroneous define NUM_POOL_10 changed to NUM_POOL_11 (WIND00122709)
02s,21may08,kjn  Add INET_SEND_GRATUITOUS_ARP
02r,09aug07,tlu  Added TLS configuration parameters for Diameter
02q,02aug07,dlk  Added parameters of INCLUDE_IPNET_IFQUEUE_FIFO_DEFAULT.
02p,15jul07,dlk  Added INET6_RTHDR0.
02o,10jul07,tlu  Added local diameter node supported application ID list and
		 TCP listening port number for Diameter config parameters
02n,28jun07,tlu  Added local node's IP address for Diameter config parameters
02m,23may07,tlu  Added configuration parameters for Diameter client
02l,02may07,dlk  Multiple net daemon support.
...
#endif
#ifndef NUM_NET_DAEMONS
#define NUM_NET_DAEMONS		1
#endif
#ifndef NET_DAEMONS_CPU_AFFINITY
...
#define REM_NUM_CONN_RETRIALS           3       /* NO. of connect() retrials */
#else
#define REM_NUM_CONN_RETRIALS           0       /* NO. of connect() retrials */
#endif
...
#ifdef INCLUDE_END2_LINKBUFPOOL
#define END2_LINKBUFPOOL_NTUPLES	8    /* # tuples in END2 linkBufPool */
#define END2_LINKBUFPOOL_CLSIZE		1600 /* size of tuple clusters */
#endif /* INCLUDE_END2_LINKBUFPOOL */

#ifdef INCLUDE_VXMUX_PKT_POOL_MIN
/* Allocation limit (in bytes) for VXMUX memory pool */
#define VXMUX_PKT_POOL_LIMIT (20 * 1024 * 1024)
/*
 * Should the VXMUX minimal packet pool support M_BLK
 * oriented protocols and drivers?
 */
#define VXMUX_PKT_POOL_USE_NULL_POOL TRUE
/*
 * The number of bytes of space reserved at the start of
 * each packet in the VXMUX minimal packet pool for link-level
 * headers (including tunnelling and similar headers)
 */
#define VXMUX_PKT_POOL_MAX_LINKHDR 18
/* Alignment of packet buffers */
#define VXMUX_PKT_POOL_BUF_ALIGN 64
#endif /* INCLUDE_VXMUX_PKT_POOL_MIN */
...
#ifndef IPCOM_AUTH_HASH_HOOK
#define IPCOM_AUTH_HASH_HOOK     NULL  /* Custom hash routine */
#endif

#ifndef IPCOM_AUTH_HASH_HOOK_DIGEST
#define IPCOM_AUTH_HASH_HOOK_DIGEST   0     /* Digest length of custom hash routine */
#endif

#ifndef IPCOM_AUTH_HASH_HOOK_INSTALL
#define IPCOM_AUTH_HASH_HOOK_INSTALL     FALSE  /* Install custom hash routine */
#endif
...
#endif
#ifndef AUTH_USER_PASSWD1_HASH
#define AUTH_USER_PASSWD1_HASH   FALSE  /* Cleartext password #1 */
#endif
...
#endif
#ifndef AUTH_USER_PASSWD2_HASH
#define AUTH_USER_PASSWD2_HASH   FALSE  /* Cleartext password #2 */
#endif
...
#endif
#ifndef AUTH_USER_PASSWD3_HASH
#define AUTH_USER_PASSWD3_HASH   FALSE  /* Cleartext password #3 */
#endif
...
#endif
#ifndef AUTH_USER_PASSWD4_HASH
#define AUTH_USER_PASSWD4_HASH   FALSE  /* Cleartext password #4 */
#endif
...
#endif
#ifndef AUTH_USER_PASSWD5_HASH
#define AUTH_USER_PASSWD5_HASH   FALSE  /* Cleartext password #5 */
#endif
...
#endif
#ifndef AUTH_USER_PASSWD6_HASH
#define AUTH_USER_PASSWD6_HASH   FALSE  /* Cleartext password #6 */
#endif
...
/* Maximum number of packets queued in default root fifo output queue */
#ifndef IFQUEUE_FIFO_QLIMIT
#define IFQUEUE_FIFO_QLIMIT	50
#endif
/*
 * Array initializer for list of interfaces not to assign a default fifo
 * output queue, e.g. {"lo0", "motetsec1"}
 */
#ifndef IFQUEUE_FIFO_EXCLUDE_IFACES
#define IFQUEUE_FIFO_EXCLUDE_IFACES {IPNET_IF_LOOPBACK_NAME}
#endif
...
#define INET_SEND_GRATUITOUS_ARP          "yes" /* Send gratuitous ARP */
#endif
#ifndef INET_DELETE_ADDR_ON_DUPLICATE_DETECT
#define INET_DELETE_ADDR_ON_DUPLICATE_DETECT "yes" /* Send gratuitous ARP */
#endif
...
#define INET_DISABLE_BROADCAST_FWD "1"  /* Default broadcast forwarding behaviour */
#endif                                 
#ifndef INET_ICMP_IGNORE_BROADCAST      
#define INET_ICMP_IGNORE_BROADCAST "1"   /* SMURF attack prevention */
#endif         
...
#endif
#ifndef INET6_RTHDR0
#define INET6_RTHDR0	  "0"   /* Allow processing of routing header type 0.
				   It is disabled by default since it is a
...
#define TCP_CONN_TIMEOUT        "75"   /* Connection timeout */
#endif
...
#endif
#ifndef TCP_DISABLE_LAND_ATTACK       
#define TCP_DISABLE_LAND_ATTACK "1"    /* LAND attack prevention */
#endif 
#ifndef TCP_MAX_MSS
...
/* also defined in ipsctp\config\ipsctp_config.c */
#ifndef SCTP_RTO_MIN
...
#endif
#ifndef SCTP_RTO_INITIAL
#define SCTP_RTO_INITIAL                 "3000"
#endif
#ifndef SCTP_MAX_ASSOCS
#define SCTP_MAX_ASSOCS                  "-1"
#endif
#ifndef SCTP_VALID_COOKIE_LIFE_TIME
#define SCTP_VALID_COOKIE_LIFE_TIME      "60000"
#endif
#ifndef SCTP_MAX_INIT_RETR
#define SCTP_MAX_INIT_RETR               "8"
#endif
#ifndef SCTP_MAX_HEARTBEAT_BURST
#define SCTP_MAX_HEARTBEAT_BURST         "1"
#endif
#ifndef SCTP_ENABLE_STRICT_SACKS
#define SCTP_ENABLE_STRICT_SACKS         "0"
#endif
#ifndef SCTP_MAX_BURST
#define SCTP_MAX_BURST                   "4"
#endif
#ifndef SCTP_MAX_CHUNKS_PER_ASSOC
#define SCTP_MAX_CHUNKS_PER_ASSOC        "4294967295"
#endif
#ifndef SCTP_DELAYED_SACK_TIME
#define SCTP_DELAYED_SACK_TIME           "200"
#endif
#ifndef SCTP_HEARTBEAT_INTERVAL
#define SCTP_HEARTBEAT_INTERVAL          "30000"
#endif
#ifndef SCTP_DEFAULT_SHUTDOWN_GUARD_TIME
#define SCTP_DEFAULT_SHUTDOWN_GUARD_TIME "180"
#endif
#ifndef SCTP_SECRET_LIFE_TIME
#define SCTP_SECRET_LIFE_TIME            "3600"
#endif
#ifndef SCTP_MAX_RETR_PER_ASSOC
#define SCTP_MAX_RETR_PER_ASSOC          "10"
#endif
#ifndef SCTP_OUT_STREAMS
#define SCTP_OUT_STREAMS                 "10"
#endif
#ifndef SCTP_MAX_SEGMENT_DEFAULT
#define SCTP_MAX_SEGMENT_DEFAULT         "0"
#endif
#ifndef SCTP_PARTIAL_DELIVERY_POINT
#define SCTP_PARTIAL_DELIVERY_POINT      "65536"
#endif
#ifndef SCTP_SACK_FREQ_DEFAULT
#define SCTP_SACK_FREQ_DEFAULT           "2"
#endif
#ifndef SCTP_IN_STREAMS
#define SCTP_IN_STREAMS                  "10"
#endif
#ifndef SCTP_OPTIMIZATION_TCB_LOOKUP
#define SCTP_OPTIMIZATION_TCB_LOOKUP     "0"
#endif
#ifndef SCTP_MAX_VTAG_TIMEWAIT
#define SCTP_MAX_VTAG_TIMEWAIT           "10000"
#endif
#ifndef SCTP_ABORT_ONE2ONE_HITLIMIT
#define SCTP_ABORT_ONE2ONE_HITLIMIT      "1"
#endif
#ifndef SCTP_MAX_RETR_PER_PATH
#define SCTP_MAX_RETR_PER_PATH           "5"
#endif

#endif /* INCLUDE_IPSCTP */
...
/*
 * DHCPC_INSTALL_OPTION_CALLBACK_HOOK - install dhcp client option callback hook
 ...
 */
#ifndef DHCPC_INSTALL_OPTION_CALLBACK_HOOK
#define DHCPC_INSTALL_OPTION_CALLBACK_HOOK     FALSE
#endif
 ...
 * be used. The DHCPC_INSTALL_OPTION_CALLBACK_HOOK must also be set to 
 * TRUE in order to install this callback routine.
 */
...
/*
 * DHCPC_INSTALL_REPLY_CALLBACK_HOOK - Install DHCP client reply callback 
 * routine
 * 
 * Determine if the user-defined DHCP client callback routine
 * as specified by the macro DHCPC_REPLY_CALLBACK_HOOK should
 * be installed. If FALSE, the DHCPC_REPLY_CALLBACK_HOOK
 * configuration is not applicable.
 */
#ifndef DHCPC_INSTALL_REPLY_CALLBACK_HOOK
#define DHCPC_INSTALL_REPLY_CALLBACK_HOOK    FALSE
#endif
  
/*
 * DHCPC_REPLY_CALLBACK_HOOK - Reply callback routine
 * This callback can be used to change the contents of the DHCP
 * server reply (caution!). If not specified, the internal reply
 * callback routine will be used. The DHCPC_INSTALL_CALLBACK_HOOK
 * must also be set to TRUE in order to install this callback
 * routine.
 */
#ifndef DHCPC_REPLY_CALLBACK_HOOK
#define DHCPC_REPLY_CALLBACK_HOOK    NULL
#endif
    
/*
 * DHCPC_BOOTP_MODE - BOOTP mode
 * Operate as a BOOTP client only.
 * That is, do not append a DHCP "message type" option to requests.  
 * "1" to enable, "0" to disable
 */    
#ifndef DHCPC_BOOTP_MODE
#define DHCPC_BOOTP_MODE    "0"
#endif
                 
/*
 * DHCPC_BOOT_FILENAME - DHCP boot filename
 * Specify an optional filename to use in dhcp/bootp requests.
 */
#ifndef DHCPC_BOOT_FILENAME
#define DHCPC_BOOT_FILENAME    ""
#endif
    
/*
 * DHCPC_SERVER_HOSTNAME - DHCP server hostname
 * Specify an optional server hostname to use in dhcp/bootp requests.
 */ 
#ifndef DHCPC_SERVER_HOSTNAME
#define DHCPC_SERVER_HOSTNAME    ""
#endif

/*
 * DHCPC_OPTION_HOSTNAME - Option Hostname (12)
 * Defines the hostname option to use in requests.
 */
#ifndef DHCPC_OPTION_HOSTNAME
#define DHCPC_OPTION_HOSTNAME    ""
#endif

/*
 * DHCPC_OPTION_NETMASK - Option Netmask (1)
 * Defines the subnet mask option to use in requests.
 */
#ifndef DHCPC_OPTION_NETMASK
#define DHCPC_OPTION_NETMASK    ""
#endif
  
/*
 * DHCPC_OPTION_IPADDRESS_LEASE_TIME
 * This option is used in a client request to allow the client to request
 * a lease time for the IP address. 
 */
#ifndef DHCPC_OPTION_IPADDRESS_LEASE_TIME
#define DHCPC_OPTION_IPADDRESS_LEASE_TIME    0
#endif

/*
 * DHCPC_OPTION_VENDOR_CLASS_ID - Option Vendor Class ID (60)
 * Defines the vendor class id option.
 */
#ifndef DHCPC_OPTION_VENDOR_CLASS_ID
#define DHCPC_OPTION_VENDOR_CLASS_ID    ""
#endif
 
/*
 * DHCPC_OPTION_VI_VENDOR_CLASS - Option Vendor Identifying Vendor Class (124)
 * Defines the vendor identifying vendor class option.
 * Expected format is: 
 * <enterprise number>=<data1>;<enterprise number>=<data2>;...
 */
#ifndef DHCPC_OPTION_VI_VENDOR_CLASS
#define DHCPC_OPTION_VI_VENDOR_CLASS    ""
#endif

/*
 * DHCPC_OPTION_USER_SPECIFIED - Global option: user specified list
 * Defines a list of options and associated data not supported explicitly by 
 * other option configuration parameters. 
 * Expected format is: <option>=<option_data>. 
 * Each pair of <option_number>=<option_data> is semicolon separated. 
 * In addition, <option_data> must be specified in hex with network byte order. 
 * e.g. "3=C0A80101;4=C0A80102" specifies a router option (3) with address at 
 * 192.168.1.1 and a time server option (4) with address at 192.168.1.2.
 */
#ifndef DHCPC_OPTION_USER_SPECIFIED
#define DHCPC_OPTION_USER_SPECIFIED    ""
#endif
 
/*
 * DHCPC_REMOVE_EXISTING_ADDRESSES - Remove Existing Addresses
 * Remove all unicast addresses from the interface before negotiation begins. 
 * "1" to remove, "0" to retain
 */
#ifndef DHCPC_REMOVE_EXISTING_ADDRESSES
#define DHCPC_REMOVE_EXISTING_ADDRESSES    "1"
#endif

/*
 * DHCPC_REMOVE_LEASED_ADDRESS - Remove Leased Address 
 * Remove any address from the interface if the lease expires. 
 * "1" to remove, "0" to retain
 */
#ifndef DHCPC_REMOVE_LEASED_ADDRESS
#define DHCPC_REMOVE_LEASED_ADDRESS    "1"
#endif
 
/*
 * DHCPC_AUTO_DISABLE - Auto Disable 
 * Disable DHCP on the interface if another address is manually configured.
 * "1" to turn on, "0" to turn off
 */    
#ifndef DHCPC_AUTO_DISABLE
#define DHCPC_AUTO_DISABLE    "0"
#endif
...
#endif
#ifndef DNSC_TERTIARY_NAME_SERVER
#define DNSC_TERTIARY_NAME_SERVER ""   /* tertiaryns name server */
#endif
#ifndef DNSC_QUATERNARY_NAME_SERVER
#define DNSC_QUATERNARY_NAME_SERVER   ""    /* quaternaryns name server */
#endif
...
#endif
#ifndef FTPS_SOCKET_BACKLOG
#define FTPS_SOCKET_BACKLOG   "0"  /* Control socket backlog queue length */
#endif
...
/*
 * Please refer to Diameter CDF file for the explaination of the
...
/*
 * Please refer to ROHC CDF file for the explaination of the
 * configuration parameters.
 */
