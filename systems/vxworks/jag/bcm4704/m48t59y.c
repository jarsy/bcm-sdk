/*
 * $Id: m48t59y.c,v 1.2 2006/01/12 22:57:03 sanjayg Exp $
 *
...
#define YEAR		(0xf ^ ADDR_XOR_3)
#define MONTH		(0xe ^ ADDR_XOR_3)
#define DAY         (0xd ^ ADDR_XOR_3)
#define DAY_OF_WEEK	(0xc ^ ADDR_XOR_3)
#define HOUR		(0xb ^ ADDR_XOR_3)
#define MINUTE		(0xa ^ ADDR_XOR_3)
#define SECOND		(0x9 ^ ADDR_XOR_3)
#define CONTROL		(0x8 ^ ADDR_XOR_3)
#define WATCH		(0x7 ^ ADDR_XOR_3)
#define INTCTL		(0x6 ^ ADDR_XOR_3)
#define WD_DATE		(0x5 ^ ADDR_XOR_3)
#define WD_HOUR		(0x4 ^ ADDR_XOR_3)
#define WD_MIN		(0x3 ^ ADDR_XOR_3)
#define WD_SEC		(0x2 ^ ADDR_XOR_3)
#define _UNUSED		(0x1 ^ ADDR_XOR_3)
#define FLAGS		(0x0 ^ ADDR_XOR_3)
