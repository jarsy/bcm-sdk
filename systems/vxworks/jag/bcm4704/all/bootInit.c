...
/* $Id: bootInit.c,v 1.2 2011/07/21 16:14:24 yshtil Exp $
...
/* Defaults set to external UART properties */

unsigned char *uartBaseAddr = (unsigned char*)MBZ_DUART_CHAN0_ASM;
int serialClockFreq = COM1_FREQ;

#endif /* !BROADCOM_BSP */

#if 0
#define ROMPRINT(a,b,c,d)  \
        if (romPrintRtn != NULL) (romPrintRtn) (a,b,c,d)
#endif

#define RPRINT(a, b, c, d) \
        *((volatile unsigned char *)(0xba00c000)) = a; \
        *((volatile unsigned char *)(0xba00c001)) = b; \
        *((volatile unsigned char *)(0xba00c002)) = c; \
        *((volatile unsigned char *)(0xba00c003)) = d;
...
UCHAR serialInByte
    ...
    {
    return *(volatile unsigned char *) ((MBZ_DUART_CHAN0_ASM)+(addr^3));
    }
...
void serialOutByte
    ...
    {
    *(volatile unsigned char *) ((MBZ_DUART_CHAN0_ASM)+(addr^3)) = c;
    }
