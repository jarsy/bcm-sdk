 ...
 * $Id: vx_osl.h,v 1.2 2006/06/30 22:15:30 korchakd Exp $
 */
...
#define OSL_SLEEP(x) osl_delay(x)
...
extern uint32 osl_pci_read_config(pciinfo_t *pciinfo, uint offset, uint size);
extern void osl_pci_write_config(pciinfo_t *pciinfo, uint offset, uint size, uint val);
