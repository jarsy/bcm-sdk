...
/* $Id: sysMipsALib.s,v 1.2 2011/07/21 16:14:28 yshtil Exp $
...
#if 0 /* Debug code for interrupt vector table */
	.globl	excNormVec1	/* Normal exc/int vector	*/	
	.globl	excNormVecSize1	/* Normal exc/int vector size   */
#endif 
...
excNormVec1:	
	...
	nop				/* 1 cyc delay before reading CAUSE */
#endif	/* _WRS_MIPS_VR4131_ERRATA */
	mfc0	k0, C0_CAUSE		/* grab cause register	*/
	HAZARD_CP_READ
	and	k0, CAUSE_EXCMASK	/* look at exception bits */
	bne	k0, zero, 1f		/* zero == interrupt	  */
	nop

	
	la	k1, excIntStub
	jr	k1			/* can be in kseg0 or kseg1 */
	nop
1:	
	/* test for syscall */
	li	k1, (IV_SYSCALL_VEC << CAUSE_EXCSHIFT)
	bne	k0, k1, 2f		/* test for syscall */
	nop	

	lw	k0, _func_excScStub
	bnez	k0, 3f			/* test for null pointer */
	nop
2:
	la	k0, excStub
3:
...
excNormVecEnd1:
	...
	.align	4
excNormVecSize1:
	.word	excNormVecEnd1-excNormVec1
	.text
#endif 
