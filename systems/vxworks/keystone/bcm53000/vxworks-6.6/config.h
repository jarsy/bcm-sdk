...
/* $Id: config.h,v 1.11 2011/08/08 15:57:34 jimhuang Exp $
...
#define BSP_REV     "/10"   /* increment with each revision */
...
#define WDB_END_DEVICE_NAME "et"
#define WDB_END_DEVICE_UNIT sysEndUnitGet()
...
/* calibration constant to adjust the aux clock rate. the calibration
 * constant will change with oscillator frequency changes. These values
 * assume the default oscillator frequencies.
 */
#define AUX_CLK_CALIBRATE 41
...
#define INCLUDE_RAW_FS
#define INCLUDE_DOSFS
#define INCLUDE_DOSFS_MAIN
#define INCLUDE_DOSFS_CHKDSK
#define INCLUDE_DOSFS_FMT

#define BULK_MAX_DEVS 2
#define BULK_DRIVE_NAME "/bd"
#define BULK_MAX_DRV_NAME_SZ 20
