...
/* $Id: configAll.h,v 1.3 2011/07/21 16:14:31 yshtil Exp $
...
#if ((CPU_FAMILY == PPC) && defined (_WRS_VX_SMP))
...
#define INCLUDE_CORE_DUMP_MEM_POOL /* Core Dump memory pool */
...
#define DOSFS_DEFAULT_DATA_CACHE_SIZE	 0x20000 /* 128K */
#define DOSFS_DEFAULT_DIR_CACHE_SIZE	 0x2000  /*  16K */
#define DOSFS_DEFAULT_FAT_CACHE_SIZE	 0x10000 /*  64K */
