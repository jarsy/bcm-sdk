...
/* $Id: bootInit.c,v 1.2 2011/07/21 16:14:31 yshtil Exp $
 * Copyright (c) 1989-2007 Wind River Systems, Inc.
 *
...
#if 0 /* Enable for boot from ddr, disable for boot from flash */
