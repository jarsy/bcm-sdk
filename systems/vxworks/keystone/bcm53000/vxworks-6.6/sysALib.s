...
/* $Id: sysALib.s,v 1.4 2011/07/21 16:14:28 yshtil Exp $
...
#define TO_KSEG1(x)	(((x) & ADDRESS_SPACE_MASK) | K1BASE)
#define DISP_DIRECT( reg, ch ) \
	lui	k0, ((TO_KSEG1(reg) >> 16) & 0xFFFF);\
	addiu	k0, (TO_KSEG1(reg) & 0xFFFF );\
	li	k1, ch;\
	sw	k1, 0(k0)
