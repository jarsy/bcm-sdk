 ...
 * All Rights Reserved.
 * $Id: vxbsp.h,v 1.2 2009/04/03 13:09:32 alai Exp $
 */
...
#define SYSMODEL        "bcm53000(mips74k)"

#define BCM53000_SR      (SR_CU0| INT_LVL_IORQ0 | INT_LVL_IORQ3 | INT_LVL_IORQ1 |\
                           INT_LVL_TIMER | INT_LVL_IORQ2 | SR_IE | INT_LVL_IORQ4)
...
/* shared mips int 0 */
#define IV_LAST_VEC			90
#define IV_PCI1_MAX			89
#define IV_PCI1_2			88
#define IV_PCI1_1			87
#define IV_PCI1_0			86
#define IV_PCI0_MAX			85
#define IV_PCI0_2			84
#define IV_PCI0_1			83
#define IV_PCI0_0			82
#define IV_PCMCIA			81
#define IV_EXT_ALT2_VEC 		80	   
#define IV_EXT_ALT1_VEC 		79	   

/* whenever a new BIT vec is added please update the IV_IORQ0_MAX_VEC define*/
#define IV_IORQ0_BIT7_VEC		78	 
...
#define IV_IORQ0_MAX_VEC		IV_IORQ0_BIT7_VEC	
...
extern uint32 sysGetSBClk(void); /* routine to return sb clock */
extern int sysInumToIrq(int inum);
