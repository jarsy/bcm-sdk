 ...
 *
 * $Id: siutils_priv.h,v 1.2 Broadcom SDK $
 */
...
/* XXX PR32414 FORCEHT war, block dynamic clock when pci/pcie is in up state */
...
#endif /* BCMINTERNAL || BCMDBG_ASSERT || BCMDBG_ERR || BCMDBG_DUMP */
