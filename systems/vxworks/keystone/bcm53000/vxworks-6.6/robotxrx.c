/*
 * $Id: robotxrx.c,v 1.3 2011/06/01 10:32:21 jimhuang Exp $
...
/*#define ROBO_TXRX_DEBUG 1*/
#define ROBO_TX_TEST_XXXX

#define ROBO_MII_DEVICE_NAME "et"
#define ROBO_MII_DEV_UNIT 0
#define LINK_HDR_LEN 14

#define ROBO_TX_RX_PK_SZ    16318
...
#define ROBO_TXRX_PRINT if (robo_txrx_debug & ROBO_TXRX_DEBUG_P) printf
#else
#define ROBO_TXRX_PRINT
#endif
